import { _ as G, e as V, b as Q, w as W, c as X, d as $, a as P, n as D, u as B, t as J, T as Z, o as E, P as z, N as f, ba as Y, W as g, bb as y, bc as v, bd as q, a0 as A, $ as S, aw as K, Q as w, R as ee, S as R, U as te, X as k, Y as re, Z as ae, M as ie, V as L, a1 as se, a2 as ne, a3 as U, a5 as N, a6 as oe, a7 as le, a8 as de, aa as he, ab as ue, be as I, bf as ce, bg as fe, aO as pe, bh as ge, am as me, bi as ve, b7 as xe, G as Te, E as Me, I as Se, J as we, aB as ye, C as _e, B as be, D as Pe, bj as Be, K as Ce } from "./SkeletonUtils-ChRJV-qR.js";
const De = { key: 0, class: "loading" }, Ee = { class: "bar" }, Re = { class: "label" }, ke = { __name: "Loading", setup(d) {
  ...
  return window.addEventListener("updateLoading", function(a) {
    r(a.detail);
  }), (a, i) => (E(), Q(Z, { name: "fade-loading" }, { default: W(() => [t() == false ? (E(), X("div", De, [P("div", Ee, [P("div", { class: "boxel", style: D({ left: `calc(${B(e).percent}% - 1em)` }) }, null, 4), P("div", { class: "progress", style: D({ width: B(e).percent + "%" }) }, null, 4)]), P("div", Re, "Loading: " + J(B(e).percent) + "%", 1)])) : $("", true)]), _: 1 }));
} }, je = G(ke, [["__scopeId", "data-v-96273571"]]);
class He {
  constructor() {
...
class x extends z {
  ...
  _changeVisibilityOfNonSelectedObjects(e) {
    ...
    function a(i) {
      ...
      } else (i.isPoints || i.isLine) && (e === true ? i.visible = r.get(i) : (r.set(i, i.visible), i.visible = e));
    }
...
_.Panel = function(d, e, r) {
  ...
  return l.font = "bold " + 9 * s + "px Helvetica,Arial,sans-serif", l.textBaseline = "top", l.fillStyle = r, l.fillRect(0, 0, n, c), l.fillStyle = e, l.fillText(d, o, h), l.fillRect(u, p, m, T), l.fillStyle = r, l.globalAlpha = 0.9, l.fillRect(u, p, m, T), { dom: M, update: function(b, H) {
    t = Math.min(t, b), a = Math.max(a, b), l.fillStyle = r, l.globalAlpha = 1, l.fillRect(0, 0, n, p), l.fillStyle = e, l.fillText(i(b) + " " + d + " (" + i(t) + "-" + i(a) + ")", o, h), l.drawImage(M, u + s, p, m - s, T, u, p, m - s, T), l.fillRect(u + m - s, p, s, T), l.fillStyle = r, l.globalAlpha = 0.9, l.fillRect(u + m - s, p, s, i((1 - b / H) * T));
  } };
};
class Ge {
...
class Ve {
  ...
  static create(e = "PointLight", r) {
    var t, a;
    if (r = Object.assign({ color: "#ffffff", decay: 2, distance: 0, groundColor: "#000000", intensity: Math.PI, castShadow: false, skyColor: "#ffffff" }, r), e == "AmbientLight" ? t = new I(r.color, r.intensity) : e == "DirectionalLight" ? (t = new ce(r.color, r.intensity), a = new fe(t)) : e == "HemisphereLight" ? (t = new pe(r.skyColor, r.groundColor, r.intensity), a = new ge(t)) : e == "PointLight" && (t = new me(r.color, r.intensity, r.distance, r.decay), a = new ve(t)), t == null) {
...
class Oe extends Te {
  ...
  renderThumbnail(e, r) {
    ...
    return e.position.copy(r.position), e.scale.copy(r.scale), C.add(e), O.setSize(r.width, r.height), O.render(C, j), e.removeFromParent(), e.position.copy(t), e.scale.copy(a), F.toDataURL("image/png");
  }
}
const ze = new I("#ffffff", Math.PI), C = new U(), F = document.createElement("canvas"), O = new N({ alpha: true, canvas: F }), j = new xe(-0.5, 0.5, 0.5, -0.5, 0.01, 100);
C.add(ze);
j.position.z = 10;
class Ae extends we {
  constructor(e) {
...
class Qe extends Ce {
  constructor(e, r, t) {
    super(e, Ie.bind(r), t), this.cache = {}, this.assetModelLoader = new Oe(this), this.assetTextureLoader = new Ae(this), this.assetAudioLoader = new Ue(this), this.assetJSONLoader = new Ne(this);
  }
  load(e = {}) {
