const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./web-DuAJVPMI.js","./SkeletonUtils-Bd8KjIp5.js","./web-DE0qYAhT.js"])))=>i.map(i=>d[i]);
import { ac as za, aW as Za, f as en, aX as tn, g as we, q as pt, aV as an, aY as St, aZ as ya, F as La, a_ as Te, a$ as nn, x as rn, y as sn, h as on, b0 as ln } from "./SkeletonUtils-Bd8KjIp5.js";
let Uo, Ve, xo, ct, ka, Mo, gn, De, Do, $o, Dt;
let __tla = (async () => {
  var be;
  (function(e) {
    ...
    const t = e.CapacitorCustomPlatform || null, a = e.Capacitor || {}, n = a.Plugins = a.Plugins || {}, r = () => t !== null ? t.name : cn(e), s = () => r() !== "web", o = (_) => {
      ...
      const f = async () => (!S && P in m ? S = typeof m[P] == "function" ? S = await m[P]() : S = m[P] : t !== null && !S && "web" in m && (S = typeof m.web == "function" ? S = await m.web() : S = m.web), S), v = (N, A) => {
        ...
        if (w) {
          ...
          if (x) return x.rtype === "promise" ? (J) => a.nativePromise(_, A.toString(), J) : (J, le) => a.nativeCallback(_, A.toString(), J, le);
  ...
  }, dn = (e) => e.Capacitor = un(e), We = dn(typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : typeof global < "u" ? global : {}), Be = We.registerPlugin;
  ka = class {
    constructor() {
  ...
  const Wt = Be("Filesystem", {
    web: () => wa(() => import("./web-DuAJVPMI.js"), __vite__mapDeps([0,1]), import.meta.url).then((e) => new e.FilesystemWeb())
  });
  wn();
  xo = class {
    constructor() {
  ...
  const Ye = typeof window < "u", ue = (e, t = false) => t ? Symbol.for(e) : Symbol(e), Tn = (e, t, a) => In({
    l: e,
    k: t,
    s: a
  }), In = (e) => JSON.stringify(e).replace(/\u2028/g, "\\u2028").replace(/\u2029/g, "\\u2029").replace(/\u0027/g, "\\u0027"), q = (e) => typeof e == "number" && isFinite(e), Cn = (e) => Tt(e) === "[object Date]", Ee = (e) => Tt(e) === "[object RegExp]", Ge = (e) => F(e) && Object.keys(e).length === 0, K = Object.assign, Pn = Object.create, $ = (e = null) => Pn(e);
  let Ht;
  ...
  const V = Array.isArray, W = (e) => typeof e == "function", C = (e) => typeof e == "string", D = (e) => typeof e == "boolean", M = (e) => e !== null && typeof e == "object", An = (e) => M(e) && W(e.then) && W(e.catch), Sa = Object.prototype.toString, Tt = (e) => Sa.call(e), F = (e) => Tt(e) === "[object Object]", Rn = (e) => e == null ? "" : V(e) || F(e) && e.toString === Sa ? JSON.stringify(e, null, 2) : String(e);
  function It(e, t = "") {
  ...
  function je(e, t) {
    ...
    for (; a.length; ) {
      ...
      Object.keys(n).forEach((s) => {
        s !== "__proto__" && (M(n[s]) && !M(r[s]) && (r[s] = Array.isArray(n[s]) ? [] : $()), Me(r[s]) || Me(n[s]) ? r[s] = n[s] : a.push({
          src: n[s],
          des: r[s]
        }));
      });
...
`, Un = "\u2028", $n = "\u2029";
  ...
  const ce = void 0, Wn = ".", Bt = "'", Hn = "tokenizer";
  function Vn(e, t = {}) {
    ...
    function w(l) {
      let c = "";
      for (; l.currentPeek() === re || l.currentPeek() === X; ) c += l.currentPeek(), l.peek();
      return c;
    }
    function S(l) {
      const c = w(l);
    ...
    function A(l, c) {
      ...
      const O = () => {
        ...
        return R === "{" ? f(l.peek()) : R === "@" || R === "|" || R === ":" || R === "." || R === re || !R ? false : R === X ? (l.peek(), O()) : G(l, false);
      }, Y = O();
      return l.resetPeek(), Y;
    }
    function H(l) {
    ...
    function G(l, c = true) {
      const b = (Y = false, R = "") => {
        ...
        return p === "{" || p === "@" || !p ? Y : p === "|" ? !(R === re || R === X) : p === re ? (l.peek(), b(true, re)) : p === X ? (l.peek(), b(true, X)) : true;
      }, O = b();
    ...
    function ot(l) {
      const c = (b) => {
        const O = l.currentChar();
        return O === "{" || O === "@" || O === "|" || O === "(" || O === ")" || !O || O === re ? b : (b += O, l.next(), c(b));
      };
      return c("");
    }
    function Le(l) {
    ...
    function _e(l, c) {
      ...
      switch (l.currentChar()) {
        ...
        default: {
          ...
          if (Y = L(l, c)) return b = m(c, 4, Ze(l)), S(l), b;
          if (R = h(l, c)) return b = m(c, 5, et(l)), S(l), b;
          if (p = T(l, c)) return b = m(c, 6, tt(l)), S(l), b;
          if (!Y && !R && !p) return b = m(c, 12, rt(l)), _(U.INVALID_TOKEN_IN_PLACEHOLDER, s(), 0, b.value), S(l), b;
          break;
        }
      }
      return b;
    ...
    function ge(l, c) {
      ...
      switch ((b === 7 || b === 8 || b === 11 || b === 9) && (Y === X || Y === re) && _(U.INVALID_LINKED_FORMAT, s(), 0), Y) {
        case "@":
        ...
        default:
          return H(l) ? (O = m(c, 1, Le(l)), c.braceNest = 0, c.inLinked = false, O) : I(l, c) || N(l, c) ? (S(l), ge(l, c)) : E(l, c) ? (S(l), m(c, 11, st(l))) : A(l, c) ? (S(l), Y === "{" ? _e(l, c) || O : m(c, 10, ot(l))) : (b === 7 && _(U.INVALID_LINKED_FORMAT, s(), 0), c.braceNest = 0, c.inLinked = false, ke(l, c));
      }
    }
    function ke(l, c) {
      let b = {
    ...
    function lt() {
      ...
      return u.lastType = l, u.lastOffset = c, u.lastStartLoc = b, u.lastEndLoc = O, u.offset = r(), u.startLoc = s(), n.currentChar() === ce ? m(u, 13) : ke(n, u);
    }
    return {
      nextToken: lt,
      currentOffset: r,
  ...
  function qn(e = {}) {
    ...
    function g(f) {
      ...
      return v.type !== 11 ? (n(f, U.UNEXPECTED_EMPTY_LINKED_MODIFIER, L.lastStartLoc, 0), I.value = "", s(I, h, T), {
        nextConsumeToken: v,
        node: I
      }) : (v.value == null && n(f, U.UNEXPECTED_LEXICAL_ANALYSIS, L.lastStartLoc, 0, te(v)), I.value = v.value || "", s(I, f.currentOffset(), f.currentPosition()), {
        node: I
      });
    }
    function _(f, v) {
    ...
    function m(f) {
      ...
      switch (h.type !== 9 && n(f, U.UNEXPECTED_LEXICAL_ANALYSIS, v.lastStartLoc, 0, te(h)), h = f.nextToken(), h.type === 2 && (h = f.nextToken()), h.type) {
        case 10:
          h.value == null && n(f, U.UNEXPECTED_LEXICAL_ANALYSIS, v.lastStartLoc, 0, te(h)), L.key = _(f, h.value || "");
          break;
        case 4:
          h.value == null && n(f, U.UNEXPECTED_LEXICAL_ANALYSIS, v.lastStartLoc, 0, te(h)), L.key = u(f, h.value || "");
          break;
        case 5:
          h.value == null && n(f, U.UNEXPECTED_LEXICAL_ANALYSIS, v.lastStartLoc, 0, te(h)), L.key = i(f, h.value || "");
          break;
        case 6:
          h.value == null && n(f, U.UNEXPECTED_LEXICAL_ANALYSIS, v.lastStartLoc, 0, te(h)), L.key = d(f, h.value || "");
          break;
        default: {
    ...
    function k(f) {
      ...
      do {
        ...
        switch (I = null, A.type) {
          case 0:
            A.value == null && n(f, U.UNEXPECTED_LEXICAL_ANALYSIS, v.lastStartLoc, 0, te(A)), T.items.push(o(f, A.value || ""));
            break;
          case 5:
            A.value == null && n(f, U.UNEXPECTED_LEXICAL_ANALYSIS, v.lastStartLoc, 0, te(A)), T.items.push(i(f, A.value || ""));
            break;
          case 4:
            A.value == null && n(f, U.UNEXPECTED_LEXICAL_ANALYSIS, v.lastStartLoc, 0, te(A)), T.items.push(u(f, A.value || ""));
            break;
          case 6:
            A.value == null && n(f, U.UNEXPECTED_LEXICAL_ANALYSIS, v.lastStartLoc, 0, te(A)), T.items.push(d(f, A.value || ""));
            break;
          case 7: {
            const H = m(f);
...
`, s = t.needIndent ? t.needIndent : a !== "arrow", o = e.helpers || [], i = Qn(e, {
  ...
  function pr(e, t) {
    if (!__INTLIFY_DROP_MESSAGE_COMPILER__ && C(e)) {
      ...
      const n = (t.onCacheKey || fr)(e), r = Ue[n];
      if (r) return r;
  ...
  function Jt(e) {
    ...
    if (W(e)) {
      ...
      if (e.constructor.name === "Function") {
        const t = e();
        if (An(t)) throw oe(se.NOT_SUPPORT_LOCALE_PROMISE_VALUE);
        return ft = t;
  ...
  function Da(e, t, a) {
    ...
    if (!s) {
      ...
      o = C(i) ? [
        i
      ] : i, V(o) && Xt(s, o, false), r.__localeChainCache.set(n, s);
    }
    return s;
  }
  function Xt(e, t, a) {
  ...
  function Or(e, t) {
    ...
    for (; s < n; ) {
      const o = a[s];
      if (Fa.includes(o) && ae(r)) return null;
      const i = r[o];
  ...
  const Nr = "11.1.11", Ke = -1, Pe = "en-US", zt = "", Zt = (e) => `${e.charAt(0).toLocaleUpperCase()}${e.substr(1)}`;
  function Ar() {
    return {
  ...
  function Jr(e = {}) {
    ...
    const _ = (f) => e.modifiers ? e.modifiers[f] : Hr, m = F(e.processor) && W(e.processor.normalize) ? e.processor.normalize : Br, k = F(e.processor) && W(e.processor.interpolate) ? e.processor.interpolate : Gr, P = F(e.processor) && C(e.processor.type) ? e.processor.type : Yr, S = {
      ...
      linked: (f, ...v) => {
        ...
        const E = g(f, true)(S), N = T === "vnode" && V(E) && I ? E[0] : E;
        return I ? _(I)(N, T) : N;
      },
      message: g,
      type: P,
  ...
  function ia(e, ...t) {
    ...
    if (!k && !(C(h) || ae(h) || Z(h)) && w && (h = P, T = h), !k && (!(C(h) || ae(h) || Z(h)) || !C(v))) return r ? Ke : u;
    let I = false;
    const E = () => {
      I = true;
  ...
  function Va(e, t, a, n, r, s) {
    ...
    let _ = $(), m, k = null;
    const P = "translate";
    for (let w = 0; w < g.length && (m = g[w], _ = o[m] || $(), (k = u(_, t)) === null && (k = _[t]), !(C(k) || ae(k) || Z(k))); w++) if (!Wr(m, g)) {
  ...
  function bt(...e) {
    ...
    return q(a) ? r.plural = a : C(a) ? r.default = a : F(a) && !Ge(a) ? r.named = a : V(a) && (r.list = a), q(n) ? r.plural = n : C(n) ? r.default = n : F(n) && K(r, n), [
      s,
      r
    ];
  }
  ...
  function Oe(e) {
    ...
    for (const t in e) if (ee(e, t)) if (!t.includes(".")) M(e[t]) && Oe(e[t]);
      ...
      if (s || (ae(r) ? Fa.includes(a[n]) || delete e[t] : (r[a[n]] = e[t], delete e[t])), !ae(r)) {
        const o = r[a[n]];
        M(o) && Oe(o);
      }
    }
  ...
  function At(e, t) {
    const { messages: a, __i18n: n, messageResolver: r, flatJson: s } = t, o = F(a) ? a : V(n) ? $() : {
      [e]: $()
    };
    if (V(n) && n.forEach((i) => {
  ...
  function Rt(e = {}) {
    const { __root: t, __injectWithOption: a } = e, n = t === void 0, r = e.flatJson, s = Ye ? en : tn;
    ...
    }), x = we(() => d.value), J = we(() => g.value), le = we(() => _.value);
    function ie() {
      return W(v) ? v : null;
    }
    function Je(p) {
    ...
    const ne = (p, y, j, B, me, Fe) => {
      ...
      if (j !== "translate exists" && q(he) && he === Ke || j === "translate exists" && !he) {
        const [Qa, Ro] = y();
    ...
    function Ne(...p) {
      return ne((y) => Reflect.apply(ia, null, [
        y,
        ...p
    ...
    function ze(...p) {
      return ne((y) => Reflect.apply(aa, null, [
        y,
        ...p
    ...
    function Ze(...p) {
      return ne((y) => Reflect.apply(ra, null, [
        y,
        ...p
    ...
    return R.datetimeFormats = J, R.numberFormats = le, R.rt = Ae, R.te = st, R.tm = Le, R.d = ze, R.n = Ze, R.getDateTimeFormat = lt, R.setDateTimeFormat = l, R.mergeDateTimeFormat = c, R.getNumberFormat = b, R.setNumberFormat = O, R.mergeNumberFormat = Y, R[Ga] = a, R[Et] = at, R[yt] = nt, R[Lt] = Re, R;
  }
  function rs(e) {
    const t = C(e.locale) ? e.locale : Pe, a = C(e.fallbackLocale) || V(e.fallbackLocale) || F(e.fallbackLocale) || e.fallbackLocale === false ? e.fallbackLocale : t, n = W(e.missing) ? e.missing : void 0, r = D(e.silentTranslationWarn) || Ee(e.silentTranslationWarn) ? !e.silentTranslationWarn : true, s = D(e.silentFallbackWarn) || Ee(e.silentFallbackWarn) ? !e.silentFallbackWarn : true, o = D(e.fallbackRoot) ? e.fallbackRoot : true, i = !!e.formatFallbackMessages, u = F(e.modifiers) ? e.modifiers : {}, d = e.pluralizationRules, g = W(e.postTranslation) ? e.postTranslation : void 0, _ = C(e.warnHtmlInMessage) ? e.warnHtmlInMessage !== "off" : true, m = !!e.escapeParameterHtml, k = D(e.sync) ? e.sync : true;
    let P = e.messages;
  ...
  Uo = Be("App", {
    web: () => wa(() => import("./web-DE0qYAhT.js"), __vite__mapDeps([2,1]), import.meta.url).then((e) => new e.AppWeb())
  });
  Ss = {
    button: {
      pause: "Pause"
