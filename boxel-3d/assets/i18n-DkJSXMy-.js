const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./web-Bh1XE83k.js","./SkeletonUtils-Lx6OFsqh.js","./web-Dp43B4RA.js"])))=>i.map(i=>d[i]);
...
let __tla = (async () => {
  ...
  const Wt = Ge("Filesystem", {
    web: () => wa(() => import("./web-Bh1XE83k.js"), __vite__mapDeps([0,1]), import.meta.url).then((e) => new e.FilesystemWeb())
  });
  wn();
  xo = class {
    constructor() {
...
`, s = t.needIndent ? t.needIndent : a !== "arrow", o = e.helpers || [], i = Qn(e, {
  ...
  Uo = Ge("App", {
    web: () => wa(() => import("./web-Dp43B4RA.js"), __vite__mapDeps([2,1]), import.meta.url).then((e) => new e.AppWeb())
  });
  Ss = {
    button: {
      pause: "Pause"
