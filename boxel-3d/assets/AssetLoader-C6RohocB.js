import { _ as G, f as V, b as Q, o as D, w as W, c as X, d as $, a as P, n as E, u as B, t as J, T as Z, P as z, N as f, ba as Y, W as g, bb as y, bc as v, bd as q, a0 as A, $ as S, aw as K, Q as w, R as ee, S as k, U as te, X as R, Y as re, Z as ae, M as ie, V as L, a1 as se, a2 as ne, a3 as F, a5 as U, a6 as oe, a7 as le, a8 as de, aa as he, ab as ue, be as N, bf as ce, bg as fe, aO as pe, bh as ge, am as me, bi as ve, b7 as xe, G as Te, E as Me, I as Se, J as we, aB as ye, C as _e, B as be, D as Pe, bj as Be, K as Ce } from "./SkeletonUtils-CqlbfaSM.js";
const De = { key: 0, class: "loading" }, Ee = { class: "bar" }, ke = { class: "label" }, Re = { __name: "Loading", setup(d) {
  ...
  return window.addEventListener("updateLoading", function(a) {
    r(a.detail);
  }), (a, i) => (D(), Q(Z, { name: "fade-loading" }, { default: W(() => [t() == false ? (D(), X("div", De, [P("div", Ee, [P("div", { class: "boxel", style: E({ left: `calc(${B(e).percent}% - 1em)` }) }, null, 4), P("div", { class: "progress", style: E({ width: B(e).percent + "%" }) }, null, 4)]), P("div", ke, "Loading: " + J(B(e).percent) + "%", 1)])) : $("", true)]), _: 1 }));
