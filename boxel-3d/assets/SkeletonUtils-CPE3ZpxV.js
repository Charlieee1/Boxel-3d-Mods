...
const ft = {}, Ns = [], Hn = () => {
}, og = () => false, Sa = (n) => n.charCodeAt(0) === 111 && n.charCodeAt(1) === 110 && (n.charCodeAt(2) > 122 || n.charCodeAt(2) < 97), iu = (n) => n.startsWith("onUpdate:"), Rt = Object.assign, su = (n, e) => {
  const t = n.indexOf(e);
  t > -1 && n.splice(t, 1);
}, ag = Object.prototype.hasOwnProperty, st = (n, e) => ag.call(n, e), ze = Array.isArray, Us = (n) => ba(n) === "[object Map]", Ed = (n) => ba(n) === "[object Set]", We = (n) => typeof n == "function", Mt = (n) => typeof n == "string", di = (n) => typeof n == "symbol", _t = (n) => n !== null && typeof n == "object", Ad = (n) => (_t(n) || We(n)) && We(n.then) && We(n.catch), wd = Object.prototype.toString, ba = (n) => wd.call(n), lg = (n) => ba(n).slice(8, -1), Rd = (n) => ba(n) === "[object Object]", ru = (n) => Mt(n) && n !== "NaN" && n[0] !== "-" && "" + parseInt(n, 10) === n, br = /* @__PURE__ */ nu(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"), Ta = (n) => {
  const e = /* @__PURE__ */ Object.create(null);
  return (t) => e[t] || (e[t] = n(t));
}, cg = /-(\w)/g, Mn = Ta((n) => n.replace(cg, (e, t) => t ? t.toUpperCase() : "")), ug = /\B([A-Z])/g, Ui = Ta((n) => n.replace(ug, "-$1").toLowerCase()), Ea = Ta((n) => n.charAt(0).toUpperCase() + n.slice(1)), ka = Ta((n) => n ? `on${Ea(n)}` : ""), Pi = (n, e) => !Object.is(n, e), Zo = (n, ...e) => {
...
let rh;
const Aa = () => rh || (rh = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : typeof global < "u" ? global : {});
function ou(n) {
  if (ze(n)) {
    const e = {};
    for (let t = 0; t < n.length; t++) {
      const i = n[t], s = Mt(i) ? mg(i) : ou(i);
...
const gg = "itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly", _g = /* @__PURE__ */ nu(gg);
function Cd(n) {
  return !!n || n === "";
}
const Pd = (n) => !!(n && n.__v_isRef === true), xg = (n) => Mt(n) ? n : n == null ? "" : ze(n) || _t(n) && (n.toString === wd || !We(n.toString)) ? Pd(n) ? xg(n.value) : JSON.stringify(n, Ld, 2) : String(n), Ld = (n, e) => Pd(e) ? Ld(n, e.value) : Us(e) ? { [`Map(${e.size})`]: [...e.entries()].reduce((t, [i, s], r) => (t[Ga(i, r) + " =>"] = s, t), {}) } : Ed(e) ? { [`Set(${e.size})`]: [...e.values()].map((t) => Ga(t)) } : di(e) ? Ga(e) : _t(e) && !ze(e) && !Rd(e) ? String(e) : e, Ga = (n, e = "") => {
  var t;
...
class Dd {
  ...
  stop() {
    if (this.flags & 1) {
      for (let e = this.deps; e; e = e.nextDep) uu(e);
...
function Fd(n) {
  ...
  for (; i; ) {
    const s = i.prevDep;
    i.version === -1 ? (i === t && (t = s), uu(i), yg(i)) : e = i, i.dep.activeLink = i.prevActiveLink, i.prevActiveLink = void 0, i = s;
  }
...
function Bd(n) {
  if (n.flags & 4 && !(n.flags & 16) || (n.flags &= -17, n.globalVersion === Ur) || (n.globalVersion = Ur, !n.isSSR && n.flags & 128 && (!n.deps && !n._dirty || !ql(n)))) return;
  n.flags |= 2;
...
function uu(n, e = false) {
  ...
  if (i && (i.nextSub = s, n.prevSub = void 0), s && (s.prevSub = i, n.nextSub = void 0), t.subs === n && (t.subs = i, !i && t.computed)) {
    t.computed.flags &= -5;
    for (let r = t.computed.deps; r; r = r.nextDep) uu(r, true);
  }
...
const jl = /* @__PURE__ */ new WeakMap(), rs = Symbol(""), Kl = Symbol(""), Or = Symbol("");
function Ht(n, e, t) {
  if (Cn && pt) {
    let i = jl.get(n);
    i || jl.set(n, i = /* @__PURE__ */ new Map());
    let s = i.get(t);
    s || (i.set(t, s = new hu()), s.map = i, s.key = t), s.track();
  }
}
function ii(n, e, t, i, s, r) {
  ...
  if (lu(), e === "clear") o.forEach(a);
  else {
    const l = ze(n), c = l && ru(t);
    if (l && t === "length") {
      const u = Number(i);
      o.forEach((h, f) => {
        (f === "length" || f === Or || !di(f) && f >= u) && a(h);
      });
    } else switch ((t !== void 0 || o.has(void 0)) && a(o.get(t)), c && a(o.get(Or)), e) {
      case "add":
        l ? c && a(o.get("length")) : (a(o.get(rs)), Us(n) && a(o.get(Kl)));
        break;
      case "delete":
        l || (a(o.get(rs)), Us(n) && a(o.get(Kl)));
        break;
      case "set":
        Us(n) && a(o.get(rs));
        break;
...
function hs(n) {
  const e = nt(n);
  return e === n ? e : (Ht(e, "iterate", Or), _n(n) ? e : e.map(Nt));
}
function wa(n) {
  return Ht(n = nt(n), "iterate", Or), n;
}
const Sg = { __proto__: null, [Symbol.iterator]() {
  return Xa(this, Symbol.iterator, Nt);
}, concat(...n) {
  return hs(this).concat(...n.map((e) => ze(e) ? hs(e) : e));
}, entries() {
  return Xa(this, "entries", (n) => (n[1] = Nt(n[1]), n));
}, every(n, e) {
  ...
  return Ya(this, "includes", n);
}, indexOf(...n) {
  return Ya(this, "indexOf", n);
}, join(n) {
  return hs(this).join(n);
}, lastIndexOf(...n) {
  return Ya(this, "lastIndexOf", n);
}, map(n, e) {
  return qn(this, "map", n, e, void 0, arguments);
}, pop() {
  return ar(this, "pop");
}, push(...n) {
  return ar(this, "push", n);
}, reduce(n, ...e) {
  return ah(this, "reduce", n, e);
}, reduceRight(n, ...e) {
  return ah(this, "reduceRight", n, e);
}, shift() {
  return ar(this, "shift");
}, some(n, e) {
  return qn(this, "some", n, e, void 0, arguments);
}, splice(...n) {
  return ar(this, "splice", n);
}, toReversed() {
  ...
  return ar(this, "unshift", n);
}, values() {
  return Xa(this, "values", Nt);
} };
function Xa(n, e, t) {
  const i = wa(n), s = i[e]();
...
function Ya(n, e, t) {
  ...
  Ht(i, "iterate", Or);
  const s = i[e](...t);
  return (s === -1 || s === false) && mu(t[0]) ? (t[0] = nt(t[0]), i[e](...t)) : s;
}
function ar(n, e, t = []) {
  ui(), lu();
...
const Tg = /* @__PURE__ */ nu("__proto__,__v_isRef,__isVue"), Vd = new Set(Object.getOwnPropertyNames(Symbol).filter((n) => n !== "arguments" && n !== "caller").map((n) => Symbol[n]).filter(di));
function Eg(n) {
  di(n) || (n = String(n));
  const e = nt(this);
...
class kd {
  ...
  get(e, t, i) {
    ...
    return (di(t) ? Vd.has(t) : Tg(t)) || (s || Ht(e, "get", t), r) ? a : Gt(a) ? o && ru(t) ? a : a.value : _t(a) ? s ? qd(a) : du(a) : a;
  }
}
class Gd extends kd {
  constructor(e = false) {
  ...
  set(e, t, i, s) {
    ...
    if (!this._isShallow) {
      const l = Ii(r);
      if (!_n(i) && !Ii(i) && (r = nt(r), i = nt(i)), !ze(e) && Gt(r) && !Gt(i)) return l ? false : (r.value = i, true);
    }
    const o = ze(e) && ru(t) ? Number(t) < e.length : st(e, t), a = Reflect.set(e, t, i, Gt(e) ? e : s);
  ...
  has(e, t) {
    ...
    return (!di(t) || !Vd.has(t)) && Ht(e, "has", t), i;
  }
  ownKeys(e) {
...
const Zl = (n) => n, ao = (n) => Reflect.getPrototypeOf(n);
function Pg(n, e, t) {
  return function(...i) {
    const s = this.__v_raw, r = nt(s), o = Us(r), a = n === "entries" || n === Symbol.iterator && o, l = n === "keys" && o, c = s[n](...i), u = t ? Zl : e ? la : Nt;
    return !e && Ht(r, "iterate", l ? Kl : rs), { next() {
...
function Lg(n, e) {
  const t = { get(s) {
    ...
    const { has: l } = ao(o), c = e ? Zl : n ? la : Nt;
    ...
    const o = this, a = o.__v_raw, l = nt(a), c = e ? Zl : n ? la : Nt;
    return !n && Ht(l, "iterate", rs), a.forEach((u, h) => s.call(r, c(u), c(h), o));
  } };
  return Rt(t, n ? { add: lo("add"), set: lo("set"), delete: lo("delete"), clear: lo("clear") } : { add(s) {
    !e && !_n(s) && !Ii(s) && (s = nt(s));
    const r = nt(this);
    return ao(r).has.call(r, s) || (r.add(s), ii(r, "add", s, s)), this;
  }, set(s, r) {
    !e && !_n(r) && !Ii(r) && (r = nt(r));
    const o = nt(this), { has: a, get: l } = ao(o);
    let c = a.call(o, s);
    c || (s = nt(s), c = a.call(o, s));
    const u = l.call(o, s);
    return o.set(s, r), c ? Pi(r, u) && ii(o, "set", s, r) : ii(o, "add", s, r), this;
  }, delete(s) {
    const r = nt(this), { has: o, get: a } = ao(r);
    let l = o.call(r, s);
...
function fu(n, e) {
  const t = Lg(n, e);
  return (i, s, r) => s === "__v_isReactive" ? !n : s === "__v_isReadonly" ? n : s === "__v_raw" ? i : Reflect.get(st(t, s) && s in i ? t : i, s, r);
}
const Ig = { get: fu(false, false) }, Dg = { get: fu(false, true) }, Ng = { get: fu(true, false) };
...
function du(n) {
  return Ii(n) ? n : pu(n, false, wg, Ig, Wd);
}
function Bg(n) {
  return pu(n, false, Cg, Dg, Xd);
}
function qd(n) {
  return pu(n, true, Rg, Ng, Yd);
}
...
function Os(n) {
  return Ii(n) ? Os(n.__v_raw) : !!(n && n.__v_isReactive);
}
function Ii(n) {
...
function zg(n) {
  return !st(n, "__v_skip") && Object.isExtensible(n) && Xl(n, "__v_skip", true), n;
}
const Nt = (n) => _t(n) ? du(n) : n, la = (n) => _t(n) ? qd(n) : n;
function Gt(n) {
...
class Hg {
  constructor(e, t) {
    this.dep = new hu(), this.__v_isRef = true, this.__v_isShallow = false, this._rawValue = t ? e : nt(e), this._value = t ? e : Nt(e), this.__v_isShallow = t;
  }
  get value() {
...
function Kd(n) {
  return Os(n) ? n : new Proxy(n, kg);
}
class Gg {
  constructor(e, t, i) {
    this.fn = e, this.setter = t, this._value = void 0, this.dep = new hu(this), this.__v_isRef = true, this.deps = void 0, this.depsTail = void 0, this.flags = 16, this.globalVersion = Ur - 1, this.next = void 0, this.effect = this, this.__v_isReadonly = !t, this.isSSR = i;
  }
  notify() {
...
const co = {}, ca = /* @__PURE__ */ new WeakMap();
let Qi;
function Xg(n, e = false, t = Qi) {
  if (t) {
    let i = ca.get(t);
    i || ca.set(t, i = []), i.push(n);
  }
}
function Yg(n, e, t = ft) {
  ...
  if (Gt(n) ? (h = () => n.value, m = _n(n)) : Os(n) ? (h = () => c(n), m = true) : ze(n) ? (_ = true, m = n.some((x) => Os(x) || _n(x)), h = () => n.map((x) => {
  ...
  const g = vg(), p = () => {
    u.stop(), g && g.active && su(g.effects, u);
  };
  if (r && e) {
    const x = e;
    e = (...P) => {
  ...
  let E = _ ? new Array(n.length).fill(co) : co;
  const b = (x) => {
    if (!(!(u.flags & 1) || !u.dirty && !x)) if (e) {
      ...
      if (s || m || (_ ? P.some((w, C) => Pi(w, E[C])) : Pi(P, E))) {
        ...
        Qi = u;
        try {
          const C = [P, E === co ? void 0 : _ && E[0] === co ? [] : E, d];
          E = P, l ? l(e, 3, C) : e(...C);
        } finally {
          Qi = w;
        }
...
function si(n, e = 1 / 0, t) {
  if (e <= 0 || !_t(n) || n.__v_skip || (t = t || /* @__PURE__ */ new Set(), t.has(n))) return n;
  if (t.add(n), e--, Gt(n)) si(n.value, e, t);
  else if (ze(n)) for (let i = 0; i < n.length; i++) si(n[i], e, t);
  else if (Ed(n) || Us(n)) n.forEach((i) => {
    si(i, e, t);
  });
  else if (Rd(n)) {
...
function gu(n) {
  if (!(n.flags & 1)) {
    const e = Fr(n), t = Kt[Kt.length - 1];
    !t || !(n.flags & 2) && e >= Fr(t) ? Kt.push(n) : Kt.splice(Kg(e), 0, n), n.flags |= 1, Jd();
  }
}
function Jd() {
  ua || (ua = Zd.then($d));
...
function Zg(n) {
  ze(n) ? Fs.push(...n) : Ei && n.id === -1 ? Ei.splice(Rs + 1, 0, n) : n.flags & 1 || (Fs.push(n), n.flags |= 1), Jd();
}
function lh(n, e, t = Un + 1) {
  for (; t < Kt.length; t++) {
    const i = Kt[t];
    if (i && i.flags & 2) {
...
function Qd(n) {
  if (Fs.length) {
    const e = [...new Set(Fs)].sort((t, i) => Fr(t) - Fr(i));
    if (Fs.length = 0, Ei) {
      Ei.push(...e);
      return;
    }
    for (Ei = e, Rs = 0; Rs < Ei.length; Rs++) {
      const t = Ei[Rs];
...
const Fr = (n) => n.id == null ? n.flags & 2 ? -1 : 1 / 0 : n.id;
function $d(n) {
  try {
    for (Un = 0; Un < Kt.length; Un++) {
      const e = Kt[Un];
      e && !(e.flags & 8) && (e.flags & 4 && (e.flags &= -2), $r(e, e.i, e.i ? 15 : 14), e.flags & 4 || (e.flags &= -2));
    }
  } finally {
    for (; Un < Kt.length; Un++) {
      const e = Kt[Un];
    ...
    Un = -1, Kt.length = 0, Qd(), ua = null, (Kt.length || Fs.length) && $d();
  }
}
let It = null, ep = null;
function ha(n) {
  const e = It;
  return It = n, ep = n && n.type.__scopeId || null, e;
}
function Jg(n, e = It, t) {
  if (!e || n._n) return n;
  const i = (...s) => {
    i._d && Sh(-1);
    const r = ha(e);
...
const tp = Symbol("_vte"), np = (n) => n.__isTeleport, Ar = (n) => n && (n.disabled || n.disabled === ""), ch = (n) => n && (n.defer || n.defer === ""), uh = (n) => typeof SVGElement < "u" && n instanceof SVGElement, hh = (n) => typeof MathMLElement == "function" && n instanceof MathMLElement, Jl = (n, e) => {
  const t = n && n.to;
  return Mt(t) ? e ? e(t) : null : t;
}, ip = { name: "Teleport", __isTeleport: true, process(n, e, t, i, s, r, o, a, l, c) {
  const { mc: u, pc: h, pbc: f, o: { insert: d, querySelector: m, createText: _, createComment: g } } = c, p = Ar(e.props);
  ...
  if (n == null) {
    ...
    const C = (S, M) => {
      ...
      const S = e.target = Jl(e.props, m), M = sp(S, e, _, d);
      S && (o !== "svg" && uh(S) ? o = "svg" : o !== "mathml" && hh(S) && (o = "mathml"), p || (C(S, M), Jo(e, false)));
    };
    p && (C(t, w), Jo(e, true)), ch(e.props) ? (e.el.__isMounted = false, jt(() => {
      I(), delete e.el.__isMounted;
    }, r)) : I();
  } else {
    if (ch(e.props) && n.el.__isMounted === false) {
      jt(() => {
    ...
    const P = e.anchor = n.anchor, w = e.target = n.target, C = e.targetAnchor = n.targetAnchor, I = Ar(n.props), S = I ? t : w, M = I ? P : C;
    if (o === "svg" || uh(w) ? o = "svg" : (o === "mathml" || hh(w)) && (o = "mathml"), x ? (f(n.dynamicChildren, x, S, s, r, o, a), yu(n, e, true)) : l || h(n, e, S, M, s, r, o, a, false), p) I ? e.props && n.props && e.props.to !== n.props.to && (e.props.to = n.props.to) : uo(e, t, P, c, 1);
    else if ((e.props && e.props.to) !== (n.props && n.props.to)) {
      const L = e.target = Jl(e.props, m);
      L && uo(e, L, null, c, 0);
    } else I && uo(e, w, C, c, 1);
    Jo(e, p);
  }
...
const Ai = Symbol("_leaveCb"), ho = Symbol("_enterCb");
function rp() {
...
const dn = [Function, Array], op = { mode: String, appear: Boolean, persisted: Boolean, onBeforeEnter: dn, onEnter: dn, onAfterEnter: dn, onEnterCancelled: dn, onBeforeLeave: dn, onLeave: dn, onAfterLeave: dn, onLeaveCancelled: dn, onBeforeAppear: dn, onAppear: dn, onAfterAppear: dn, onAppearCancelled: dn }, ap = (n) => {
  const e = n.subTree;
  return e.component ? ap(e.component) : e;
}, $g = { name: "BaseTransition", props: op, setup(n, { slots: e }) {
  const t = zp(), i = rp();
  return () => {
    const s = e.default && _u(e.default(), true);
    if (!s || !s.length) return;
    const r = lp(s), o = nt(n), { mode: a } = o;
    if (i.isLeaving) return qa(r);
    const l = fh(r);
    if (!l) return qa(r);
    let c = Br(l, o, i, t, (h) => c = h);
    l.type !== Vt && os(l, c);
    let u = t.subTree && fh(t.subTree);
...
function Br(n, e, t, i, s) {
  const { appear: r, mode: o, persisted: a = false, onBeforeEnter: l, onEnter: c, onAfterEnter: u, onEnterCancelled: h, onBeforeLeave: f, onLeave: d, onAfterLeave: m, onLeaveCancelled: _, onBeforeAppear: g, onAppear: p, onAfterAppear: E, onAppearCancelled: b } = e, x = String(n.key), P = cp(t, n), w = (S, M) => {
    ...
    S[Ai] && S[Ai](true);
    const L = P[x];
    L && ts(n, L) && L.el[Ai] && L.el[Ai](), w(M, [S]);
  }, enter(S) {
    let M = c, L = u, O = h;
    ...
    let X = false;
    const Q = S[ho] = (ne) => {
      X || (X = true, ne ? w(O, [S]) : w(L, [S]), I.delayedLeave && I.delayedLeave(), S[ho] = void 0);
    };
    M ? C(M, [S, Q]) : Q();
  }, leave(S, M) {
    const L = String(n.key);
    if (S[ho] && S[ho](true), t.isUnmounting) return M();
    w(f, [S]);
    let O = false;
    const X = S[Ai] = (Q) => {
      O || (O = true, M(), Q ? w(_, [S]) : w(m, [S]), S[Ai] = void 0, P[L] === n && delete P[L]);
    };
    P[L] = n, d ? C(d, [S, X]) : X();
  }, clone(S) {
    const M = Br(S, e, t, i, s);
    return s && s(M), M;
  } };
  return I;
}
function qa(n) {
  if (Ca(n)) return n = Di(n), n.children = null, n;
}
function fh(n) {
  if (!Ca(n)) return np(n.type) && n.children ? lp(n.children) : n;
...
function _u(n, e = false, t) {
  let i = [], s = 0;
  for (let r = 0; r < n.length; r++) {
    let o = n[r];
    const a = t == null ? o.key : String(t) + String(o.key != null ? o.key : r);
    o.type === en ? (o.patchFlag & 128 && s++, i = i.concat(_u(o.children, e, a))) : (e || o.type !== Vt) && i.push(a != null ? Di(o, { key: a }) : o);
  }
...
function wr(n, e, t, i, s = false) {
  if (ze(n)) {
    n.forEach((m, _) => wr(m, e && (ze(e) ? e[_] : e), t, i, s));
    return;
  }
  if (Bs(i) && !s) {
    i.shapeFlag & 512 && i.type.__asyncResolved && i.component.subTree.component && wr(n, e, t, i.component.subTree);
    return;
  }
  const r = i.shapeFlag & 4 ? Da(i.component) : i.el, o = s ? null : r, { i: a, r: l } = n, c = e && e.r, u = a.refs === ft ? a.refs = {} : a.refs, h = a.setupState, f = nt(h), d = h === ft ? () => false : (m) => st(f, m);
  if (c != null && c !== l && (Mt(c) ? (u[c] = null, d(c) && (h[c] = null)) : Gt(c) && (c.value = null)), We(l)) $r(l, a, 12, [o, u]);
  else {
    const m = Mt(l), _ = Gt(l);
    if (m || _) {
      const g = () => {
        if (n.f) {
          ...
          s ? ze(p) && su(p, r) : ze(p) ? p.includes(r) || p.push(r) : m ? (u[l] = [r], d(l) && (h[l] = u[l])) : (l.value = [r], n.k && (u[n.k] = l.value));
...
const Bs = (n) => !!n.type.__asyncLoader, Ca = (n) => n.type.__isKeepAlive;
function t_(n, e) {
  hp(n, "a", e);
}
function n_(n, e) {
...
function hp(n, e, t = Ut) {
  ...
  if (Pa(e, i, t), t) {
    let s = t.parent;
    for (; s && s.parent; ) Ca(s.parent.vnode) && i_(i, e, t, s), s = s.parent;
  }
}
function i_(n, e, t, i) {
  const s = Pa(e, n, i, true);
  mp(() => {
    su(i[e], s);
  }, t);
}
function Pa(n, e, t = Ut, i = false) {
  if (t) {
    const s = t[n] || (t[n] = []), r = e.__weh || (e.__weh = (...o) => {
      ui();
      const a = eo(t), l = Pn(e, t, n, o);
      return a(), hi(), l;
    });
...
const pi = (n) => (e, t = Ut) => {
  (!Vr || n === "sp") && Pa(n, (...i) => e(...i), t);
}, s_ = pi("bm"), fp = pi("m"), r_ = pi("bu"), dp = pi("u"), pp = pi("bum"), mp = pi("um"), o_ = pi("sp"), a_ = pi("rtg"), l_ = pi("rtc");
function c_(n, e = Ut) {
  Pa("ec", n, e);
}
const gp = "components";
...
function dA(n) {
  return Mt(n) ? xp(gp, n, false) || n : n || _p;
}
function xp(n, e, t = true, i = false) {
  ...
  if (s) {
    ...
    {
      const a = J_(r, false);
      if (a && (a === e || a === Mn(e) || a === Ea(Mn(e)))) return r;
    }
    const o = dh(s[n] || r[n], e) || dh(s.appContext[n], e);
    return !o && i ? r : o;
  }
}
function dh(n, e) {
  return n && (n[e] || n[Mn(e)] || n[Ea(Mn(e))]);
}
function pA(n, e, t, i) {
  let s;
  const r = t, o = ze(n);
  if (o || Mt(n)) {
    const a = o && Os(n);
    let l = false, c = false;
    a && (l = !_n(n), c = Ii(n), n = wa(n)), s = new Array(n.length);
    for (let u = 0, h = n.length; u < h; u++) s[u] = e(l ? c ? la(Nt(n[u])) : Nt(n[u]) : n[u], u, void 0, r);
...
function mA(n, e, t = {}, i, s) {
  if (It.ce || It.parent && Bs(It.parent) && It.parent.ce) return e !== "default" && (t.name = e), nc(), ic(en, null, [Zt("slot", t, i)], 64);
  let r = n[e];
  r && r._c && (r._d = false), nc();
  const o = r && vp(r(t)), a = t.key || o && o.key, l = ic(en, { key: (a && !di(a) ? a : `_${e}`) + "" }, o || [], o && n._ === 1 ? 64 : -2);
  return r && r._c && (r._d = true), l;
}
function vp(n) {
  return n.some((e) => Hr(e) ? !(e.type === Vt || e.type === en && !vp(e.children)) : true) ? n : null;
}
const Ql = (n) => n ? Hp(n) ? Da(n) : Ql(n.parent) : null, Rr = Rt(/* @__PURE__ */ Object.create(null), { $: (n) => n, $el: (n) => n.vnode.el, $data: (n) => n.data, $props: (n) => n.props, $attrs: (n) => n.attrs, $slots: (n) => n.slots, $refs: (n) => n.refs, $parent: (n) => Ql(n.parent), $root: (n) => Ql(n.root), $host: (n) => n.ce, $emit: (n) => n.emit, $options: (n) => Mp(n), $forceUpdate: (n) => n.f || (n.f = () => {
  gu(n.update);
}), $nextTick: (n) => n.n || (n.n = jg.bind(n.proxy)), $watch: (n) => L_.bind(n) }), ja = (n, e) => n !== ft && !n.__isScriptSetup && st(n, e), u_ = { get({ _: n }, e) {
  ...
  if (e[0] !== "$") {
    ...
    if (d !== void 0) switch (d) {
      ...
      if (s !== ft && st(s, e)) return o[e] = 2, s[e];
      if ((c = n.propsOptions[0]) && st(c, e)) return o[e] = 3, r[e];
      if (t !== ft && st(t, e)) return o[e] = 4, t[e];
      $l && (o[e] = 0);
    }
  }
  const u = Rr[e];
  ...
  if (t !== ft && st(t, e)) return o[e] = 4, t[e];
  if (f = l.config.globalProperties, st(f, e)) return f[e];
}, set({ _: n }, e, t) {
  const { data: i, setupState: s, ctx: r } = n;
  return ja(s, e) ? (s[e] = t, true) : i !== ft && st(i, e) ? (i[e] = t, true) : st(n.props, e) || e[0] === "$" && e.slice(1) in n ? false : (r[e] = t, true);
}, has({ _: { data: n, setupState: e, accessCache: t, ctx: i, appContext: s, propsOptions: r } }, o) {
  let a;
  return !!t[o] || n !== ft && st(n, o) || ja(e, o) || (a = r[0]) && st(a, o) || st(i, o) || st(Rr, o) || st(s.config.globalProperties, o);
}, defineProperty(n, e, t) {
  return t.get != null ? n._.accessCache[e] = 0 : st(t, "value") && this.set(n, e, t.value, null), Reflect.defineProperty(n, e, t);
} };
function ph(n) {
...
function h_(n) {
  ...
  $l = false, e.beforeCreate && mh(e.beforeCreate, n, "bc");
  ...
  if ($l = true, r) for (const se in r) {
    const j = r[se], de = We(j) ? j.bind(t, t) : We(j.get) ? j.get.bind(t, t) : Hn, ve = !We(j) && We(j.set) ? j.set.bind(t) : Hn, be = $_({ get: de, set: ve });
    Object.defineProperty(i, se, { enumerable: true, configurable: true, get: () => be.value, set: (Oe) => be.value = Oe });
  }
...
function f_(n, e, t = Hn) {
  ...
  for (const i in n) {
    const s = n[i];
    let r;
    _t(s) ? "default" in s ? r = Qo(s.from || i, s.default, true) : r = Qo(s.from || i) : r = Qo(s), Gt(r) ? Object.defineProperty(e, i, { enumerable: true, configurable: true, get: () => r.value, set: (o) => r.value = o }) : e[i] = r;
  }
}
function mh(n, e, t) {
...
function yp(n, e, t, i) {
  ...
  if (Mt(n)) {
    const r = e[n];
    We(r) && Za(s, r);
  } else if (We(n)) Za(s, n.bind(t));
  else if (_t(n)) if (ze(n)) n.forEach((r) => yp(r, e, t, i));
  else {
...
function Mp(n) {
  ...
  let l;
  return a ? l = a : !s.length && !t && !i ? l = e : (l = {}, s.length && s.forEach((c) => fa(l, c, o, true)), fa(l, e, o)), _t(e) && r.set(e, l), l;
}
function fa(n, e, t, i = false) {
  const { mixins: s, extends: r } = e;
  r && fa(n, r, t, true), s && s.forEach((o) => fa(n, o, t, true));
...
function _h(n, e) {
  return n ? ze(n) && ze(e) ? [.../* @__PURE__ */ new Set([...n, ...e])] : Rt(/* @__PURE__ */ Object.create(null), ph(n), ph(e ?? {})) : e;
}
function m_(n, e) {
  if (!n) return e;
  if (!e) return n;
...
function __(n, e) {
  return function(i, s = null) {
    We(i) || (i = Rt({}, i)), s != null && !_t(s) && (s = null);
    ...
    const c = r.app = { _uid: g_++, _component: i, _props: s, _container: null, _context: r, _instance: null, version: tx, get config() {
      ...
      if (!l) {
        ...
        return d.appContext = r, f === true ? f = "svg" : f === false && (f = void 0), n(d, u, f), l = true, c._container = u, u.__vue_app__ = c, Da(d.component);
      }
    }, onUnmount(u) {
      a.push(u);
    }, unmount() {
...
function Qo(n, e, t = false) {
  const i = Ut || It;
  if (i || zs) {
    let s = zs ? zs._context.provides : i ? i.parent == null || i.ce ? i.vnode.appContext && i.vnode.appContext.provides : i.parent.provides : void 0;
  ...
  if ((i || o > 0) && !(o & 16)) {
    if (o & 8) {
      ...
      for (let h = 0; h < u.length; h++) {
        let f = u[h];
        if (La(n.emitsOptions, f)) continue;
        const d = e[f];
        if (l) if (st(r, f)) d !== r[f] && (r[f] = d, c = true);
        else {
          const m = Mn(f);
          s[m] = tc(l, a, m, d, n, false);
        }
    ...
    Ap(n, e, s, r) && (c = true);
    let u;
    for (const h in a) (!e || !st(e, h) && ((u = Ui(h)) === h || !st(e, u))) && (l ? t && (t[h] !== void 0 || t[u] !== void 0) && (s[h] = tc(l, a, h, void 0, n, true)) : delete s[h]);
    if (r !== a) for (const h in r) (!e || !st(e, h)) && (delete r[h], c = true);
  }
  c && ii(n.attrs, "set", "");
}
function Ap(n, e, t, i) {
  ...
  if (e) for (let l in e) {
    ...
    const c = e[l];
    let u;
    s && st(s, u = Mn(l)) ? !r || !r.includes(u) ? t[u] = c : (a || (a = {}))[u] = c : La(n.emitsOptions, l) || (!(l in i) || c !== i[l]) && (i[l] = c, o = true);
  }
  if (r) {
    const l = nt(t), c = a || ft;
    for (let u = 0; u < r.length; u++) {
      const h = r[u];
      t[h] = tc(s, l, h, c[h], n, !st(c, h));
    }
  }
  return o;
}
...
function wp(n, e, t = false) {
  ...
  if (!r && !l) return _t(n) && i.set(n, Ns), Ns;
  if (ze(r)) for (let u = 0; u < r.length; u++) {
    ...
    const h = Mn(u);
    if (xh(h)) {
      const f = r[u], d = o[h] = ze(f) || We(f) ? { type: f } : Rt({}, f), m = d.type;
      let _ = false, g = true;
      ...
      d[0] = _, d[1] = g, (_ || st(d, "default")) && a.push(h);
    }
  }
  const c = [o, a];
...
const xu = (n) => n[0] === "_" || n === "$stable", vu = (n) => ze(n) ? n.map(On) : [On(n)], S_ = (n, e, t) => {
  if (e._n) return e;
  const i = Jg((...s) => vu(e(...s)), t);
  return i._c = false, i;
}, Rp = (n, e, t) => {
  const i = n._ctx;
  for (const s in n) {
  ...
  for (const i in e) (t || !xu(i)) && (n[i] = e[i]);
}, b_ = (n, e, t) => {
  const i = n.slots = Tp();
  if (n.vnode.shapeFlag & 32) {
    ...
    s && Xl(i, "__", s, true);
    const r = e._;
    r ? (Pp(i, e, t), t && Xl(i, "_", r, true)) : Rp(e, i);
  } else e && Cp(n, e);
}, T_ = (n, e, t) => {
  ...
  if (r) for (const a in s) !xu(a) && o[a] == null && delete s[a];
}, jt = B_;
function E_(n) {
  return A_(n);
}
function A_(n, e) {
  ...
  const { insert: i, remove: s, patchProp: r, createElement: o, createText: a, createComment: l, setText: c, setElementText: u, parentNode: h, nextSibling: f, setScopeId: d = Hn, insertStaticContent: m } = n, _ = (R, D, y, V = null, F = null, H = null, z = void 0, J = null, G = !!D.dynamicChildren) => {
    if (R === D) return;
    R && !ts(R, D) && (V = ge(R), Oe(R, F, H, true), R = null), D.patchFlag === -2 && (G = false, D.dynamicChildren = null);
    ...
    ae != null && F ? wr(ae, R && R.ref, H, D || R, !D) : ae == null && R && R.ref != null && wr(R.ref, null, H, R, true);
  }, g = (R, D, y, V) => {
    ...
    if (G = R.el = o(R.type, H, ae && ae.is, ae), T & 8 ? u(G, R.children) : T & 16 && I(R.children, G, null, V, F, Ka(R, H), z, J), U && zi(R, null, V, "created"), C(G, R, R.scopeId, z, V), ae) {
      for (const te in ae) te !== "value" && !br(te) && r(G, te, null, ae[te], H, V);
    ...
    let U;
    if (y && Hi(y, false), (U = v.onVnodeBeforeUpdate) && Dn(U, y, D, R), ae && zi(D, R, y, "beforeUpdate"), y && Hi(y, true), (T.innerHTML && v.innerHTML == null || T.textContent && v.textContent == null) && u(J, ""), q ? M(R.dynamicChildren, q, J, y, V, Ka(D, F), H) : z || j(R, D, J, null, y, V, Ka(D, F), H, false), G > 0) {
      if (G & 16) L(J, T, v, y, F);
        ...
        for (let te = 0; te < Y.length; te++) {
          const K = Y[te], xe = T[K], ce = v[K];
          (ce !== xe || K === "value") && r(J, K, xe, ce, F, y);
        }
      }
    ...
    if (D !== y) {
      if (D !== ft) for (const H in D) !br(H) && !(H in y) && r(R, H, D[H], null, F, V);
      for (const H in y) {
        if (br(H)) continue;
        const z = y[H], J = D[H];
    ...
    U && (J = J ? J.concat(U) : U), R == null ? (i(q, y, V), i(ae, y, V), I(D.children || [], y, ae, F, H, z, J, G)) : T > 0 && T & 64 && v && R.dynamicChildren ? (M(R.dynamicChildren, v, y, F, H, z, J), (D.key != null || F && D === F.subTree) && yu(R, D, true)) : j(R, D, y, ae, F, H, z, J, G);
  }, X = (R, D, y, V, F, H, z, J, G) => {
    D.slotScopeIds = J, R == null ? D.shapeFlag & 512 ? F.ctx.activate(D, y, V, z, G) : Q(D, y, V, F, H, z, G) : ne(R, D, G);
  }, Q = (R, D, y, V, F, H, z) => {
    const J = R.component = Y_(R, V, F);
    if (Ca(R) && (J.ctx.renderer = Ne), q_(J, false, z), J.asyncDep) {
    ...
    const J = () => {
      if (R.isMounted) {
        ...
        let K = T, xe;
        Hi(R, false), T ? (T.el = te.el, se(R, T, z)) : T = te, v && Zo(v), (xe = T.props && T.props.onVnodeBeforeUpdate) && Dn(xe, Y, T, te), Hi(R, true);
        const ce = yh(R), ye = R.subTree;
        R.subTree = ce, _(ye, ce, h(ye.el), ge(ye), R, F, H), T.el = ce.el, K === null && F_(R, ce.el), U && jt(U, F), (xe = T.props && T.props.onVnodeUpdated) && jt(() => Dn(xe, Y, T, te), F);
      } else {
        let T;
        const { el: v, props: U } = D, { bm: Y, m: te, parent: K, root: xe, type: ce } = R, ye = Bs(D);
        Hi(R, false), Y && Zo(Y), !ye && (T = U && U.onVnodeBeforeMount) && Dn(T, K, D), Hi(R, true);
        {
          xe.ce && xe.ce._def.shadowRoot !== false && xe.ce._injectChildStyle(ce);
          const Te = R.subTree = yh(R);
        ...
        (D.shapeFlag & 256 || K && Bs(K.vnode) && K.vnode.shapeFlag & 256) && R.a && jt(R.a, F), R.isMounted = true, D = y = V = null;
      }
    };
    R.scope.on();
    ...
    ae.i = R, ae.id = R.uid, G.scheduler = () => gu(ae), Hi(R, true), q();
  }, se = (R, D, y) => {
    D.component = R;
    const V = R.vnode.props;
    R.vnode = D, R.next = null, y_(R, D.props, V, y), T_(R, D.children, y), ui(), lh(R), hi();
  }, j = (R, D, y, V, F, H, z, J, G = false) => {
    const q = R && R.children, ae = R ? R.shapeFlag : 0, T = D.children, { patchFlag: v, shapeFlag: U } = D;
    if (v > 0) {
      if (v & 128) {
        ve(q, T, y, V, F, H, z, J, G);
        return;
      } else if (v & 256) {
    ...
    U & 8 ? (ae & 16 && we(q, F, H), T !== q && u(y, T)) : ae & 16 ? U & 16 ? ve(q, T, y, V, F, H, z, J, G) : we(q, F, H, true) : (ae & 8 && u(y, ""), U & 16 && I(T, y, V, F, H, z, J, G));
  }, de = (R, D, y, V, F, H, z, J, G) => {
    R = R || Ns, D = D || Ns;
    const q = R.length, ae = D.length, T = Math.min(q, ae);
    let v;
    for (v = 0; v < T; v++) {
      const U = D[v] = G ? wi(D[v]) : On(D[v]);
      _(R[v], U, y, null, F, H, z, J, G);
    }
    q > ae ? we(R, F, H, true, false, T) : I(D, y, V, F, H, z, J, G, T);
  }, ve = (R, D, y, V, F, H, z, J, G) => {
    let q = 0;
    const ae = D.length;
    let T = R.length - 1, v = ae - 1;
    for (; q <= T && q <= v; ) {
      const U = R[q], Y = D[q] = G ? wi(D[q]) : On(D[q]);
      if (ts(U, Y)) _(U, Y, y, null, F, H, z, J, G);
      else break;
      q++;
    }
    for (; q <= T && q <= v; ) {
      const U = R[T], Y = D[v] = G ? wi(D[v]) : On(D[v]);
      if (ts(U, Y)) _(U, Y, y, null, F, H, z, J, G);
      else break;
      T--, v--;
    }
    if (q > T) {
      if (q <= v) {
        ...
        for (; q <= v; ) _(null, D[q] = G ? wi(D[q]) : On(D[q]), y, Y, F, H, z, J, G), q++;
      }
    } else if (q > v) for (; q <= T; ) Oe(R[q], F, H, true), q++;
    else {
      const U = q, Y = q, te = /* @__PURE__ */ new Map();
      for (q = Y; q <= v; q++) {
        const Ce = D[q] = G ? wi(D[q]) : On(D[q]);
      ...
      for (q = U; q <= T; q++) {
        ...
        Le === void 0 ? Oe(Ce, F, H, true) : (oe[Le - Y] = q + 1, Le >= Te ? Te = Le : ye = true, _(Ce, D[Le], y, null, F, H, z, J, G), xe++);
      }
      const Ee = ye ? R_(oe) : Ns;
  ...
  }, Oe = (R, D, y, V = false, F = false) => {
    const { type: H, props: z, ref: J, children: G, dynamicChildren: q, shapeFlag: ae, patchFlag: T, dirs: v, cacheIndex: U } = R;
    if (T === -2 && (F = false), J != null && (ui(), wr(J, null, y, R, true), hi()), U != null && (D.renderCache[U] = void 0), ae & 256) {
      D.ctx.deactivate(R);
      return;
    }
    const Y = ae & 1 && v, te = !Bs(R);
    let K;
    ...
    vh(G), vh(q), V && Zo(V), ae && ze(T) && T.forEach((v) => {
      ae.renderCache[v] = void 0;
    }), F.stop(), H && (H.flags |= 8, Oe(z, R, D, y)), J && jt(J, D), jt(() => {
      R.isUnmounted = true;
    ...
    for (let z = H; z < R.length; z++) Oe(R[z], D, y, V, F);
  }, ge = (R) => {
  ...
  let Pe = false;
  const ke = (R, D, y) => {
    R == null ? D._vnode && Oe(D._vnode, null, null, true) : _(D._vnode || null, R, D, null, null, null, y), D._vnode = R, Pe || (Pe = true, lh(), Qd(), Pe = false);
  }, Ne = { p: _, um: Oe, m: be, r: Ze, mt: Q, mc: I, pc: j, pbc: M, n: ge, o: n };
...
function yu(n, e, t = false) {
  const i = n.children, s = e.children;
  if (ze(i) && ze(s)) for (let r = 0; r < i.length; r++) {
    const o = i[r];
    let a = s[r];
    a.shapeFlag & 1 && !a.dynamicChildren && ((a.patchFlag <= 0 || a.patchFlag === 32) && (a = s[r] = wi(s[r]), a.el = o.el), !t && a.patchFlag !== -2 && yu(o, a)), a.type === Ia && (a.el = o.el), a.type === Vt && !a.el && (a.el = o.el);
  }
}
function R_(n) {
  const e = n.slice(), t = [0];
...
const C_ = Symbol.for("v-scx"), P_ = () => Qo(C_);
function Za(n, e, t) {
  return Ip(n, e, t);
}
function Ip(n, e, t = ft) {
  ...
  const f = Yg(n, e, a);
  return Vr && (c ? c.push(f) : l && f()), f;
}
function L_(n, e, t) {
  const i = this.proxy, s = Mt(n) ? n.includes(".") ? Dp(i, n) : () => i[n] : n.bind(i, i);
  let r;
  We(e) ? r = e : (r = e.handler, t = e);
  const o = eo(this), a = Ip(s, r.bind(i), t);
  return o(), a;
}
function Dp(n, e) {
  const t = e.split(".");
...
const I_ = (n, e) => e === "modelValue" || e === "model-value" ? n.modelModifiers : n[`${e}Modifiers`] || n[`${Mn(e)}Modifiers`] || n[`${Ui(e)}Modifiers`];
function D_(n, e, ...t) {
  if (n.isUnmounted) return;
  const i = n.vnode.props || ft;
  let s = t;
  const r = e.startsWith("update:"), o = r && I_(i, e.slice(7));
  o && (o.trim && (s = t.map((u) => Mt(u) ? u.trim() : u)), o.number && (s = t.map(Yl)));
  let a, l = i[a = ka(e)] || i[a = ka(Mn(e))];
  !l && r && (l = i[a = ka(Ui(e))]), l && Pn(l, n, 6, s);
  const c = i[a + "Once"];
  if (c) {
...
function La(n, e) {
  return !n || !Sa(e) ? false : (e = e.slice(2).replace(/Once$/, ""), st(n, e[0].toLowerCase() + e.slice(1)) || st(n, Ui(e)) || st(n, e));
}
function yh(n) {
  const { type: e, vnode: t, proxy: i, withProxy: s, propsOptions: [r], slots: o, attrs: a, emit: l, render: c, renderCache: u, props: h, data: f, setupState: d, ctx: m, inheritAttrs: _ } = n, g = ha(n);
  let p, E;
  try {
    if (t.shapeFlag & 4) {
      const x = s || i, P = x;
    ...
    Cr.length = 0, Ra(x, n, 1), p = Zt(Vt);
  }
  let b = p;
  if (E && _ !== false) {
    const x = Object.keys(E), { shapeFlag: P } = b;
    x.length && P & 7 && (r && x.some(iu) && (E = U_(E, r)), b = Di(b, E, false, true));
  }
  return t.dirs && (b = Di(b, null, false, true), b.dirs = b.dirs ? b.dirs.concat(t.dirs) : t.dirs), t.transition && os(b, t.transition), p = b, ha(g), p;
}
const N_ = (n) => {
  let e;
  for (const t in n) (t === "class" || t === "style" || Sa(t)) && ((e || (e = {}))[t] = n[t]);
  return e;
}, U_ = (n, e) => {
  const t = {};
  for (const i in n) (!iu(i) || !(i.slice(9) in e)) && (t[i] = n[i]);
  return t;
};
function O_(n, e, t) {
  ...
  if (t && l >= 0) {
    ...
    if (l & 16) return i ? Mh(i, o, c) : !!o;
    if (l & 8) {
      const u = e.dynamicProps;
      for (let h = 0; h < u.length; h++) {
        const f = u[h];
        if (o[f] !== i[f] && !La(c, f)) return true;
      }
    }
  } else return (s || a) && (!a || !a.$stable) ? true : i === o ? false : i ? o ? Mh(i, o, c) : true : !!o;
  return false;
}
function Mh(n, e, t) {
...
const en = Symbol.for("v-fgt"), Ia = Symbol.for("v-txt"), Vt = Symbol.for("v-cmt"), Ja = Symbol.for("v-stc"), Cr = [];
let un = null;
function nc(n = false) {
  Cr.push(un = n ? null : []);
}
function z_() {
  Cr.pop(), un = Cr[Cr.length - 1] || null;
}
let zr = 1;
function Sh(n, e = false) {
  zr += n, n < 0 && un && e && (un.hasOnce = true);
}
function Op(n) {
  return n.dynamicChildren = zr > 0 ? un || Ns : null, z_(), zr > 0 && un && un.push(n), n;
}
...
const Fp = ({ key: n }) => n ?? null, $o = ({ ref: n, ref_key: e, ref_for: t }) => (typeof n == "number" && (n = "" + n), n != null ? Mt(n) || Gt(n) || We(n) ? { i: It, r: n, k: e, f: !!t } : n : null);
function Bp(n, e = null, t = null, i = 0, s = null, r = n === en ? 0 : 1, o = false, a = false) {
  const l = { __v_isVNode: true, __v_skip: true, type: n, props: e, key: e && Fp(e), ref: e && $o(e), scopeId: ep, slotScopeIds: null, children: t, component: null, suspense: null, ssContent: null, ssFallback: null, dirs: null, transition: null, el: null, anchor: null, target: null, targetStart: null, targetAnchor: null, staticCount: 0, shapeFlag: r, patchFlag: i, dynamicProps: s, dynamicChildren: null, appContext: null, ctx: It };
  return a ? (Mu(l, t), r & 128 && n.normalize(l)) : t && (l.shapeFlag |= Mt(t) ? 8 : 16), zr > 0 && !o && un && (l.patchFlag > 0 || r & 6) && l.patchFlag !== 32 && un.push(l), l;
}
const Zt = H_;
function H_(n, e = null, t = null, i = 0, s = null, r = false) {
  if ((!n || n === _p) && (n = Vt), Hr(n)) {
    const a = Di(n, e, true);
    return t && Mu(a, t), zr > 0 && !r && un && (a.shapeFlag & 6 ? un[un.indexOf(n)] = a : un.push(a)), a.patchFlag = -2, a;
  }
  if (Q_(n) && (n = n.__vccOpts), e) {
    e = V_(e);
    let { class: a, style: l } = e;
    a && !Mt(a) && (e.class = au(a)), _t(l) && (mu(l) && !ze(l) && (l = Rt({}, l)), e.style = ou(l));
  }
  const o = Mt(n) ? 1 : Up(n) ? 128 : np(n) ? 64 : _t(n) ? 4 : We(n) ? 2 : 0;
  return Bp(n, e, t, i, s, o, r, true);
}
function V_(n) {
  return n ? mu(n) || Ep(n) ? Rt({}, n) : n : null;
}
function Di(n, e, t = false, i = false) {
  const { props: s, ref: r, patchFlag: o, children: a, transition: l } = n, c = e ? G_(s || {}, e) : s, u = { __v_isVNode: true, __v_skip: true, type: n.type, props: c, key: c && Fp(c), ref: e && e.ref ? t && r ? ze(r) ? r.concat($o(e)) : [r, $o(e)] : $o(e) : r, scopeId: n.scopeId, slotScopeIds: n.slotScopeIds, children: a, target: n.target, targetStart: n.targetStart, targetAnchor: n.targetAnchor, staticCount: n.staticCount, shapeFlag: n.shapeFlag, patchFlag: e && n.type !== en ? o === -1 ? 16 : o | 16 : o, dynamicProps: n.dynamicProps, dynamicChildren: n.dynamicChildren, appContext: n.appContext, dirs: n.dirs, transition: l, component: n.component, suspense: n.suspense, ssContent: n.ssContent && Di(n.ssContent), ssFallback: n.ssFallback && Di(n.ssFallback), el: n.el, anchor: n.anchor, ctx: n.ctx, ce: n.ce };
  return l && i && os(u, l.clone(u)), u;
}
function k_(n = " ", e = 0) {
  return Zt(Ia, null, n, e);
}
function _A(n = "", e = false) {
  return e ? (nc(), ic(Vt, null, n)) : Zt(Vt, null, n);
}
function On(n) {
  return n == null || typeof n == "boolean" ? Zt(Vt) : ze(n) ? Zt(en, null, n.slice()) : Hr(n) ? wi(n) : Zt(Ia, null, String(n));
}
function wi(n) {
...
function Mu(n, e) {
  ...
  if (e == null) e = null;
    ...
    const s = e.default;
    s && (s._c && (s._d = false), Mu(n, s()), s._c && (s._d = true));
    return;
  } else {
    t = 32;
    const s = e._;
    !s && !Ep(e) ? e._ctx = It : s === 3 && It && (It.slots._ === 1 ? e._ = 1 : (e._ = 2, n.patchFlag |= 1024));
  }
  else We(e) ? (e = { default: e, _ctx: It }, t = 32) : (e = String(e), i & 64 ? (t = 16, e = [k_(e)]) : t = 8);
...
function G_(...n) {
  ...
  for (let t = 0; t < n.length; t++) {
    const i = n[t];
    for (const s in i) if (s === "class") e.class !== i.class && (e.class = au([e.class, i.class]));
    else if (s === "style") e.style = ou([e.style, i.style]);
    else if (Sa(s)) {
      const r = e[s], o = i[s];
...
let da, sc;
{
  ...
  da = e("__VUE_INSTANCE_SETTERS__", (t) => Ut = t), sc = e("__VUE_SSR_SETTERS__", (t) => Vr = t);
}
const eo = (n) => {
  const e = Ut;
  return da(n), n.scope.on(), () => {
    n.scope.off(), da(e);
  };
}, bh = () => {
  Ut && Ut.scope.off(), da(null);
};
function Hp(n) {
...
function j_(n, e) {
  ...
  if (i) {
    ui();
    const s = n.setupContext = i.length > 1 ? Z_(n) : null, r = eo(n), o = $r(i, n, 0, [n.props, s]), a = Ad(o);
    if (hi(), r(), (a || n.sp) && !Bs(n) && up(n), a) {
      if (o.then(bh, bh), e) return o.then((l) => {
        Th(n, l);
      }).catch((l) => {
        Ra(l, n, 0);
      });
...
function Th(n, e, t) {
  We(e) ? n.type.__ssrInlineRender ? n.ssrRender = e : n.render = e : _t(e) && (n.setupState = Kd(e)), Vp(n);
}
function Vp(n, e, t) {
  const i = n.type;
...
const $_ = (n, e) => Wg(n, e, Vr);
function ex(n, e, t) {
  const i = arguments.length;
  return i === 2 ? _t(e) && !ze(e) ? Hr(e) ? Zt(n, null, [e]) : Zt(n, e) : Zt(n, null, e) : (i > 3 ? t = Array.prototype.slice.call(arguments, 2) : i === 3 && Hr(t) && (t = [t]), Zt(n, e, t));
}
const tx = "3.5.17";
/**
...
**/
let rc;
const Eh = typeof window < "u" && window.trustedTypes;
if (Eh) try {
  rc = Eh.createPolicy("vue", { createHTML: (n) => n });
} catch {
}
const kp = rc ? (n) => rc.createHTML(n) : (n) => n, nx = "http://www.w3.org/2000/svg", ix = "http://www.w3.org/1998/Math/MathML", ti = typeof document < "u" ? document : null, Ah = ti && ti.createElement("template"), sx = { insert: (n, e, t) => {
  ...
  if (s && (s === r || s.nextSibling)) for (; e.insertBefore(s.cloneNode(true), t), !(s === r || !(s = s.nextSibling)); ) ;
    ...
    Ah.innerHTML = kp(i === "svg" ? `<svg>${n}</svg>` : i === "mathml" ? `<math>${n}</math>` : n);
    const a = Ah.content;
    if (i === "svg" || i === "mathml") {
...
} }, gi = "transition", lr = "animation", Xs = Symbol("_vtc"), Gp = { name: String, type: String, css: { type: Boolean, default: true }, duration: [String, Number, Object], enterFromClass: String, enterActiveClass: String, enterToClass: String, appearFromClass: String, appearActiveClass: String, appearToClass: String, leaveFromClass: String, leaveActiveClass: String, leaveToClass: String }, Wp = Rt({}, op, Gp), rx = (n) => (n.displayName = "Transition", n.props = Wp, n), xA = rx((n, { slots: e }) => ex(e_, Xp(n), e)), Vi = (n, e = []) => {
  ze(n) ? n.forEach((t) => t(...e)) : n && n(...e);
}, wh = (n) => n ? ze(n) ? n.some((e) => e.length > 1) : n.length > 1 : false;
function Xp(n) {
  const e = {};
  ...
  const { name: t = "v", type: i, duration: s, enterFromClass: r = `${t}-enter-from`, enterActiveClass: o = `${t}-enter-active`, enterToClass: a = `${t}-enter-to`, appearFromClass: l = r, appearActiveClass: c = o, appearToClass: u = a, leaveFromClass: h = `${t}-leave-from`, leaveActiveClass: f = `${t}-leave-active`, leaveToClass: d = `${t}-leave-to` } = n, m = ox(s), _ = m && m[0], g = m && m[1], { onBeforeEnter: p, onEnter: E, onEnterCancelled: b, onLeave: x, onLeaveCancelled: P, onBeforeAppear: w = p, onAppear: C = E, onAppearCancelled: I = b } = e, S = (O, X, Q, ne) => {
    O._enterCancelled = ne, Ti(O, X ? u : a), Ti(O, X ? c : o), Q && Q();
  }, M = (O, X) => {
    O._isLeaving = false, Ti(O, h), Ti(O, d), Ti(O, f), X && X();
  }, L = (O) => (X, Q) => {
    const ne = O ? C : E, Z = () => S(X, O, Q);
    Vi(ne, [X, Z]), Rh(() => {
      Ti(X, O ? l : r), Nn(X, O ? u : a), wh(ne) || Ch(X, i, _, Z);
    });
  };
  return Rt(e, { onBeforeEnter(O) {
    ...
    O._isLeaving = true;
    const Q = () => M(O, X);
    Nn(O, h), O._enterCancelled ? (Nn(O, f), oc()) : (oc(), Nn(O, f)), Rh(() => {
      O._isLeaving && (Ti(O, h), Nn(O, d), wh(x) || Ch(O, i, g, Q));
    }), Vi(x, [O, Q]);
  }, onEnterCancelled(O) {
...
function ox(n) {
  ...
  if (_t(n)) return [Qa(n.enter), Qa(n.leave)];
  {
    const e = Qa(n);
    return [e, e];
  }
...
function Nn(n, e) {
  e.split(/\s+/).forEach((t) => t && n.classList.add(t)), (n[Xs] || (n[Xs] = /* @__PURE__ */ new Set())).add(e);
}
function Ti(n, e) {
  e.split(/\s+/).forEach((i) => i && n.classList.remove(i));
  const t = n[Xs];
  t && (t.delete(e), t.size || (n[Xs] = void 0));
}
function Rh(n) {
...
function Yp(n, e) {
  const t = window.getComputedStyle(n), i = (m) => (t[m] || "").split(", "), s = i(`${gi}Delay`), r = i(`${gi}Duration`), o = Ph(s, r), a = i(`${lr}Delay`), l = i(`${lr}Duration`), c = Ph(a, l);
  let u = null, h = 0, f = 0;
  e === gi ? o > 0 && (u = gi, h = o, f = r.length) : e === lr ? c > 0 && (u = lr, h = c, f = l.length) : (h = Math.max(o, c), u = h > 0 ? o > c ? gi : lr : null, f = u ? u === gi ? r.length : l.length : 0);
  const d = u === gi && /\b(transform|all)(,|$)/.test(i(`${gi}Property`).toString());
  return { type: u, timeout: h, propCount: f, hasTransform: d };
}
function Ph(n, e) {
  for (; n.length < e.length; ) n = n.concat(n);
  return Math.max(...e.map((t, i) => Lh(t) + Lh(n[i])));
}
function Lh(n) {
...
const pa = Symbol("_vod"), qp = Symbol("_vsh"), vA = { beforeMount(n, { value: e }, { transition: t }) {
  n[pa] = n.style.display === "none" ? "" : n.style.display, t && e ? t.beforeEnter(n) : cr(n, e);
}, mounted(n, { value: e }, { transition: t }) {
  t && e && t.enter(n);
}, updated(n, { value: e, oldValue: t }, { transition: i }) {
  !e != !t && (i ? e ? (i.beforeEnter(n), cr(n, true), i.enter(n)) : i.leave(n, () => {
    cr(n, false);
  }) : cr(n, e));
...
function cr(n, e) {
  n.style.display = e ? n[pa] : "none", n[qp] = !e;
}
...
function hx(n, e, t) {
  ...
  if (t && !s) {
    ...
    else for (const o in e) t[o] == null && ea(i, o, "");
    for (const o in t) o === "display" && (r = true), ea(i, o, t[o]);
  } else if (s) {
    if (e !== t) {
      const o = i[cx];
  ...
  pa in n && (n[pa] = r ? i.display : "", n[qp] && (i.display = "none"));
}
const Ih = /\s*!important$/;
function ea(n, e, t) {
  if (ze(t)) t.forEach((i) => ea(n, e, i));
  else if (t == null && (t = ""), e.startsWith("--")) n.setProperty(e, t);
  else {
    const i = fx(n, e);
    Ih.test(t) ? n.setProperty(Ui(i), t.replace(Ih, ""), "important") : n[i] = t;
  }
}
const Dh = ["Webkit", "Moz", "ms"], $a = {};
function fx(n, e) {
  const t = $a[e];
  if (t) return t;
  let i = Mn(e);
  if (i !== "filter" && i in n) return $a[e] = i;
  i = Ea(i);
  for (let s = 0; s < Dh.length; s++) {
    const r = Dh[s] + i;
    if (r in n) return $a[e] = r;
  }
  return e;
}
const Nh = "http://www.w3.org/1999/xlink";
function Uh(n, e, t, i, s, r = _g(e)) {
  i && e.startsWith("xlink:") ? t == null ? n.removeAttributeNS(Nh, e.slice(6, e.length)) : n.setAttributeNS(Nh, e, t) : t == null || r && !Cd(t) ? n.removeAttribute(e) : n.setAttribute(e, r ? "" : di(t) ? String(t) : t);
}
function Oh(n, e, t, i, s) {
...
const Fh = Symbol("_vei");
function px(n, e, t, i, s = null) {
  const r = n[Fh] || (n[Fh] = {}), o = r[e];
  if (i && o) o.value = i;
  else {
    const [a, l] = mx(e);
    if (i) {
...
const Bh = /(?:Once|Passive|Capture)$/;
function mx(n) {
  let e;
  if (Bh.test(n)) {
    e = {};
    let i;
    for (; i = n.match(Bh); ) n = n.slice(0, n.length - i[0].length), e[i[0].toLowerCase()] = true;
  }
  return [n[2] === ":" ? n.slice(3) : Ui(n.slice(2)), e];
}
let el = 0;
const gx = Promise.resolve(), _x = () => el || (gx.then(() => el = 0), el = Date.now());
function xx(n, e) {
  const t = (i) => {
...
const zh = (n) => n.charCodeAt(0) === 111 && n.charCodeAt(1) === 110 && n.charCodeAt(2) > 96 && n.charCodeAt(2) < 123, yx = (n, e, t, i, s, r) => {
  const o = s === "svg";
  e === "class" ? lx(n, i, o) : e === "style" ? hx(n, t, i) : Sa(e) ? iu(e) || px(n, e, t, i, r) : (e[0] === "." ? (e = e.slice(1), true) : e[0] === "^" ? (e = e.slice(1), false) : Mx(n, e, i, o)) ? (Oh(n, e, i), !n.tagName.includes("-") && (e === "value" || e === "checked" || e === "selected") && Uh(n, e, i, o, r, e !== "value")) : n._isVueCE && (/[A-Z]/.test(e) || !Mt(i)) ? Oh(n, Mn(e), i, r, e) : (e === "true-value" ? n._trueValue = i : e === "false-value" && (n._falseValue = i), Uh(n, e, i, o));
};
function Mx(n, e, t, i) {
  if (i) return !!(e === "innerHTML" || e === "textContent" || e in n && zh(e) && We(t));
  ...
  return zh(e) && Mt(t) ? false : e in n;
}
const jp = /* @__PURE__ */ new WeakMap(), Kp = /* @__PURE__ */ new WeakMap(), ma = Symbol("_moveCb"), Hh = Symbol("_enterCb"), Sx = (n) => (delete n.props.mode, n), bx = Sx({ name: "TransitionGroup", props: Rt({}, Wp, { tag: String, moveClass: String }), setup(n, { slots: e }) {
  const t = zp(), i = rp();
  let s, r;
  return dp(() => {
    if (!s.length) return;
    ...
    oc(), a.forEach((l) => {
      ...
      const h = c[ma] = (f) => {
        f && f.target !== c || (!f || /transform$/.test(f.propertyName)) && (c.removeEventListener("transitionend", h), c[ma] = null, Ti(c, o));
      };
    ...
    if (s = [], r) for (let c = 0; c < r.length; c++) {
      const u = r[c];
      u.el && u.el instanceof Element && (s.push(u), os(u, Br(u, a, i, t)), jp.set(u, u.el.getBoundingClientRect()));
    }
    r = e.default ? _u(e.default()) : [];
    for (let c = 0; c < r.length; c++) {
      const u = r[c];
      u.key != null && os(u, Br(u, a, i, t));
    }
    return Zt(l, null, r);
  };
} }), yA = bx;
...
}, Lx = { esc: "escape", space: " ", up: "arrow-up", left: "arrow-left", right: "arrow-right", down: "arrow-down", delete: "backspace" }, bA = (n, e) => {
...
*/
const Su = "178", EA = { ROTATE: 0, DOLLY: 1, PAN: 2 }, AA = { ROTATE: 0, PAN: 1, DOLLY_PAN: 2, DOLLY_ROTATE: 3 }, Ox = 0, Wh = 1, Fx = 2, Zp = 1, Bx = 2, ei = 3, fi = 0, sn = 1, Bn = 2, li = 0, Hs = 1, Xh = 2, Yh = 3, qh = 4, zx = 5, ns = 100, Hx = 101, Vx = 102, kx = 103, Gx = 104, Wx = 200, Xx = 201, Yx = 202, qx = 203, ac = 204, lc = 205, jx = 206, Kx = 207, Zx = 208, Jx = 209, Qx = 210, $x = 211, ev = 212, tv = 213, nv = 214, cc = 0, uc = 1, hc = 2, Ys = 3, fc = 4, dc = 5, pc = 6, mc = 7, bu = 0, iv = 1, sv = 2, Li = 0, Jp = 1, Qp = 2, $p = 3, em = 4, tm = 5, nm = 6, im = 7, jh = "attached", rv = "detached", sm = 300, qs = 301, js = 302, gc = 303, _c = 304, Na = 306, Ks = 1e3, Ci = 1001, ga = 1002, Ot = 1003, rm = 1004, yr = 1005, nn = 1006, ta = 1007, ri = 1008, Vn = 1009, om = 1010, am = 1011, kr = 1012, Tu = 1013, as = 1014, Rn = 1015, Ni = 1016, Eu = 1017, Au = 1018, Gr = 1020, lm = 35902, cm = 1021, um = 1022, gn = 1023, Wr = 1026, Xr = 1027, wu = 1028, Ru = 1029, hm = 1030, Cu = 1031, Pu = 1033, na = 33776, ia = 33777, sa = 33778, ra = 33779, xc = 35840, vc = 35841, yc = 35842, Mc = 35843, Sc = 36196, bc = 37492, Tc = 37496, Ec = 37808, Ac = 37809, wc = 37810, Rc = 37811, Cc = 37812, Pc = 37813, Lc = 37814, Ic = 37815, Dc = 37816, Nc = 37817, Uc = 37818, Oc = 37819, Fc = 37820, Bc = 37821, oa = 36492, zc = 36494, Hc = 36495, fm = 36283, Vc = 36284, kc = 36285, Gc = 36286, ov = 2200, av = 2201, lv = 2202, Yr = 2300, qr = 2301, nl = 2302, Ps = 2400, Ls = 2401, _a = 2402, Lu = 2500, cv = 2501, uv = 0, dm = 1, Wc = 2, hv = 3200, fv = 3201, Ua = 0, dv = 1, Ri = "", Dt = "srgb", Jt = "srgb-linear", xa = "linear", at = "srgb", fs = 7680, Kh = 519, pv = 512, mv = 513, gv = 514, pm = 515, _v = 516, xv = 517, vv = 518, yv = 519, Xc = 35044, Zh = "300 es", zn = 2e3, va = 2001;
class Oi {
...
let Jh = 1234567;
const Pr = Math.PI / 180, Zs = 180 / Math.PI;
function xn() {
...
function bv(n, e, t, i) {
  return Lr(n, e, 1 - Math.exp(-t * i));
}
function Tv(n, e = 1) {
  return e - Math.abs(Iu(n, e * 2) - e);
}
function Ev(n, e, t) {
...
const Fv = { DEG2RAD: Pr, RAD2DEG: Zs, generateUUID: xn, clamp: qe, euclideanModulo: Iu, mapLinear: Mv, inverseLerp: Sv, lerp: Lr, damp: bv, pingpong: Tv, smoothstep: Ev, smootherstep: Av, randInt: wv, randFloat: Rv, randFloatSpread: Cv, seededRandom: Pv, degToRad: Lv, radToDeg: Iv, isPowerOfTwo: Dv, ceilPowerOfTwo: Nv, floorPowerOfTwo: Uv, setQuaternionFromProperEuler: Ov, normalize: lt, denormalize: An };
class fe {
  constructor(e = 0, t = 0) {
...
const $h = {};
function Vs(n) {
  n in $h || ($h[n] = true, console.warn(n));
}
function zv(n, e, t) {
...
const ef = new je().set(0.4123908, 0.3575843, 0.1804808, 0.212639, 0.7151687, 0.0721923, 0.0193308, 0.1191948, 0.9505322), tf = new je().set(3.2409699, -1.5373832, -0.4986108, -0.9692436, 1.8759675, 0.0415551, 0.0556301, -0.203977, 1.0569715);
function kv() {
  const n = { enabled: true, workingColorSpace: Jt, spaces: {}, convert: function(s, r, o) {
    return this.enabled === false || r === o || !r || !o || (this.spaces[r].transfer === at && (s.r = ci(s.r), s.g = ci(s.g), s.b = ci(s.b)), this.spaces[r].primaries !== this.spaces[o].primaries && (s.applyMatrix3(this.spaces[r].toXYZ), s.applyMatrix3(this.spaces[o].fromXYZ)), this.spaces[o].transfer === at && (s.r = ks(s.r), s.g = ks(s.g), s.b = ks(s.b))), s;
    ...
    return s === Ri ? xa : this.spaces[s].transfer;
    ...
    return Vs("THREE.ColorManagement: .fromWorkingColorSpace() has been renamed to .workingToColorSpace()."), n.workingToColorSpace(s, r);
  }, toWorkingColorSpace: function(s, r) {
    return Vs("THREE.ColorManagement: .toWorkingColorSpace() has been renamed to .colorSpaceToWorking()."), n.colorSpaceToWorking(s, r);
  } }, e = [0.64, 0.33, 0.3, 0.6, 0.15, 0.06], t = [0.2126, 0.7152, 0.0722], i = [0.3127, 0.329];
  return n.define({ [Jt]: { primaries: e, whitePoint: i, transfer: xa, toXYZ: ef, fromXYZ: tf, luminanceCoefficients: t, workingColorSpaceConfig: { unpackColorSpace: Dt }, outputColorSpaceConfig: { drawingBufferColorSpace: Dt } }, [Dt]: { primaries: e, whitePoint: i, transfer: at, toXYZ: ef, fromXYZ: tf, luminanceCoefficients: t, outputColorSpaceConfig: { drawingBufferColorSpace: Dt } } }), n;
}
const $e = kv();
function ci(n) {
...
class Du {
  constructor(e = null) {
    this.isSource = true, Object.defineProperty(this, "id", { value: Wv++ }), this.uuid = xn(), this.data = e, this.dataReady = true, this.version = 0;
  }
  getSize(e) {
    const t = this.data;
  ...
  toJSON(e) {
    ...
    if (s !== null) {
      ...
      if (Array.isArray(s)) {
        r = [];
        for (let o = 0, a = s.length; o < a; o++) s[o].isDataTexture ? r.push(rl(s[o].image)) : r.push(rl(s[o]));
      } else r = rl(s);
      i.url = r;
    }
...
class Yv extends Oi {
  ...
  copy(e) {
    ...
    for (let t = 0, i = e.textures.length; t < i; t++) {
      ...
      this.textures[t].source = new Du(s);
    }
...
class gm extends wt {
  constructor(e = null, t = 1, i = 1, s = 1) {
    super(null), this.isDataArrayTexture = true, this.image = { data: e, width: t, height: i, depth: s }, this.magFilter = Ot, this.minFilter = Ot, this.wrapR = Ci, this.generateMipmaps = false, this.flipY = false, this.unpackAlignment = 1, this.layerUpdates = /* @__PURE__ */ new Set();
  }
  addLayerUpdate(e) {
...
class qv extends wt {
  constructor(e = null, t = 1, i = 1, s = 1) {
    super(null), this.isData3DTexture = true, this.image = { data: e, width: t, height: i, depth: s }, this.magFilter = Ot, this.minFilter = Ot, this.wrapR = Ci, this.generateMipmaps = false, this.flipY = false, this.unpackAlignment = 1;
  }
}
class mi {
  ...
  expandByObject(e, t = false) {
    ...
    if (i !== void 0) {
      ...
      else e.boundingBox !== void 0 ? (e.boundingBox === null && e.computeBoundingBox(), fo.copy(e.boundingBox)) : (i.boundingBox === null && i.computeBoundingBox(), fo.copy(i.boundingBox)), fo.applyMatrix4(e.matrixWorld), this.union(fo);
    }
    const s = e.children;
  ...
  intersectsTriangle(e) {
    ...
    this.getCenter(ur), po.subVectors(this.max, ur), ps.subVectors(e.a, ur), ms.subVectors(e.b, ur), gs.subVectors(e.c, ur), _i.subVectors(ms, ps), xi.subVectors(gs, ms), ki.subVectors(ps, gs);
    let t = [0, -_i.z, _i.y, 0, -xi.z, xi.y, 0, -ki.z, ki.y, _i.z, 0, -_i.x, xi.z, 0, -xi.x, ki.z, 0, -ki.x, -_i.y, _i.x, 0, -xi.y, xi.x, 0, -ki.y, ki.x, 0];
    return !al(t, ps, ms, gs, po) || (t = [1, 0, 0, 0, 1, 0, 0, 0, 1], !al(t, ps, ms, gs, po)) ? false : (mo.crossVectors(_i, xi), t = [mo.x, mo.y, mo.z], al(t, ps, ms, gs, po));
  }
  clampPoint(e, t) {
...
const jn = [new N(), new N(), new N(), new N(), new N(), new N(), new N(), new N()], bn = new N(), fo = new mi(), ps = new N(), ms = new N(), gs = new N(), _i = new N(), xi = new N(), ki = new N(), ur = new N(), po = new N(), mo = new N(), Gi = new N();
...
const jv = new mi(), hr = new N(), ll = new N();
class Gn {
  ...
  expandByPoint(e) {
    ...
    if (t > this.radius * this.radius) {
      ...
      this.center.addScaledVector(hr, s / i), this.radius += s;
    }
    return this;
  }
  union(e) {
    return e.isEmpty() ? this : this.isEmpty() ? (this.copy(e), this) : (this.center.equals(e.center) === true ? this.radius = Math.max(this.radius, e.radius) : (ll.subVectors(e.center, this.center).setLength(e.radius), this.expandByPoint(hr.copy(e.center).add(ll)), this.expandByPoint(hr.copy(e.center).sub(ll))), this);
  }
  equals(e) {
...
const Kn = new N(), cl = new N(), go = new N(), vi = new N(), ul = new N(), _o = new N(), hl = new N();
class to {
  ...
  distanceSqToSegment(e, t, i, s) {
    cl.copy(e).add(t).multiplyScalar(0.5), go.copy(t).sub(e).normalize(), vi.copy(this.origin).sub(cl);
    const r = e.distanceTo(t) * 0.5, o = -this.direction.dot(go), a = vi.dot(this.direction), l = -vi.dot(go), c = vi.lengthSq(), u = Math.abs(1 - o * o);
    let h, f, d, m;
    ...
    return i && i.copy(this.origin).addScaledVector(this.direction, h), s && s.copy(cl).addScaledVector(go, f), d;
  }
  intersectSphere(e, t) {
  ...
  intersectTriangle(e, t, i, s, r) {
    ul.subVectors(t, e), _o.subVectors(i, e), hl.crossVectors(ul, _o);
    let o = this.direction.dot(hl), a;
    if (o > 0) {
      if (s) return null;
      a = 1;
    } else if (o < 0) a = -1, o = -o;
    ...
    const l = a * this.direction.dot(_o.crossVectors(vi, _o));
    if (l < 0) return null;
    const c = a * this.direction.dot(ul.cross(vi));
...
class Ye {
  ...
  lookAt(e, t, i) {
    ...
    return ln.subVectors(e, t), ln.lengthSq() === 0 && (ln.z = 1), ln.normalize(), yi.crossVectors(i, ln), yi.lengthSq() === 0 && (Math.abs(i.z) === 1 ? ln.x += 1e-4 : ln.z += 1e-4, ln.normalize(), yi.crossVectors(i, ln)), yi.normalize(), xo.crossVectors(ln, yi), s[0] = yi.x, s[4] = xo.x, s[8] = ln.x, s[1] = yi.y, s[5] = xo.y, s[9] = ln.y, s[2] = yi.z, s[6] = xo.z, s[10] = ln.z, this;
  }
  multiply(e) {
    return this.multiplyMatrices(this, e);
  }
  ...
  multiplyMatrices(e, t) {
    const i = e.elements, s = t.elements, r = this.elements, o = i[0], a = i[4], l = i[8], c = i[12], u = i[1], h = i[5], f = i[9], d = i[13], m = i[2], _ = i[6], g = i[10], p = i[14], E = i[3], b = i[7], x = i[11], P = i[15], w = s[0], C = s[4], I = s[8], S = s[12], M = s[1], L = s[5], O = s[9], X = s[13], Q = s[2], ne = s[6], Z = s[10], se = s[14], j = s[3], de = s[7], ve = s[11], be = s[15];
    return r[0] = o * w + a * M + l * Q + c * j, r[4] = o * C + a * L + l * ne + c * de, r[8] = o * I + a * O + l * Z + c * ve, r[12] = o * S + a * X + l * se + c * be, r[1] = u * w + h * M + f * Q + d * j, r[5] = u * C + h * L + f * ne + d * de, r[9] = u * I + h * O + f * Z + d * ve, r[13] = u * S + h * X + f * se + d * be, r[2] = m * w + _ * M + g * Q + p * j, r[6] = m * C + _ * L + g * ne + p * de, r[10] = m * I + _ * O + g * Z + p * ve, r[14] = m * S + _ * X + g * se + p * be, r[3] = E * w + b * M + x * Q + P * j, r[7] = E * C + b * L + x * ne + P * de, r[11] = E * I + b * O + x * Z + P * ve, r[15] = E * S + b * X + x * se + P * be, this;
  }
  multiplyScalar(e) {
    const t = this.elements;
  ...
  makePerspective(e, t, i, s, r, o, a = zn) {
    ...
    else if (a === va) d = -o / (o - r), m = -o * r / (o - r);
...
const _s = new N(), Tn = new Ye(), Kv = new N(0, 0, 0), Zv = new N(1, 1, 1), yi = new N(), xo = new N(), ln = new N(), nf = new Ye(), sf = new vn();
class Ln {
  ...
  setFromQuaternion(e, t, i) {
    return nf.makeRotationFromQuaternion(e), this.setFromRotationMatrix(nf, t, i);
  }
  setFromVector3(e, t = this._order) {
    return this.set(e.x, e.y, e.z, t);
  }
  reorder(e) {
    return sf.setFromEuler(this), this.setFromQuaternion(sf, e);
  }
  equals(e) {
...
let Jv = 0;
const rf = new N(), xs = new vn(), Zn = new Ye(), vo = new N(), fr = new N(), Qv = new N(), $v = new vn(), of = new N(1, 0, 0), af = new N(0, 1, 0), lf = new N(0, 0, 1), cf = { type: "added" }, e0 = { type: "removed" }, vs = { type: "childadded", child: null }, fl = { type: "childremoved", child: null };
class ut extends Oi {
  constructor() {
    super(), this.isObject3D = true, Object.defineProperty(this, "id", { value: Jv++ }), this.uuid = xn(), this.name = "", this.type = "Object3D", this.parent = null, this.children = [], this.up = ut.DEFAULT_UP.clone();
    const e = new N(), t = new Ln(), i = new vn(), s = new N(1, 1, 1);
    function r() {
  ...
  rotateY(e) {
    return this.rotateOnAxis(af, e);
  }
  rotateZ(e) {
    return this.rotateOnAxis(lf, e);
  }
  translateOnAxis(e, t) {
    return rf.copy(e).applyQuaternion(this.quaternion), this.position.add(rf.multiplyScalar(t)), this;
  }
  translateX(e) {
    return this.translateOnAxis(of, e);
  }
  translateY(e) {
    return this.translateOnAxis(af, e);
  }
  translateZ(e) {
    return this.translateOnAxis(lf, e);
  }
  localToWorld(e) {
  ...
  lookAt(e, t, i) {
    ...
    const s = this.parent;
    this.updateWorldMatrix(true, false), fr.setFromMatrixPosition(this.matrixWorld), this.isCamera || this.isLight ? Zn.lookAt(fr, vo, this.up) : Zn.lookAt(vo, fr, this.up), this.quaternion.setFromRotationMatrix(Zn), s && (Zn.extractRotation(s.matrixWorld), xs.setFromRotationMatrix(Zn), this.quaternion.premultiply(xs.invert()));
  }
  add(e) {
    ...
    return e === this ? (console.error("THREE.Object3D.add: object can't be added as a child of itself.", e), this) : (e && e.isObject3D ? (e.removeFromParent(), e.parent = this, this.children.push(e), e.dispatchEvent(cf), vs.child = e, this.dispatchEvent(vs), vs.child = null) : console.error("THREE.Object3D.add: object not an instance of THREE.Object3D.", e), this);
  }
  remove(e) {
    if (arguments.length > 1) {
    ...
    return t !== -1 && (e.parent = null, this.children.splice(t, 1), e.dispatchEvent(e0), fl.child = e, this.dispatchEvent(fl), fl.child = null), this;
  }
  removeFromParent() {
    const e = this.parent;
  ...
  attach(e) {
    return this.updateWorldMatrix(true, false), Zn.copy(this.matrixWorld).invert(), e.parent !== null && (e.parent.updateWorldMatrix(true, false), Zn.multiply(e.parent.matrixWorld)), e.applyMatrix4(Zn), e.removeFromParent(), e.parent = this, this.children.push(e), e.updateWorldMatrix(false, true), e.dispatchEvent(cf), vs.child = e, this.dispatchEvent(vs), vs.child = null, this;
  }
  getObjectById(e) {
  ...
  getWorldQuaternion(e) {
    return this.updateWorldMatrix(true, false), this.matrixWorld.decompose(fr, e, Qv), e;
  }
  getWorldScale(e) {
    return this.updateWorldMatrix(true, false), this.matrixWorld.decompose(fr, $v, e), e;
  }
  getWorldDirection(e) {
...
const En = new N(), Jn = new N(), dl = new N(), Qn = new N(), ys = new N(), Ms = new N(), uf = new N(), pl = new N(), ml = new N(), gl = new N(), _l = new it(), xl = new it(), vl = new it();
class wn {
  ...
  static getBarycoord(e, t, i, s, r) {
    En.subVectors(s, t), Jn.subVectors(i, t), dl.subVectors(e, t);
    const o = En.dot(En), a = En.dot(Jn), l = En.dot(dl), c = Jn.dot(Jn), u = Jn.dot(dl), h = o * c - a * a;
  ...
  static getInterpolatedAttribute(e, t, i, s, r, o) {
    return _l.setScalar(0), xl.setScalar(0), vl.setScalar(0), _l.fromBufferAttribute(e, t), xl.fromBufferAttribute(e, i), vl.fromBufferAttribute(e, s), o.setScalar(0), o.addScaledVector(_l, r.x), o.addScaledVector(xl, r.y), o.addScaledVector(vl, r.z), o;
  }
  ...
  closestPointToPoint(e, t) {
    ...
    let o, a;
    ys.subVectors(s, i), Ms.subVectors(r, i), pl.subVectors(e, i);
    const l = ys.dot(pl), c = Ms.dot(pl);
    if (l <= 0 && c <= 0) return t.copy(i);
    ml.subVectors(e, s);
    const u = ys.dot(ml), h = Ms.dot(ml);
    if (u >= 0 && h <= u) return t.copy(s);
    const f = l * h - u * c;
    if (f <= 0 && l >= 0 && u <= 0) return o = l / (l - u), t.copy(i).addScaledVector(ys, o);
    gl.subVectors(e, r);
    const d = ys.dot(gl), m = Ms.dot(gl);
    if (m >= 0 && d <= m) return t.copy(r);
    const _ = d * c - l * m;
    if (_ <= 0 && c >= 0 && m <= 0) return a = c / (c - m), t.copy(i).addScaledVector(Ms, a);
    const g = u * m - d * h;
    if (g <= 0 && h - u >= 0 && d - m >= 0) return uf.subVectors(r, s), a = (h - u) / (h - u + (d - m)), t.copy(s).addScaledVector(uf, a);
    const p = 1 / (g + _ + f);
...
class Ue {
  ...
  setHSL(e, t, i, s = $e.workingColorSpace) {
    if (e = Iu(e, 1), t = qe(t, 0, 1), i = qe(i, 0, 1), t === 0) this.r = this.g = this.b = i;
    else {
      const r = i <= 0.5 ? i * (1 + t) : i + t - i * t, o = 2 * i - r;
      this.r = yl(o, r, e + 1 / 3), this.g = yl(o, r, e), this.b = yl(o, r, e - 1 / 3);
    }
  ...
  lerpHSL(e, t) {
    this.getHSL(Mi), e.getHSL(yo);
    const i = Lr(Mi.h, yo.h, t), s = Lr(Mi.s, yo.s, t), r = Lr(Mi.l, yo.l, t);
...
class oi extends yn {
  constructor(e) {
    super(), this.isMeshBasicMaterial = true, this.type = "MeshBasicMaterial", this.color = new Ue(16777215), this.map = null, this.lightMap = null, this.lightMapIntensity = 1, this.aoMap = null, this.aoMapIntensity = 1, this.specularMap = null, this.alphaMap = null, this.envMap = null, this.envMapRotation = new Ln(), this.combine = bu, this.reflectivity = 1, this.refractionRatio = 0.98, this.wireframe = false, this.wireframeLinewidth = 1, this.wireframeLinecap = "round", this.wireframeLinejoin = "round", this.fog = true, this.setValues(e);
  }
  copy(e) {
    return super.copy(e), this.color.copy(e.color), this.map = e.map, this.lightMap = e.lightMap, this.lightMapIntensity = e.lightMapIntensity, this.aoMap = e.aoMap, this.aoMapIntensity = e.aoMapIntensity, this.specularMap = e.specularMap, this.alphaMap = e.alphaMap, this.envMap = e.envMap, this.envMapRotation.copy(e.envMapRotation), this.combine = e.combine, this.reflectivity = e.reflectivity, this.refractionRatio = e.refractionRatio, this.wireframe = e.wireframe, this.wireframeLinewidth = e.wireframeLinewidth, this.wireframeLinecap = e.wireframeLinecap, this.wireframeLinejoin = e.wireframeLinejoin, this.fog = e.fog, this;
  }
}
const At = new N(), Mo = new fe();
let n0 = 0;
class Ft {
  constructor(e, t, i = false) {
    if (Array.isArray(e)) throw new TypeError("THREE.BufferAttribute: array should be a Typed Array.");
    this.isBufferAttribute = true, Object.defineProperty(this, "id", { value: n0++ }), this.name = "", this.array = e, this.itemSize = t, this.count = e !== void 0 ? e.length / t : 0, this.normalized = i, this.usage = Xc, this.updateRanges = [], this.gpuType = Rn, this.version = 0;
  }
  onUploadCallback() {
  }
  set needsUpdate(e) {
  ...
  applyMatrix3(e) {
    if (this.itemSize === 2) for (let t = 0, i = this.count; t < i; t++) Mo.fromBufferAttribute(this, t), Mo.applyMatrix3(e), this.setXY(t, Mo.x, Mo.y);
  ...
  toJSON() {
    ...
    return this.name !== "" && (e.name = this.name), this.usage !== Xc && (e.usage = this.usage), e;
  }
}
class xm extends Ft {
  constructor(e, t, i) {
  ...
  computeBoundingSphere() {
    ...
    if (e) {
      ...
      if (cn.setFromBufferAttribute(e), t) for (let r = 0, o = t.length; r < o; r++) {
        const a = t[r];
        dr.setFromBufferAttribute(a), this.morphTargetsRelative ? (Lt.addVectors(cn.min, dr.min), cn.expandByPoint(Lt), Lt.addVectors(cn.max, dr.max), cn.expandByPoint(Lt)) : (cn.expandByPoint(dr.min), cn.expandByPoint(dr.max));
      }
      cn.getCenter(i);
      let s = 0;
...
const hf = new Ye(), Wi = new to(), So = new Gn(), ff = new N(), bo = new N(), To = new N(), Eo = new N(), Sl = new N(), Ao = new N(), df = new N(), wo = new N();
class kt extends ut {
  ...
  getVertexPosition(e, t) {
    ...
    if (r && a) {
      ...
      for (let l = 0, c = r.length; l < c; l++) {
        const u = a[l], h = r[l];
        u !== 0 && (Sl.fromBufferAttribute(h, e), o ? Ao.addScaledVector(Sl, u) : Ao.addScaledVector(Sl.sub(t), u));
      }
      t.add(Ao);
    }
    return t;
  ...
  raycast(e, t) {
    ...
    s !== void 0 && (i.boundingSphere === null && i.computeBoundingSphere(), So.copy(i.boundingSphere), So.applyMatrix4(r), Wi.copy(e.ray).recast(e.near), !(So.containsPoint(Wi.origin) === false && (Wi.intersectSphere(So, ff) === null || Wi.origin.distanceToSquared(ff) > (e.far - e.near) ** 2)) && (hf.copy(r).invert(), Wi.copy(e.ray).applyMatrix4(hf), !(i.boundingBox !== null && Wi.intersectsBox(i.boundingBox) === false) && this._computeIntersections(e, t, Wi)));
  }
  _computeIntersections(e, t, i) {
    ...
    if (a !== null) if (Array.isArray(o)) for (let m = 0, _ = f.length; m < _; m++) {
      ...
      for (let x = E, P = b; x < P; x += 3) {
        ...
        s = Ro(this, p, e, i, c, u, h, w, C, I), s && (s.faceIndex = Math.floor(x / 3), s.face.materialIndex = g.materialIndex, t.push(s));
      }
    }
    else {
      ...
      for (let g = m, p = _; g < p; g += 3) {
        ...
        s = Ro(this, o, e, i, c, u, h, E, b, x), s && (s.faceIndex = Math.floor(g / 3), t.push(s));
      }
    }
...
function s0(n, e, t, i, s, r, o, a) {
  ...
  wo.copy(a), wo.applyMatrix4(n.matrixWorld);
  const c = t.ray.origin.distanceTo(wo);
  return c < t.near || c > t.far ? null : { distance: c, point: wo.clone(), object: n };
}
function Ro(n, e, t, i, s, r, o, a, l, c) {
  n.getVertexPosition(a, bo), n.getVertexPosition(l, To), n.getVertexPosition(c, Eo);
  const u = s0(n, e, t, i, bo, To, Eo, df);
  if (u) {
    const h = new N();
    wn.getBarycoord(df, bo, To, Eo, h), s && (u.uv = wn.getInterpolatedAttribute(s, a, l, c, h, new fe())), r && (u.uv1 = wn.getInterpolatedAttribute(r, a, l, c, h, new fe())), o && (u.normal = wn.getInterpolatedAttribute(o, a, l, c, h, new N()), u.normal.dot(i.direction) > 0 && u.normal.multiplyScalar(-1));
    const f = { a, b: l, c, normal: new N(), materialIndex: 0 };
    wn.getNormal(bo, To, Eo, f.normal), u.face = f, u.barycoord = h;
  }
  return u;
}
class no extends St {
    ...
    function m(_, g, p, E, b, x, P, w, C, I, S) {
      ...
      for (let ve = 0; ve < Z; ve++) {
        ...
        for (let Oe = 0; Oe < ne; Oe++) {
          const Ze = Oe * M - O;
          de[_] = Ze * E, de[g] = be * b, de[p] = Q, c.push(de.x, de.y, de.z), de[_] = 0, de[g] = 0, de[p] = w > 0 ? 1 : -1, u.push(de.x, de.y, de.z), h.push(Oe / C), h.push(1 - ve / I), se += 1;
        }
      }
      for (let ve = 0; ve < I; ve++) for (let be = 0; be < C; be++) {
        const Oe = f + be + ne * ve, Ze = f + be + ne * (ve + 1), ie = f + (be + 1) + ne * (ve + 1), pe = f + (be + 1) + ne * ve;
        l.push(Oe, Ze, pe), l.push(Ze, ie, pe), j += 6;
      }
  ...
  static fromJSON(e) {
    return new no(e.width, e.height, e.depth, e.widthSegments, e.heightSegments, e.depthSegments);
  }
}
function Js(n) {
  const e = {};
...
const Si = new N(), pf = new fe(), mf = new fe();
class tn extends Uu {
  ...
  getEffectiveFOV() {
    return Zs * 2 * Math.atan(Math.tan(Pr * 0.5 * this.fov) / this.zoom);
  }
  getFilmWidth() {
  ...
  getViewSize(e, t) {
    return this.getViewBounds(e, pf, mf), t.subVectors(mf, pf);
  }
...
class l0 extends ut {
  ...
  updateCoordinateSystem() {
    ...
    else if (e === va) i.up.set(0, -1, 0), i.lookAt(-1, 0, 0), s.up.set(0, -1, 0), s.lookAt(1, 0, 0), r.up.set(0, 0, 1), r.lookAt(0, 1, 0), o.up.set(0, 0, -1), o.lookAt(0, -1, 0), a.up.set(0, -1, 0), a.lookAt(0, 0, 1), l.up.set(0, -1, 0), l.lookAt(0, 0, -1);
...
class Mm extends wt {
  constructor(e = [], t = qs, i, s, r, o, a, l, c, u) {
...
class c0 extends kn {
  ...
  fromEquirectangularTexture(e, t) {
    ...
    const i = { uniforms: { tEquirect: { value: null } }, vertexShader: `
			...
			` }, s = new no(5, 5, 5), r = new rn({ name: "CubemapFromEquirect", uniforms: Js(i.uniforms), vertexShader: i.vertexShader, fragmentShader: i.fragmentShader, side: sn, blending: li });
...
class bm {
  constructor(e, t) {
    this.isInterleavedBuffer = true, this.array = e, this.stride = t, this.count = e !== void 0 ? e.length / t : 0, this.usage = Xc, this.updateRanges = [], this.version = 0, this.uuid = xn();
  }
  onUploadCallback() {
  }
  set needsUpdate(e) {
...
class Ou {
  ...
  clone(e) {
    ...
    } else return e.interleavedBuffers === void 0 && (e.interleavedBuffers = {}), e.interleavedBuffers[this.data.uuid] === void 0 && (e.interleavedBuffers[this.data.uuid] = this.data.clone(e)), new Ou(e.interleavedBuffers[this.data.uuid], this.itemSize, this.offset, this.normalized);
  }
  toJSON(e) {
    if (e === void 0) {
...
const gf = new N(), _f = new it(), xf = new it(), h0 = new N(), vf = new Ye(), Co = new N(), Tl = new Gn(), yf = new Ye(), El = new to();
class f0 extends kt {
  constructor(e, t) {
  ...
  computeBoundingBox() {
    ...
    for (let i = 0; i < t.count; i++) this.getVertexPosition(i, Co), this.boundingBox.expandByPoint(Co);
  }
  computeBoundingSphere() {
    const e = this.geometry;
    this.boundingSphere === null && (this.boundingSphere = new Gn()), this.boundingSphere.makeEmpty();
    const t = e.getAttribute("position");
    for (let i = 0; i < t.count; i++) this.getVertexPosition(i, Co), this.boundingSphere.expandByPoint(Co);
  }
  copy(e, t) {
  ...
  raycast(e, t) {
    ...
    i !== void 0 && (this.boundingSphere === null && this.computeBoundingSphere(), Tl.copy(this.boundingSphere), Tl.applyMatrix4(s), e.ray.intersectsSphere(Tl) !== false && (yf.copy(s).invert(), El.copy(e.ray).applyMatrix4(yf), !(this.boundingBox !== null && El.intersectsBox(this.boundingBox) === false) && this._computeIntersections(e, t, El)));
  }
  getVertexPosition(e, t) {
  ...
  updateMatrixWorld(e) {
    super.updateMatrixWorld(e), this.bindMode === jh ? this.bindMatrixInverse.copy(this.matrixWorld).invert() : this.bindMode === rv ? this.bindMatrixInverse.copy(this.bindMatrix).invert() : console.warn("THREE.SkinnedMesh: Unrecognized bindMode: " + this.bindMode);
  }
  applyBoneTransform(e, t) {
    const i = this.skeleton, s = this.geometry;
    _f.fromBufferAttribute(s.attributes.skinIndex, e), xf.fromBufferAttribute(s.attributes.skinWeight, e), gf.copy(t).applyMatrix4(this.bindMatrix), t.set(0, 0, 0);
    for (let r = 0; r < 4; r++) {
      const o = xf.getComponent(r);
      if (o !== 0) {
        const a = _f.getComponent(r);
        vf.multiplyMatrices(i.bones[a].matrixWorld, i.boneInverses[a]), t.addScaledVector(h0.copy(gf).applyMatrix4(vf), o);
      }
    }
...
class Fu {
  ...
  update() {
    ...
    for (let r = 0, o = e.length; r < o; r++) {
      ...
      Mf.multiplyMatrices(a, t[r]), Mf.toArray(i, r * 16);
    }
...
const Es = new Ye(), Sf = new Ye(), Po = [], bf = new mi(), p0 = new Ye(), pr = new kt(), mr = new Gn();
class m0 extends kt {
  constructor(e, t, i) {
    super(e, t), this.isInstancedMesh = true, this.instanceMatrix = new Yc(new Float32Array(i * 16), 16), this.instanceColor = null, this.morphTexture = null, this.count = i, this.boundingBox = null, this.boundingSphere = null;
  ...
  computeBoundingBox() {
    ...
    for (let i = 0; i < t; i++) this.getMatrixAt(i, Es), bf.copy(e.boundingBox).applyMatrix4(Es), this.boundingBox.union(bf);
  }
  computeBoundingSphere() {
    const e = this.geometry, t = this.count;
    ...
    for (let i = 0; i < t; i++) this.getMatrixAt(i, Es), mr.copy(e.boundingSphere).applyMatrix4(Es), this.boundingSphere.union(mr);
  }
  copy(e, t) {
  ...
  raycast(e, t) {
    ...
    if (pr.geometry = this.geometry, pr.material = this.material, pr.material !== void 0 && (this.boundingSphere === null && this.computeBoundingSphere(), mr.copy(this.boundingSphere), mr.applyMatrix4(i), e.ray.intersectsSphere(mr) !== false)) for (let r = 0; r < s; r++) {
      this.getMatrixAt(r, Es), Sf.multiplyMatrices(i, Es), pr.matrixWorld = Sf, pr.raycast(e, Po);
      for (let o = 0, a = Po.length; o < a; o++) {
        const l = Po[o];
  ...
  setMorphAt(e, t) {
    ...
    this.morphTexture === null && (this.morphTexture = new Em(new Float32Array(s * this.count), s, this.count, wu, Rn));
...
const Al = new N(), g0 = new N(), _0 = new je();
class $i {
  ...
  setFromCoplanarPoints(e, t, i) {
    const s = Al.subVectors(i, t).cross(g0.subVectors(e, t)).normalize();
  ...
  intersectLine(e, t) {
    const i = e.delta(Al), s = this.normal.dot(i);
  ...
  applyMatrix4(e, t) {
    const i = t || _0.getNormalMatrix(e), s = this.coplanarPoint(Al).applyMatrix4(e), r = this.normal.applyMatrix3(i).normalize();
...
const Xi = new Gn(), x0 = new fe(0.5, 0.5), Lo = new N();
class Bu {
  ...
  setFromProjectionMatrix(e, t = zn) {
    ...
    else if (t === va) i[5].setComponents(a, h, _, b).normalize();
  ...
  intersectsSprite(e) {
    Xi.center.set(0, 0, 0);
    const t = x0.distanceTo(e.center);
  ...
  intersectsBox(e) {
    ...
    for (let i = 0; i < 6; i++) {
      const s = t[i];
      if (Lo.x = s.normal.x > 0 ? e.max.x : e.min.x, Lo.y = s.normal.y > 0 ? e.max.y : e.min.y, Lo.z = s.normal.z > 0 ? e.max.z : e.min.z, s.distanceToPoint(Lo) < 0) return false;
    }
    return true;
  }
  containsPoint(e) {
...
const ya = new N(), Ma = new N(), Tf = new Ye(), gr = new to(), Io = new Gn(), wl = new N(), Ef = new N();
class Kr extends ut {
  constructor(e = new St(), t = new Oa()) {
  ...
  computeLineDistances() {
    ...
    if (e.index === null) {
      ...
      for (let s = 1, r = t.count; s < r; s++) ya.fromBufferAttribute(t, s - 1), Ma.fromBufferAttribute(t, s), i[s] = i[s - 1], i[s] += ya.distanceTo(Ma);
  ...
  raycast(e, t) {
    ...
    Tf.copy(s).invert(), gr.copy(e.ray).applyMatrix4(Tf);
    ...
    if (u !== null) {
      ...
      for (let _ = d, g = m - 1; _ < g; _ += c) {
        const p = u.getX(_), E = u.getX(_ + 1), b = Do(this, e, gr, l, p, E, _);
        b && t.push(b);
      }
      if (this.isLineLoop) {
        const _ = u.getX(m - 1), g = u.getX(d), p = Do(this, e, gr, l, _, g, m - 1);
        p && t.push(p);
      }
    } else {
      const d = Math.max(0, o.start), m = Math.min(f.count, o.start + o.count);
      for (let _ = d, g = m - 1; _ < g; _ += c) {
        const p = Do(this, e, gr, l, _, _ + 1, _);
        p && t.push(p);
      }
      if (this.isLineLoop) {
        const _ = Do(this, e, gr, l, m - 1, d, m - 1);
        _ && t.push(_);
      }
    }
  }
...
function Do(n, e, t, i, s, r, o) {
  ...
  if (ya.fromBufferAttribute(a, s), Ma.fromBufferAttribute(a, r), t.distanceSqToSegment(ya, Ma, wl, Ef) > i) return;
  wl.applyMatrix4(n.matrixWorld);
  const c = e.ray.origin.distanceTo(wl);
  if (!(c < e.near || c > e.far)) return { distance: c, point: Ef.clone().applyMatrix4(n.matrixWorld), index: o, face: null, faceIndex: null, barycoord: null, object: n };
}
const Af = new N(), wf = new N();
class Am extends Kr {
  constructor(e, t) {
  ...
  computeLineDistances() {
    ...
    if (e.index === null) {
      ...
      for (let s = 0, r = t.count; s < r; s += 2) Af.fromBufferAttribute(t, s), wf.fromBufferAttribute(t, s + 1), i[s] = s === 0 ? 0 : i[s - 1], i[s + 1] = i[s] + Af.distanceTo(wf);
      e.setAttribute("lineDistance", new et(i, 1));
...
const Rf = new Ye(), qc = new to(), No = new Gn(), Uo = new N();
class y0 extends ut {
  constructor(e = new St(), t = new wm()) {
  ...
  raycast(e, t) {
    ...
    if (i.boundingSphere === null && i.computeBoundingSphere(), No.copy(i.boundingSphere), No.applyMatrix4(s), No.radius += r, e.ray.intersectsSphere(No) === false) return;
    Rf.copy(s).invert(), qc.copy(e.ray).applyMatrix4(Rf);
    ...
    if (c !== null) {
      ...
      for (let m = f, _ = d; m < _; m++) {
        const g = c.getX(m);
        Uo.fromBufferAttribute(h, g), Cf(Uo, g, l, s, e, t, this);
      }
    } else {
      const f = Math.max(0, o.start), d = Math.min(h.count, o.start + o.count);
      for (let m = f, _ = d; m < _; m++) Uo.fromBufferAttribute(h, m), Cf(Uo, m, l, s, e, t, this);
    }
  }
  updateMorphTargets() {
    const t = this.geometry.morphAttributes, i = Object.keys(t);
...
class Rm extends wt {
  constructor(e, t, i = as, s, r, o, a = Ot, l = Ot, c, u = Wr, h = 1) {
    if (u !== Wr && u !== Xr) throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");
  ...
  copy(e) {
    return super.copy(e), this.source = new Du(Object.assign({}, e.image)), this.compareFunction = e.compareFunction, this;
  }
  toJSON(e) {
    const t = super.toJSON(e);
...
class zu extends St {
  ...
  static fromJSON(e) {
    return new zu(e.radiusTop, e.radiusBottom, e.height, e.radialSegments, e.heightSegments, e.openEnded, e.thetaStart, e.thetaLength);
  }
}
class Pm extends zu {
...
class Hu extends St {
  ...
  static fromJSON(e) {
    return new Hu(e.vertices, e.indices, e.radius, e.details);
  }
}
class Wn {
  constructor() {
...
const Oo = new N(), Rl = new ku(), Cl = new ku(), Pl = new ku();
class S0 extends Wn {
  ...
  getPoint(e, t = new N()) {
    ...
    let c, u;
    this.closed || a > 0 ? c = s[(a - 1) % r] : (Oo.subVectors(s[0], s[1]).add(s[0]), c = Oo);
    const h = s[a % r], f = s[(a + 1) % r];
    if (this.closed || a + 2 < r ? u = s[(a + 2) % r] : (Oo.subVectors(s[r - 1], s[r - 2]).add(s[r - 1]), u = Oo), this.curveType === "centripetal" || this.curveType === "chordal") {
      ...
      _ < 1e-4 && (_ = 1), m < 1e-4 && (m = _), g < 1e-4 && (g = _), Rl.initNonuniformCatmullRom(c.x, h.x, f.x, u.x, m, _, g), Cl.initNonuniformCatmullRom(c.y, h.y, f.y, u.y, m, _, g), Pl.initNonuniformCatmullRom(c.z, h.z, f.z, u.z, m, _, g);
    } else this.curveType === "catmullrom" && (Rl.initCatmullRom(c.x, h.x, f.x, u.x, this.tension), Cl.initCatmullRom(c.y, h.y, f.y, u.y, this.tension), Pl.initCatmullRom(c.z, h.z, f.z, u.z, this.tension));
    return i.set(Rl.calc(l), Cl.calc(l), Pl.calc(l)), i;
  }
  copy(e) {
...
function Dr(n, e, t, i, s) {
  return A0(n, e) + w0(n, t) + R0(n, i) + C0(n, s);
}
class Lm extends Wn {
  ...
  getPoint(e, t = new fe()) {
    ...
    return i.set(Dr(e, s.x, r.x, o.x, a.x), Dr(e, s.y, r.y, o.y, a.y)), i;
  }
  copy(e) {
...
class P0 extends Wn {
  ...
  getPoint(e, t = new N()) {
    const i = t, s = this.v0, r = this.v1, o = this.v2, a = this.v3;
    return i.set(Dr(e, s.x, r.x, o.x, a.x), Dr(e, s.y, r.y, o.y, a.y), Dr(e, s.z, r.z, o.z, a.z)), i;
  }
  copy(e) {
    return super.copy(e), this.v0.copy(e.v0), this.v1.copy(e.v1), this.v2.copy(e.v2), this.v3.copy(e.v3), this;
  }
...
class Dm extends Wn {
  ...
  getPoint(e, t = new fe()) {
    ...
    return i.set(Ir(e, s.x, r.x, o.x), Ir(e, s.y, r.y, o.y)), i;
  }
  copy(e) {
...
class I0 extends Wn {
  ...
  getPoint(e, t = new N()) {
    const i = t, s = this.v0, r = this.v1, o = this.v2;
    return i.set(Ir(e, s.x, r.x, o.x), Ir(e, s.y, r.y, o.y), Ir(e, s.z, r.z, o.z)), i;
  }
  copy(e) {
    return super.copy(e), this.v0.copy(e.v0), this.v1.copy(e.v1), this.v2.copy(e.v2), this;
  }
...
class Nm extends Wn {
  ...
  getPoint(e, t = new fe()) {
    ...
    return i.set(Pf(a, l.x, c.x, u.x, h.x), Pf(a, l.y, c.y, u.y, h.y)), i;
  }
  copy(e) {
    super.copy(e), this.points = [];
    for (let t = 0, i = e.points.length; t < i; t++) {
...
var jc = Object.freeze({ __proto__: null, ArcCurve: M0, CatmullRomCurve3: S0, CubicBezierCurve: Lm, CubicBezierCurve3: P0, EllipseCurve: Vu, LineCurve: Im, LineCurve3: L0, QuadraticBezierCurve: Dm, QuadraticBezierCurve3: I0, SplineCurve: Nm });
class D0 extends Wn {
  constructor() {
...
class Lf extends D0 {
  ...
  absellipse(e, t, i, s, r, o, a, l) {
    const c = new Vu(e, t, i, s, r, o, a, l);
...
class N0 extends Lf {
  ...
  fromJSON(e) {
    ...
    for (let t = 0, i = e.holes.length; t < i; t++) {
      const s = e.holes[t];
      this.holes.push(new Lf().fromJSON(s));
    }
    return this;
  }
}
function U0(n, e, t = 2) {
  ...
  let a, l, c;
  if (i && (r = H0(n, e, r, t)), n.length > 80 * t) {
    a = 1 / 0, l = 1 / 0;
    let u = -1 / 0, h = -1 / 0;
    for (let f = t; f < s; f += t) {
      const d = n[f], m = n[f + 1];
  ...
  return Zr(r, o, t, a, l, c, 0), o;
}
function Um(n, e, t, i, s) {
  let r;
  if (s === J0(n, e, t, i) > 0) for (let o = e; o < t; o += i) r = If(o / i | 0, n[o], n[o + 1], r);
  else for (let o = t - i; o >= e; o -= i) r = If(o / i | 0, n[o], n[o + 1], r);
  return r && Qs(r, r.next) && (Qr(r), r = r.next), r;
}
function ls(n, e) {
  if (!n) return n;
  e || (e = n);
  let t = n, i;
  do
    if (i = false, !t.steiner && (Qs(t, t.next) || yt(t.prev, t, t.next) === 0)) {
...
function Zr(n, e, t, i, s, r, o) {
  if (!n) return;
  !o && r && X0(n, i, s, r);
  let a = n;
  for (; n.prev !== n.next; ) {
    const l = n.prev, c = n.next;
    if (r ? F0(n, i, s, r) : O0(n)) {
      e.push(l.i, n.i, c.i), Qr(n), n = c.next, a = c.next;
      continue;
    }
    if (n = c, n === a) {
      o ? o === 1 ? (n = B0(ls(n), e), Zr(n, e, t, i, s, r, 2)) : o === 2 && z0(n, e, t, i, s, r) : Zr(ls(n), e, t, i, s, r, 1);
      break;
    }
  }
}
function O0(n) {
  ...
  let m = i.next;
  for (; m !== e; ) {
    if (m.x >= u && m.x <= f && m.y >= h && m.y <= d && Mr(s, a, r, l, o, c, m.x, m.y) && yt(m.prev, m, m.next) >= 0) return false;
    m = m.next;
  }
  return true;
}
function F0(n, e, t, i) {
  ...
  const a = s.x, l = r.x, c = o.x, u = s.y, h = r.y, f = o.y, d = Math.min(a, l, c), m = Math.min(u, h, f), _ = Math.max(a, l, c), g = Math.max(u, h, f), p = Kc(d, m, e, t, i), E = Kc(_, g, e, t, i);
  let b = n.prevZ, x = n.nextZ;
  for (; b && b.z >= p && x && x.z <= E; ) {
    if (b.x >= d && b.x <= _ && b.y >= m && b.y <= g && b !== s && b !== o && Mr(a, u, l, h, c, f, b.x, b.y) && yt(b.prev, b, b.next) >= 0 || (b = b.prevZ, x.x >= d && x.x <= _ && x.y >= m && x.y <= g && x !== s && x !== o && Mr(a, u, l, h, c, f, x.x, x.y) && yt(x.prev, x, x.next) >= 0)) return false;
    x = x.nextZ;
  }
  for (; b && b.z >= p; ) {
    if (b.x >= d && b.x <= _ && b.y >= m && b.y <= g && b !== s && b !== o && Mr(a, u, l, h, c, f, b.x, b.y) && yt(b.prev, b, b.next) >= 0) return false;
    b = b.prevZ;
  }
  for (; x && x.z <= E; ) {
    if (x.x >= d && x.x <= _ && x.y >= m && x.y <= g && x !== s && x !== o && Mr(a, u, l, h, c, f, x.x, x.y) && yt(x.prev, x, x.next) >= 0) return false;
    x = x.nextZ;
  }
  return true;
}
function B0(n, e) {
  ...
  do {
    ...
    !Qs(i, s) && Fm(i, t, t.next, s) && Jr(i, s) && Jr(s, i) && (e.push(i.i, t.i, s.i), Qr(t), Qr(t.next), t = n = s), t = t.next;
  } while (t !== n);
  return ls(t);
}
function z0(n, e, t, i, s, r) {
  ...
  do {
    ...
    for (; a !== o.prev; ) {
      if (o.i !== a.i && j0(o, a)) {
        let l = Bm(o, a);
        o = ls(o, o.next), l = ls(l, l.next), Zr(o, e, t, i, s, r, 0), Zr(l, e, t, i, s, r, 0);
        return;
      }
      a = a.next;
    }
...
function H0(n, e, t, i) {
  ...
  s.sort(V0);
  for (let r = 0; r < s.length; r++) t = k0(s[r], t);
  return t;
}
function V0(n, e) {
  let t = n.x - e.x;
...
function G0(n, e) {
  ...
  do {
    if (i >= t.x && t.x >= l && i !== t.x && Om(s < c ? i : r, s, l, c, s < c ? r : i, s, t.x, t.y)) {
      ...
      Jr(t, n) && (h < u || h === u && (t.x > o.x || t.x === o.x && W0(o, t))) && (o = t, u = h);
    }
    t = t.next;
  } while (t !== a);
  return o;
...
function X0(n, e, t, i) {
  let s = n;
  do
    s.z === 0 && (s.z = Kc(s.x, s.y, e, t, i)), s.prevZ = s.prev, s.nextZ = s.next, s = s.next;
  while (s !== n);
  s.prevZ.nextZ = null, s.prevZ = null, Y0(s);
}
function Y0(n) {
  let e, t = 1;
  do {
...
function Mr(n, e, t, i, s, r, o, a) {
  return !(n === o && e === a) && Om(n, e, t, i, s, r, o, a);
}
function j0(n, e) {
  return n.next.i !== e.i && n.prev.i !== e.i && !K0(n, e) && (Jr(n, e) && Jr(e, n) && Z0(n, e) && (yt(n.prev, n, e.prev) || yt(n, e.prev, e)) || Qs(n, e) && yt(n.prev, n, n.next) > 0 && yt(e.prev, e, e.next) > 0);
}
function yt(n, e, t) {
...
function Fm(n, e, t, i) {
  const s = Bo(yt(n, e, t)), r = Bo(yt(n, e, i)), o = Bo(yt(t, i, n)), a = Bo(yt(t, i, e));
  return !!(s !== r && o !== a || s === 0 && Fo(n, t, e) || r === 0 && Fo(n, i, e) || o === 0 && Fo(t, n, i) || a === 0 && Fo(t, e, i));
}
function Fo(n, e, t) {
...
function Bm(n, e) {
  const t = Zc(n.i, n.x, n.y), i = Zc(e.i, e.x, e.y), s = n.next, r = e.prev;
...
class Is {
  ...
  static triangulateShape(e, t) {
    ...
    let o = e.length;
    t.forEach(Df);
    for (let l = 0; l < t.length; l++) s.push(o), o += t[l].length, Nf(i, t[l]);
    const a = Q0.triangulate(i, s);
...
class zm extends St {
  constructor(e = new N0([new fe(0.5, 0.5), new fe(-0.5, 0.5), new fe(-0.5, -0.5), new fe(0.5, -0.5)]), t = {}) {
    ...
    function o(a) {
      ...
      const p = t.extrudePath, E = t.UVGenerator !== void 0 ? t.UVGenerator : $0;
      ...
      if (!Is.isClockWise(M)) {
        ...
        for (let y = 0, V = L.length; y < V; y++) {
          const F = L[y];
          Is.isClockWise(F) && (L[y] = F.reverse());
        }
      }
      function X(y) {
      ...
      function j(y, V, F) {
        ...
        if (Math.abs(U) > Number.EPSILON) {
          const Y = Math.sqrt(v), te = Math.sqrt(ae * ae + T * T), K = V.x - q / Y, xe = V.y + G / Y, ce = F.x - T / te, ye = F.y + ae / te, Te = ((ce - K) * T - (ye - xe) * ae) / (G * T - q * ae);
          H = K + G * Te - y.x, z = xe + q * Te - y.y;
          const oe = H * H + z * z;
      ...
      for (let y = 0, V = Q; y < V; y++) {
        ...
        ve.push(be), Oe = Oe.concat(be);
      }
      let Ze;
      if (g === 0) Ze = Is.triangulateShape(ne, L);
      else {
        const y = [], V = [];
        for (let F = 0; F < g; F++) {
        ...
        Ze = Is.triangulateShape(y, V);
      }
      const ie = Ze.length, pe = m + _;
      for (let y = 0; y < se; y++) {
        const V = f ? Z(M[y], Oe[y], pe) : M[y];
  ...
  static fromJSON(e, t) {
    ...
    return s !== void 0 && (e.options.extrudePath = new jc[s.type]().fromJSON(s)), new zm(i, e.options);
  }
}
const $0 = { generateTopUV: function(n, e, t, i, s) {
...
class Gu extends Hu {
  ...
  static fromJSON(e) {
    return new Gu(e.radius, e.detail);
  }
}
class Fa extends St {
...
class Wu extends St {
  ...
  static fromJSON(e) {
    return new Wu(e.radius, e.widthSegments, e.heightSegments, e.phiStart, e.phiLength, e.thetaStart, e.thetaLength);
  }
}
class Hm extends St {
      ...
      if (e.index !== null) {
        ...
        for (let c = 0, u = l.length; c < u; ++c) {
          ...
          for (let m = f, _ = f + d; m < _; m += 3) for (let g = 0; g < 3; g++) {
            ...
            s.fromBufferAttribute(o, p), r.fromBufferAttribute(o, E), Uf(s, r, i) === true && (t.push(s.x, s.y, s.z), t.push(r.x, r.y, r.z));
          }
        }
      } else {
        ...
        for (let a = 0, l = o.count / 3; a < l; a++) for (let c = 0; c < 3; c++) {
          ...
          s.fromBufferAttribute(o, u), r.fromBufferAttribute(o, h), Uf(s, r, i) === true && (t.push(s.x, s.y, s.z), t.push(r.x, r.y, r.z));
        }
      }
...
class CA extends yn {
  constructor(e) {
    super(), this.isMeshPhongMaterial = true, this.type = "MeshPhongMaterial", this.color = new Ue(16777215), this.specular = new Ue(1118481), this.shininess = 30, this.map = null, this.lightMap = null, this.lightMapIntensity = 1, this.aoMap = null, this.aoMapIntensity = 1, this.emissive = new Ue(0), this.emissiveIntensity = 1, this.emissiveMap = null, this.bumpMap = null, this.bumpScale = 1, this.normalMap = null, this.normalMapType = Ua, this.normalScale = new fe(1, 1), this.displacementMap = null, this.displacementScale = 1, this.displacementBias = 0, this.specularMap = null, this.alphaMap = null, this.envMap = null, this.envMapRotation = new Ln(), this.combine = bu, this.reflectivity = 1, this.refractionRatio = 0.98, this.wireframe = false, this.wireframeLinewidth = 1, this.wireframeLinecap = "round", this.wireframeLinejoin = "round", this.flatShading = false, this.fog = true, this.setValues(e);
  }
  copy(e) {
...
class oy extends io {
  constructor(e, t, i, s) {
    super(e, t, i, s), this._weightPrev = -0, this._offsetPrev = -0, this._weightNext = -0, this._offsetNext = -0, this.DefaultSettings_ = { endingStart: Ps, endingEnd: Ps };
  }
...
class In {
  constructor(e, t, i, s) {
    ...
    this.name = e, this.times = zo(t, this.TimeBufferType), this.values = zo(i, this.ValueBufferType), this.setInterpolation(s || this.DefaultInterpolation);
  }
  static toJSON(e) {
    ...
    if (t.toJSON !== this.toJSON) i = t.toJSON(e);
      ...
      i = { name: e.name, times: zo(e.times, Array), values: zo(e.values, Array) };
  ...
  validate() {
    ...
    if (s !== void 0 && sy(s)) for (let a = 0, l = s.length; a !== l; ++a) {
      const c = s[a];
      if (isNaN(c)) {
  ...
  optimize() {
    const e = this.times.slice(), t = this.values.slice(), i = this.getValueSize(), s = this.getInterpolation() === nl, r = e.length - 1;
    let o = 1;
    for (let a = 1; a < r; ++a) {
      let l = false;
      const c = e[a], u = e[a + 1];
...
In.prototype.DefaultInterpolation = qr;
class nr extends In {
  constructor(e, t, i) {
    super(e, t, i);
  }
...
nr.prototype.DefaultInterpolation = Yr;
...
$s.prototype.ValueTypeName = "number";
class ly extends io {
  constructor(e, t, i, s) {
    super(e, t, i, s);
  }
...
ir.prototype.DefaultInterpolation = Yr;
...
class Jc {
  ...
  static parse(e) {
    ...
    for (let o = 0, a = i.length; o !== a; ++o) t.push(uy(i[o]).scale(s));
  ...
  static CreateFromMorphTargetSequence(e, t, i, s) {
    ...
    for (let a = 0; a < r; a++) {
      ...
      const u = ry(l);
      l = Of(l, 1, u), c = Of(c, 1, u), !s && l[0] === 0 && (l.push(r), c.push(c[0])), o.push(new $s(".morphTargetInfluences[" + t[a].name + "]", l, c).scale(1 / i));
    }
    ...
    for (let h = 0; h < c.length; h++) {
      ...
      if (!(!f || f.length === 0)) if (f[0].morphTargets) {
        ...
        for (const _ in d) {
          ...
          s.push(new $s(".morphTargetInfluence[" + _ + "]", g, p));
        }
        l = d.length * o;
      } else {
        const d = ".bones[" + t[h].name + "]";
        i(tr, d + ".position", f, "pos", s), i(er, d + ".quaternion", f, "rot", s), i(tr, d + ".scale", f, "scl", s);
      }
    }
...
class cs {
  constructor(e) {
    this.manager = e !== void 0 ? e : fy, this.crossOrigin = "anonymous", this.withCredentials = false, this.path = "", this.resourcePath = "", this.requestHeader = {};
  }
  load() {
  }
  loadAsync(e, t) {
...
class Yu extends cs {
  ...
  load(e, t, i, s) {
    ...
    fetch(o).then((c) => {
      ...
      } else throw new dy(`fetch for "${c.url}" responded with ${c.status}: ${c.statusText}`, c);
    }).then((c) => {
      switch (l) {
        case "arraybuffer":
...
class my extends cs {
  ...
  load(e, t, i, s) {
    const r = new wt(), o = new py(this.manager);
...
class LA extends so {
  constructor(e, t, i) {
    super(e, i), this.isHemisphereLight = true, this.type = "HemisphereLight", this.position.copy(ut.DEFAULT_UP), this.updateMatrix(), this.groundColor = new Ue(t);
  }
  copy(e, t) {
    return super.copy(e, t), this.groundColor.copy(e.groundColor), this;
  }
}
const Ll = new Ye(), Ff = new N(), Bf = new N();
class qu {
  constructor(e) {
    this.camera = e, this.intensity = 1, this.bias = 0, this.normalBias = 0, this.radius = 1, this.blurSamples = 8, this.mapSize = new fe(512, 512), this.mapType = Vn, this.map = null, this.mapPass = null, this.matrix = new Ye(), this.autoUpdate = true, this.needsUpdate = false, this._frustum = new Bu(), this._frameExtents = new fe(1, 1), this._viewportCount = 1, this._viewports = [new it(0, 0, 1, 1)];
  }
  getViewportCount() {
  ...
  updateMatrices(e) {
    ...
    Ff.setFromMatrixPosition(e.matrixWorld), t.position.copy(Ff), Bf.setFromMatrixPosition(e.target.matrixWorld), t.lookAt(Bf), t.updateMatrixWorld(), Ll.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse), this._frustum.setFromProjectionMatrix(Ll), i.set(0.5, 0, 0, 0.5, 0, 0.5, 0, 0.5, 0, 0, 0.5, 0.5, 0, 0, 0, 1), i.multiply(Ll);
  }
  getViewport(e) {
...
class _y extends so {
  constructor(e, t, i = 0, s = Math.PI / 3, r = 0, o = 2) {
    super(e, t), this.isSpotLight = true, this.type = "SpotLight", this.position.copy(ut.DEFAULT_UP), this.updateMatrix(), this.target = new ut(), this.distance = i, this.angle = s, this.penumbra = r, this.decay = o, this.map = null, this.shadow = new gy();
  }
  get power() {
...
const zf = new Ye(), _r = new N(), Il = new N();
class xy extends qu {
  constructor() {
  ...
  updateMatrices(e, t = 0) {
    ...
    r !== i.far && (i.far = r, i.updateProjectionMatrix()), _r.setFromMatrixPosition(e.matrixWorld), i.position.copy(_r), Il.copy(i.position), Il.add(this._cubeDirections[t]), i.up.copy(this._cubeUps[t]), i.lookAt(Il), i.updateMatrixWorld(), s.makeTranslation(-_r.x, -_r.y, -_r.z), zf.multiplyMatrices(i.projectionMatrix, i.matrixWorldInverse), this._frustum.setFromProjectionMatrix(zf);
  }
}
class vy extends so {
  constructor(e, t, i = 0, s = 2) {
    super(e, t), this.isPointLight = true, this.type = "PointLight", this.distance = i, this.decay = s, this.shadow = new xy();
  }
  get power() {
...
class My extends so {
  constructor(e, t) {
    super(e, t), this.isDirectionalLight = true, this.type = "DirectionalLight", this.position.copy(ut.DEFAULT_UP), this.updateMatrix(), this.target = new ut(), this.shadow = new yy();
  }
  dispose() {
    this.shadow.dispose();
  }
  ...
  load(e, t, i, s) {
    ...
    if (o !== void 0) {
      if (r.manager.itemStart(e), o.then) {
        o.then((c) => {
          if (Dl.has(o) === true) s && s(Dl.get(o)), r.manager.itemError(e), r.manager.itemEnd(e);
    ...
    const l = fetch(e, a).then(function(c) {
      ...
      s && s(c), Dl.set(l, c), ai.remove(`image-bitmap:${e}`), r.manager.itemError(e), r.manager.itemEnd(e);
    });
...
class Wm {
  static getContext() {
    return Ho === void 0 && (Ho = new (window.AudioContext || window.webkitAudioContext)()), Ho;
  }
  static setContext(e) {
    Ho = e;
  }
...
class NA extends cs {
  ...
  load(e, t, i, s) {
    const r = this, o = new Yu(this.manager);
...
const Yi = new N(), Nl = new vn(), Ty = new N(), qi = new N(), ji = new N();
class UA extends ut {
  constructor() {
  ...
  updateMatrixWorld(e) {
    ...
    if (this.timeDelta = this._clock.getDelta(), this.matrixWorld.decompose(Yi, Nl, Ty), qi.set(0, 0, -1).applyQuaternion(Nl), ji.set(0, 1, 0).applyQuaternion(Nl), t.positionX) {
...
const ju = "\\[\\]\\.:\\/", Ay = new RegExp("[" + ju + "]", "g"), Ku = "[^" + ju + "]", wy = "[^" + ju.replace("\\.", "") + "]", Ry = /((?:WC+[\/:])*)/.source.replace("WC", Ku), Cy = /(WCOD+)?/.source.replace("WCOD", wy), Py = /(?:\.(WC+)(?:\[(.+)\])?)?/.source.replace("WC", Ku), Ly = /\.(WC+)(?:\[(.+)\])?/.source.replace("WC", Ku), Iy = new RegExp("^" + Ry + Cy + Py + Ly + "$"), Dy = ["material", "materials", "bones", "map"];
class Ny {
  constructor(e, t, i) {
    const s = i || rt.parseTrackName(t);
...
class rt {
  ...
  static sanitizeNodeName(e) {
    return e.replace(/\s/g, "_").replace(Ay, "");
  }
  static parseTrackName(e) {
    ...
    if (s !== void 0 && s !== -1) {
      ...
      Dy.indexOf(r) !== -1 && (i.nodeName = i.nodeName.substring(0, s), i.objectName = r);
    }
...
class Uy {
  constructor(e, t, i = null, s = t.blendMode) {
    ...
    const r = t.tracks, o = r.length, a = new Array(o), l = { endingStart: Ps, endingEnd: Ps };
    for (let c = 0; c !== o; ++c) {
  ...
  _setEndings(e, t, i) {
    ...
    i ? (s.endingStart = Ls, s.endingEnd = Ls) : (e ? s.endingStart = this.zeroSlopeAtStart ? Ls : Ps : s.endingStart = _a, t ? s.endingEnd = this.zeroSlopeAtEnd ? Ls : Ps : s.endingEnd = _a);
  }
...
class BA extends Oi {
  ...
  _bindAction(e, t) {
    ...
    for (let h = 0; h !== r; ++h) {
      ...
      if (m !== void 0) ++m.referenceCount, o[h] = m;
        ...
        m = new Ey(rt.create(i, d, _), f.ValueTypeName, f.getValueSize()), ++m.referenceCount, this._addInactiveBinding(m, l, d), o[h] = m;
      }
  ...
  _lendControlInterpolant() {
    ...
    let i = e[t];
    return i === void 0 && (i = new km(new Float32Array(2), new Float32Array(2), 1, Oy), i.__cacheIndex = t, e[t] = i), i;
  }
  ...
  clipAction(e, t, i) {
    ...
    let o = typeof e == "string" ? Jc.findByName(s, e) : e;
    const a = o !== null ? o.uuid : e, l = this._actionsByClip[a];
    let c = null;
    if (i === void 0 && (o !== null ? i = o.blendMode : i = Lu), l !== void 0) {
      const h = l.actionByRoot[r];
      if (h !== void 0 && h.blendMode === i) return h;
      c = l.knownActions[0], o === null && (o = c._clip);
    }
    if (o === null) return null;
    const u = new Uy(this, o, t, i);
    return this._bindAction(u, c), this._addInactiveAction(u, a, r), u;
  }
  existingAction(e, t) {
    const i = t || this._root, s = i.uuid, r = typeof e == "string" ? Jc.findByName(i, e) : e, o = r ? r.uuid : e, a = this._actionsByClip[o];
...
class HA {
  constructor(e, t, i = 0, s = 1 / 0) {
    this.ray = new to(e, t), this.near = i, this.far = s, this.camera = null, this.layers = new Nu(), this.params = { Mesh: {}, Line: { threshold: 1 }, LOD: {}, Points: { threshold: 1 }, Sprite: {} };
  }
  set(e, t) {
    this.ray.set(e, t);
  }
  ...
  setFromXRController(e) {
    return Hf.identity().extractRotation(e.matrixWorld), this.ray.origin.setFromMatrixPosition(e.matrixWorld), this.ray.direction.set(0, 0, -1).applyMatrix4(Hf), this;
  }
  intersectObject(e, t = true, i = []) {
    return Qc(e, this, i, t), i.sort(Vf), i;
  }
  intersectObjects(e, t = true, i = []) {
    for (let s = 0, r = e.length; s < r; s++) Qc(e[s], this, i, t);
    return i.sort(Vf), i;
  }
}
function Vf(n, e) {
...
function Qc(n, e, t, i) {
  ...
  if (n.layers.test(e.layers) && n.raycast(e, t) === false && (s = false), s === true && i === true) {
    const r = n.children;
    for (let o = 0, a = r.length; o < a; o++) Qc(r[o], e, t, true);
  }
}
class VA {
...
class kA {
  ...
  closestPointToPointParameter(e, t) {
    kf.subVectors(e, this.start), Vo.subVectors(this.end, this.start);
    const i = Vo.dot(Vo);
    let r = Vo.dot(kf) / i;
...
class GA extends kt {
  constructor(e, t, i) {
    const s = new Wu(t, 4, 2), r = new oi({ wireframe: true, fog: false, toneMapped: false });
...
const Fy = new N(), Gf = new Ue(), Wf = new Ue();
class WA extends ut {
  constructor(e, t, i) {
  ...
  update() {
    ...
    if (this.color !== void 0) this.material.color.set(this.color);
      ...
      Gf.copy(this.light.color), Wf.copy(this.light.groundColor);
      for (let i = 0, s = t.count; i < s; i++) {
        const r = i < s / 2 ? Gf : Wf;
    ...
    this.light.updateWorldMatrix(true, false), e.lookAt(Fy.setFromMatrixPosition(this.light.matrixWorld).negate());
  }
}
const Xf = new N(), ko = new N(), Yf = new N();
class XA extends ut {
  constructor(e, t, i) {
    ...
    const r = new Oa({ fog: false, toneMapped: false });
    this.lightPlane = new Kr(s, r), this.add(this.lightPlane), s = new St(), s.setAttribute("position", new et([0, 0, 0, 0, 0, 1], 3)), this.targetLine = new Kr(s, r), this.add(this.targetLine), this.update();
  }
  dispose() {
    this.lightPlane.geometry.dispose(), this.lightPlane.material.dispose(), this.targetLine.geometry.dispose(), this.targetLine.material.dispose();
  }
  update() {
    this.light.updateWorldMatrix(true, false), this.light.target.updateWorldMatrix(true, false), Xf.setFromMatrixPosition(this.light.matrixWorld), ko.setFromMatrixPosition(this.light.target.matrixWorld), Yf.subVectors(ko, Xf), this.lightPlane.lookAt(ko), this.color !== void 0 ? (this.lightPlane.material.color.set(this.color), this.targetLine.material.color.set(this.color)) : (this.lightPlane.material.color.copy(this.light.color), this.targetLine.material.color.copy(this.light.color)), this.targetLine.lookAt(ko), this.targetLine.scale.z = Yf.length();
  }
}
const Go = new N(), Tt = new Uu();
class YA extends Am {
  constructor(e) {
    const t = new St(), i = new Oa({ color: 16777215, vertexColors: true, toneMapped: false }), s = [], r = [], o = {};
  ...
  update() {
    ...
    Et("c", t, e, Tt, 0, 0, r), Et("t", t, e, Tt, 0, 0, 1), Et("n1", t, e, Tt, -i, -s, r), Et("n2", t, e, Tt, i, -s, r), Et("n3", t, e, Tt, -i, s, r), Et("n4", t, e, Tt, i, s, r), Et("f1", t, e, Tt, -i, -s, 1), Et("f2", t, e, Tt, i, -s, 1), Et("f3", t, e, Tt, -i, s, 1), Et("f4", t, e, Tt, i, s, 1), Et("u1", t, e, Tt, i * 0.7, s * 1.1, r), Et("u2", t, e, Tt, -i * 0.7, s * 1.1, r), Et("u3", t, e, Tt, 0, s * 2, r), Et("cf1", t, e, Tt, -i, 0, 1), Et("cf2", t, e, Tt, i, 0, 1), Et("cf3", t, e, Tt, 0, -s, 1), Et("cf4", t, e, Tt, 0, s, 1), Et("cn1", t, e, Tt, -i, 0, r), Et("cn2", t, e, Tt, i, 0, r), Et("cn3", t, e, Tt, 0, -s, r), Et("cn4", t, e, Tt, 0, s, r), e.getAttribute("position").needsUpdate = true;
  }
  dispose() {
    this.geometry.dispose(), this.material.dispose();
  }
...
function Et(n, e, t, i, s, r, o) {
  Go.set(s, r, o).unproject(i);
  const a = e[n];
  if (a !== void 0) {
    const l = t.getAttribute("position");
    for (let c = 0, u = a.length; c < u; c++) l.setXYZ(a[c], Go.x, Go.y, Go.z);
  }
}
class qA extends Oi {
...
typeof __THREE_DEVTOOLS__ < "u" && __THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register", { detail: { revision: Su } }));
typeof window < "u" && (window.__THREE__ ? console.warn("WARNING: Multiple instances of Three.js being imported.") : window.__THREE__ = Su);
/**
* @license
* Copyright 2010-2025 Three.js Authors
* SPDX-License-Identifier: MIT
...
const Wo = { r: 0, b: 0, g: 0 }, Ki = new Ln(), vb = new Ye();
function yb(n, e, t, i, s, r, o) {
  const a = new Ue(0);
...
function Mb(n, e) {
  ...
  function d(M, L, O, X) {
    ...
    for (const j in se) if (se[j].location >= 0) {
      const ve = Q[j];
      let be = ne[j];
      if (be === void 0 && (j === "instanceMatrix" && M.instanceMatrix && (be = M.instanceMatrix), j === "instanceColor" && M.instanceColor && (be = M.instanceColor)), ve === void 0 || ve.attribute !== be || be && ve.data !== be.data) return true;
      Z++;
    }
  ...
  function m(M, L, O, X) {
    ...
    for (const j in se) if (se[j].location >= 0) {
      let ve = ne[j];
      ve === void 0 && (j === "instanceMatrix" && M.instanceMatrix && (ve = M.instanceMatrix), j === "instanceColor" && M.instanceColor && (ve = M.instanceColor));
      const be = {};
      be.attribute = ve, ve && ve.data && (be.data = ve.data), Q[j] = be, Z++;
    }
    ...
    for (const se in ne) {
      ...
      if (j.location >= 0) {
        ...
        if (de === void 0 && (se === "instanceMatrix" && M.instanceMatrix && (de = M.instanceMatrix), se === "instanceColor" && M.instanceColor && (de = M.instanceColor)), de !== void 0) {
          const ve = de.normalized, be = de.itemSize, Oe = e.get(de);
          if (Oe === void 0) continue;
          const Ze = Oe.buffer, ie = Oe.type, pe = Oe.bytesPerElement, we = ie === n.INT || ie === n.UNSIGNED_INT || de.gpuType === Tu;
          if (de.isInterleavedBufferAttribute) {
            ...
            for (let Ne = 0; Ne < j.locationSize; Ne++) b(j.location + Ne, be / j.locationSize, ie, ve, Pe * pe, (ke + be / j.locationSize * Ne) * pe, we);
          } else {
            ...
            n.bindBuffer(n.ARRAY_BUFFER, Ze);
            for (let ge = 0; ge < j.locationSize; ge++) b(j.location + ge, be / j.locationSize, ie, ve, be * pe, be / j.locationSize * ge * pe, we);
          }
        } else if (Z !== void 0) {
          const ve = Z[se];
...
function bb(n, e, t, i) {
  ...
  function o(C) {
    return !(C !== gn && i.convert(C) !== n.getParameter(n.IMPLEMENTATION_COLOR_READ_FORMAT));
  }
  function a(C) {
...
function Eb(n) {
  ...
  function t(o, a) {
    return a === gc ? o.mapping = qs : a === _c && (o.mapping = js), o;
  }
  function i(o) {
    if (o && o.isTexture) {
      const a = o.mapping;
      if (a === gc || a === _c) if (e.has(o)) {
...
const Ds = 4, jf = [0.125, 0.215, 0.35, 0.446, 0.526, 0.582], is = 20, Ul = new Ba(), Kf = new Ue();
let Ol = null, Fl = 0, Bl = 0, zl = false;
const es = (1 + Math.sqrt(5)) / 2, ws = 1 / es, Zf = [new N(-es, ws, 0), new N(es, ws, 0), new N(-ws, 0, es), new N(ws, 0, es), new N(0, es, -ws), new N(0, es, ws), new N(-1, 1, -1), new N(1, 1, -1), new N(-1, 1, 1), new N(1, 1, 1)], Ab = new N();
class Jf {
  constructor(e) {
    this._renderer = e, this._pingPongRenderTarget = null, this._lodMax = 0, this._cubeSize = 0, this._lodPlanes = [], this._sizeLods = [], this._sigmas = [], this._blurMaterial = null, this._cubemapMaterial = null, this._equirectMaterial = null, this._compileMaterial(this._blurMaterial);
  }
  fromScene(e, t = 0, i = 0.1, s = 100, r = {}) {
    const { size: o = 256, position: a = Ab } = r;
    Ol = this._renderer.getRenderTarget(), Fl = this._renderer.getActiveCubeFace(), Bl = this._renderer.getActiveMipmapLevel(), zl = this._renderer.xr.enabled, this._renderer.xr.enabled = false, this._setSize(o);
  ...
  compileEquirectangularShader() {
    this._equirectMaterial === null && (this._equirectMaterial = $f(), this._compileMaterial(this._equirectMaterial));
  }
  dispose() {
  ...
  _cleanup(e) {
    this._renderer.setRenderTarget(Ol, Fl, Bl), this._renderer.xr.enabled = zl, e.scissorTest = false, Xo(e, 0, 0, e.width, e.height);
  }
  _fromTexture(e, t) {
    e.mapping === qs || e.mapping === js ? this._setSize(e.image.length === 0 ? 16 : e.image[0].width || e.image[0].image.width) : this._setSize(e.image.width / 4), Ol = this._renderer.getRenderTarget(), Fl = this._renderer.getActiveCubeFace(), Bl = this._renderer.getActiveMipmapLevel(), zl = this._renderer.xr.enabled, this._renderer.xr.enabled = false;
    const i = t || this._allocateTargets();
    return this._textureToCubeUV(e, i), this._applyPMREM(i), this._cleanup(i), i;
  }
  _allocateTargets() {
    const e = 3 * Math.max(this._cubeSize, 112), t = 4 * this._cubeSize, i = { magFilter: nn, minFilter: nn, generateMipmaps: false, type: Ni, format: gn, colorSpace: Jt, depthBuffer: false }, s = Qf(e, t, i);
    if (this._pingPongRenderTarget === null || this._pingPongRenderTarget.width !== e || this._pingPongRenderTarget.height !== t) {
      this._pingPongRenderTarget !== null && this._dispose(), this._pingPongRenderTarget = Qf(e, t, i);
      const { _lodMax: r } = this;
      ({ sizeLods: this._sizeLods, lodPlanes: this._lodPlanes, sigmas: this._sigmas } = wb(r)), this._blurMaterial = Rb(r, e, t);
    }
    return s;
  }
  _compileMaterial(e) {
    const t = new kt(this._lodPlanes[0], e);
    this._renderer.compile(t, Ul);
  }
  _sceneToCubeUV(e, t, i, s, r) {
    ...
    h.getClearColor(Kf), h.toneMapping = Li, h.autoClear = false;
    const m = new oi({ name: "PMREM.Background", side: sn, depthWrite: false, depthTest: false }), _ = new kt(new no(), m);
    let g = false;
    const p = e.background;
    p ? p.isColor && (m.color.copy(p), e.background = null, g = true) : (m.color.copy(Kf), g = true);
    for (let E = 0; E < 6; E++) {
      const b = E % 3;
      ...
      Xo(s, b * x, E > 2 ? x : 0, x, x), h.setRenderTarget(s), g && h.render(_, l), h.render(e, l);
    }
    _.geometry.dispose(), _.material.dispose(), h.toneMapping = d, h.autoClear = f, e.background = p;
  }
  _textureToCubeUV(e, t) {
    const i = this._renderer, s = e.mapping === qs || e.mapping === js;
    s ? (this._cubemapMaterial === null && (this._cubemapMaterial = ed()), this._cubemapMaterial.uniforms.flipEnvMap.value = e.isRenderTargetTexture === false ? -1 : 1) : this._equirectMaterial === null && (this._equirectMaterial = $f());
    const r = s ? this._cubemapMaterial : this._equirectMaterial, o = new kt(this._lodPlanes[0], r), a = r.uniforms;
    a.envMap.value = e;
    const l = this._cubeSize;
    Xo(t, 0, 0, 3 * l, 2 * l), i.setRenderTarget(t), i.render(o, Ul);
  }
  _applyPMREM(e) {
    ...
    for (let r = 1; r < s; r++) {
      const o = Math.sqrt(this._sigmas[r] * this._sigmas[r] - this._sigmas[r - 1] * this._sigmas[r - 1]), a = Zf[(s - r - 1) % Zf.length];
  ...
  _halfBlur(e, t, i, s, r, o, a) {
    ...
    const x = this._sizeLods[s], P = 3 * x * (s > b - Ds ? s - b + Ds : 0), w = 4 * (this._cubeSize - x);
    Xo(t, P, w, 3 * x, 2 * x), l.setRenderTarget(t), l.render(h, Ul);
  }
}
function wb(n) {
  const e = [], t = [], i = [];
  let s = n;
  const r = n - Ds + 1 + jf.length;
  for (let o = 0; o < r; o++) {
    const a = Math.pow(2, s);
    t.push(a);
    let l = 1 / a;
    o > n - Ds ? l = jf[o - n + Ds - 1] : o === 0 && (l = 0), i.push(l);
    ...
    const P = new St();
    P.setAttribute("position", new Ft(E, _)), P.setAttribute("uv", new Ft(b, g)), P.setAttribute("faceIndex", new Ft(x, p)), e.push(P), s > Ds && s--;
  }
  return { lodPlanes: e, sizeLods: t, sigmas: i };
}
function Qf(n, e, t) {
  const i = new kn(n, e, t);
  return i.texture.mapping = Na, i.texture.name = "PMREM.cubeUv", i.scissorTest = true, i;
}
...
function Rb(n, e, t) {
  ...
  return new rn({ name: "SphericalGaussianBlur", defines: { n: is, CUBEUV_TEXEL_WIDTH: 1 / e, CUBEUV_TEXEL_HEIGHT: 1 / t, CUBEUV_MAX_MIP: `${n}.0` }, uniforms: { envMap: { value: null }, samples: { value: 1 }, weights: { value: i }, latitudinal: { value: false }, dTheta: { value: 0 }, mipInt: { value: 0 }, poleAxis: { value: s } }, vertexShader: Zu(), fragmentShader: `
...
function $f() {
  return new rn({ name: "EquirectangularToCubeUV", uniforms: { envMap: { value: null } }, vertexShader: Zu(), fragmentShader: `
...
function ed() {
  return new rn({ name: "CubemapToCubeUV", uniforms: { envMap: { value: null }, flipEnvMap: { value: -1 } }, vertexShader: Zu(), fragmentShader: `
...
function Cb(n) {
  ...
  function i(a) {
    if (a && a.isTexture) {
      const l = a.mapping, c = l === gc || l === _c, u = l === qs || l === js;
      if (c || u) {
        let h = e.get(a);
        const f = h !== void 0 ? h.texture.pmremVersion : 0;
        if (a.isRenderTargetTexture && a.pmremVersion !== f) return t === null && (t = new Jf(n)), h = c ? t.fromEquirectangular(a, h) : t.fromCubemap(a, h), h.texture.pmremVersion = a.pmremVersion, e.set(a, h), h.texture;
        if (h !== void 0) return h.texture;
        {
          const d = a.image;
          return c && d && d.height > 0 || u && d && s(d) ? (t === null && (t = new Jf(n)), h = c ? t.fromEquirectangular(a) : t.fromCubemap(a), h.texture.pmremVersion = a.pmremVersion, e.set(a, h), a.addEventListener("dispose", r), h.texture) : null;
        }
      }
    }
    return a;
...
function Pb(n) {
  ...
  return { has: function(i) {
    ...
    const s = t(i);
    return s === null && Vs("THREE.WebGLRenderer: " + i + " extension not supported."), s;
  } };
}
function Lb(n, e, t, i) {
...
const qm = new wt(), td = new Rm(1, 1), jm = new gm(), Km = new qv(), Zm = new Mm(), nd = [], id = [], sd = new Float32Array(16), rd = new Float32Array(9), od = new Float32Array(4);
function sr(n, e, t) {
  const i = n[0];
  if (i <= 0 || i > 0) return n;
  const s = e * t;
  let r = nd[s];
  if (r === void 0 && (r = new Float32Array(s), nd[s] = r), e !== 0) {
    i.toArray(r, 0);
...
function Hb(n, e) {
  ...
  if (i === void 0) {
    ...
    if (Ct(t, i)) return;
    od.set(i), n.uniformMatrix2fv(this.addr, false, od), Pt(t, i);
  }
}
function Vb(n, e) {
  const t = this.cache, i = e.elements;
  if (i === void 0) {
    ...
    if (Ct(t, i)) return;
    rd.set(i), n.uniformMatrix3fv(this.addr, false, rd), Pt(t, i);
  }
}
function kb(n, e) {
  const t = this.cache, i = e.elements;
  if (i === void 0) {
    ...
    if (Ct(t, i)) return;
    sd.set(i), n.uniformMatrix4fv(this.addr, false, sd), Pt(t, i);
  }
}
function Gb(n, e) {
  const t = this.cache;
...
function Jb(n, e, t) {
  ...
  let r;
  this.type === n.SAMPLER_2D_SHADOW ? (td.compareFunction = pm, r = td) : r = qm, t.setTexture2D(e || r, s);
}
function Qb(n, e, t) {
  const i = this.cache, s = t.allocateTextureUnit();
...
function _T(n, e, t) {
  const i = this.cache, s = e.length, r = za(t, s);
...
class ST {
  constructor(e, t, i) {
    this.id = e, this.addr = i, this.cache = [], this.type = t.type, this.setValue = tT(t.type);
  }
}
class bT {
  constructor(e, t, i) {
    this.id = e, this.addr = i, this.cache = [], this.type = t.type, this.size = t.size, this.setValue = MT(t.type);
  }
}
class TT {
  constructor(e) {
...
function ET(n, e, t) {
  ...
  for (Hl.lastIndex = 0; ; ) {
    const r = Hl.exec(i), o = Hl.lastIndex;
    let a = r[1];
    const l = r[2] === "]", c = r[3];
    if (l && (a = a | 0), c === void 0 || c === "[" && o + 2 === s) {
      ad(t, c === void 0 ? new ST(a, n, e) : new bT(a, n, e));
      break;
    } else {
      let h = t.map[a];
      h === void 0 && (h = new TT(a), ad(t, h)), t = h;
    }
  }
}
class aa {
...
const cd = new je();
function CT(n) {
  $e._getMatrix(cd, $e.workingColorSpace, n);
...
const Yo = new N();
function IT() {
  $e.getLuminanceCoefficients(Yo);
  const n = Yo.x.toFixed(4), e = Yo.y.toFixed(4), t = Yo.z.toFixed(4);
  return ["float luminance( const in vec3 rgb ) {", `	const vec3 weights = vec3( ${n}, ${e}, ${t} );`, "	return dot( weights, rgb );", "}"].join(`
`);
}
function DT(n) {
  return [n.extensionClipCullDistance ? "#extension GL_ANGLE_clip_cull_distance : require" : "", n.extensionMultiDraw ? "#extension GL_ANGLE_multi_draw : require" : ""].filter(Sr).join(`
`);
}
function NT(n) {
  const e = [];
...
function YT(n, e, t, i) {
  ...
  const l = VT(t), c = kT(t), u = GT(t), h = WT(t), f = XT(t), d = DT(t), m = NT(r), _ = s.createProgram();
...
`) + `
` + p);
  const b = E + g + o, x = E + p + a, P = ld(s, s.VERTEX_SHADER, b), w = ld(s, s.FRAGMENT_SHADER, x);
  ...
  function C(L) {
    if (n.debug.checkShaderErrors) {
      ...
      if (s.getProgramParameter(_, s.LINK_STATUS) === false) if (ne = false, typeof n.debug.onShaderError == "function") n.debug.onShaderError(s, _, P, w);
        ...
        const se = ud(s, P, "vertex"), j = ud(s, w, "fragment");
...
` + j);
    ...
    s.deleteShader(P), s.deleteShader(w), I = new aa(s, _), S = UT(s, _);
  }
  let I;
  ...
  return this.isReady = function() {
    return M === false && (M = s.getProgramParameter(_, AT)), M;
  }, this.destroy = function() {
    i.releaseStatesOfProgram(this), s.deleteProgram(_), this.program = void 0;
  }, this.type = t.shaderType, this.name = t.shaderName, this.id = wT++, this.cacheKey = e, this.usedTimes = 1, this.program = _, this.vertexShader = P, this.fragmentShader = w, this;
}
let qT = 0;
class jT {
  constructor() {
  ...
  _getShaderStage(e) {
    ...
    let i = t.get(e);
    return i === void 0 && (i = new KT(e), t.set(e, i)), i;
  }
}
class KT {
  constructor(e) {
    this.id = qT++, this.code = e, this.usedTimes = 0;
  }
}
function ZT(n, e, t, i, s, r, o) {
  const a = new Nu(), l = new jT(), c = /* @__PURE__ */ new Set(), u = [], h = s.logarithmicDepthBuffer, f = s.vertexTextures;
  let d = s.precision;
  ...
  function g(S, M, L, O, X) {
    const Q = O.fog, ne = X.geometry, Z = S.isMeshStandardMaterial ? O.environment : null, se = (S.isMeshStandardMaterial ? t : e).get(S.envMap || Z), j = se && se.mapping === Na ? se.image.height : null, de = m[S.type];
  ...
  function P(S, M) {
    ...
    return L === void 0 && (L = new YT(n, M, S, r), u.push(L)), L;
  }
  function w(S) {
    if (--S.usedTimes === 0) {
      const M = u.indexOf(S);
...
function gd() {
  ...
  function c(h, f) {
    t.length > 1 && t.sort(h || QT), i.length > 1 && i.sort(f || md), s.length > 1 && s.sort(f || md);
  }
  function u() {
...
function $T() {
  ...
  function e(i, s) {
    const r = n.get(i);
    let o;
    return r === void 0 ? (o = new gd(), n.set(i, [o])) : s >= r.length ? (o = new gd(), r.push(o)) : o = r[s], o;
  }
  function t() {
    n = /* @__PURE__ */ new WeakMap();
  }
...
function sE(n) {
  const e = new eE(), t = tE(), i = { version: 0, hash: { directionalLength: -1, pointLength: -1, spotLength: -1, rectAreaLength: -1, hemiLength: -1, numDirectionalShadows: -1, numPointShadows: -1, numSpotShadows: -1, numSpotMaps: -1, numLightProbes: -1 }, ambient: [0, 0, 0], probe: [], directional: [], directionalShadow: [], directionalShadowMap: [], directionalShadowMatrix: [], spot: [], spotLightMap: [], spotShadow: [], spotShadowMap: [], spotLightMatrix: [], rectArea: [], rectAreaLTC1: null, rectAreaLTC2: null, point: [], pointShadow: [], pointShadowMap: [], pointShadowMatrix: [], hemi: [], numSpotLightShadowsWithMaps: 0, numLightProbes: 0 };
...
function rE(n) {
  ...
  function t(s, r = 0) {
    const o = e.get(s);
    let a;
    return o === void 0 ? (a = new _d(n), e.set(s, [a])) : r >= o.length ? (a = new _d(n), o.push(a)) : a = o[r], a;
  }
  function i() {
    e = /* @__PURE__ */ new WeakMap();
  }
...
function lE(n, e, t) {
  let i = new Bu();
  const s = new fe(), r = new fe(), o = new it(), a = new ny({ depthPacking: fv }), l = new iy(), c = {}, u = t.maxTextureSize, h = { [fi]: sn, [sn]: fi, [Bn]: Bn }, f = new rn({ defines: { VSM_SAMPLES: 8 }, uniforms: { shadow_pass: { value: null }, resolution: { value: new fe() }, radius: { value: 4 } }, vertexShader: oE, fragmentShader: aE }), d = f.clone();
  ...
  this.render = function(w, C, I) {
    ...
    O.setBlending(li), O.buffers.color.setClear(1, 1, 1, 1), O.buffers.depth.setTest(true), O.setScissorTest(false);
    ...
    for (let ne = 0, Z = w.length; ne < Z; ne++) {
      ...
      for (let be = 0; be < ve; be++) {
        const Oe = j.getViewport(be);
        o.set(r.x * Oe.x, r.y * Oe.y, r.x * Oe.z, r.y * Oe.w), O.viewport(o), j.updateMatrices(se, be), i = j.getFrustum(), x(C, I, j.camera, se, this.type);
      }
    ...
    if (w.layers.test(C.layers) && (w.isMesh || w.isLine || w.isPoints) && (w.castShadow || w.receiveShadow && M === ei) && (!w.frustumCulled || i.intersectsObject(w))) {
      ...
      if (Array.isArray(Q)) {
        ...
        for (let Z = 0, se = ne.length; Z < se; Z++) {
          ...
          if (de && de.visible) {
            const ve = b(w, de, S, M);
            w.onBeforeShadow(n, w, C, I, X, ve, j), n.renderBufferDirect(I, null, X, ve, w, j), w.onAfterShadow(n, w, C, I, X, ve, j);
          }
        }
      } else if (Q.visible) {
        const ne = b(w, Q, S, M);
...
const cE = { [cc]: uc, [hc]: pc, [fc]: mc, [Ys]: dc, [uc]: cc, [pc]: hc, [mc]: fc, [dc]: Ys };
function uE(n, e) {
  function t() {
    let B = false;
    const Me = new it();
  ...
  function s() {
    ...
    return { setTest: function(ot) {
      B || (ot ? ge(n.STENCIL_TEST) : Pe(n.STENCIL_TEST));
    }, setMask: function(ot) {
      Me !== ot && !B && (n.stencilMask(ot), Me = ot);
    }, setFunc: function(ot, Sn, Yn) {
      (le !== ot || Re !== Sn || ue !== Yn) && (n.stencilFunc(ot, Sn, Yn), le = ot, Re = Sn, ue = Yn);
    }, setOp: function(ot, Sn, Yn) {
      (re !== ot || Ie !== Sn || Xe !== Yn) && (n.stencilOp(ot, Sn, Yn), re = ot, Ie = Sn, Xe = Yn);
    }, setLocked: function(ot) {
      B = ot;
    }, setClear: function(ot) {
      mt !== ot && (n.clearStencil(ot), mt = ot);
    }, reset: function() {
  ...
  let de = null, ve = {};
  const be = n.getParameter(n.SCISSOR_BOX), Oe = n.getParameter(n.VIEWPORT), Ze = new it().fromArray(be), ie = new it().fromArray(Oe);
  ...
  const D = { [Wx]: n.ZERO, [Xx]: n.ONE, [Yx]: n.SRC_COLOR, [ac]: n.SRC_ALPHA, [Qx]: n.SRC_ALPHA_SATURATE, [Zx]: n.DST_COLOR, [jx]: n.DST_ALPHA, [qx]: n.ONE_MINUS_SRC_COLOR, [lc]: n.ONE_MINUS_SRC_ALPHA, [Jx]: n.ONE_MINUS_DST_COLOR, [Kx]: n.ONE_MINUS_DST_ALPHA, [$x]: n.CONSTANT_COLOR, [ev]: n.ONE_MINUS_CONSTANT_COLOR, [tv]: n.CONSTANT_ALPHA, [nv]: n.ONE_MINUS_CONSTANT_ALPHA };
  function y(B, Me, le, Re, ue, re, Ie, Xe, mt, ot) {
    if (B === li) {
    ...
    if (_ === false && (ge(n.BLEND), _ = true), B !== zx) {
      if (B !== g || ot !== S) {
        if ((p !== ns || x !== ns) && (n.blendEquation(n.FUNC_ADD), p = ns, x = ns), ot) switch (B) {
          case Hs:
        ...
        E = null, b = null, P = null, w = null, C.set(0, 0, 0), I = 0, g = B, S = ot;
      }
      return;
    }
  ...
  function V(B, Me) {
    ...
    let le = B.side === sn;
    Me && (le = !le), F(le), B.blending === Hs && B.transparent === false ? y(li) : y(B.blending, B.blendEquation, B.blendSrc, B.blendDst, B.blendEquationAlpha, B.blendSrcAlpha, B.blendDstAlpha, B.blendColor, B.blendAlpha, B.premultipliedAlpha), o.setFunc(B.depthFunc), o.setTest(B.depthTest), o.setMask(B.depthWrite), r.setMask(B.colorWrite);
  ...
  function H(B) {
    B !== Ox ? (ge(n.CULL_FACE), B !== L && (B === Wh ? n.cullFace(n.BACK) : B === Fx ? n.cullFace(n.FRONT) : n.cullFace(n.FRONT_AND_BACK))) : Pe(n.CULL_FACE), L = B;
  }
  function z(B) {
  ...
  function ae(B, Me, le) {
    ...
    let Re = ve[le];
    Re === void 0 && (Re = { type: void 0, texture: void 0 }, ve[le] = Re), (Re.type !== B || Re.texture !== Me) && (de !== le && (n.activeTexture(le), de = le), n.bindTexture(B, Me || we[B]), Re.type = B, Re.texture = Me);
  }
  function T() {
    const B = ve[de];
...
function hE(n, e, t, i, s, r, o) {
  ...
  function _(T, v, U) {
    ...
    if ((te.width > U || te.height > U) && (Y = U / Math.max(te.width, te.height)), Y < 1) if (typeof HTMLImageElement < "u" && T instanceof HTMLImageElement || typeof HTMLCanvasElement < "u" && T instanceof HTMLCanvasElement || typeof ImageBitmap < "u" && T instanceof ImageBitmap || typeof VideoFrame < "u" && T instanceof VideoFrame) {
      const K = Math.floor(Y * te.width), xe = Math.floor(Y * te.height);
      h === void 0 && (h = m(K, xe));
      const ce = v ? m(K, xe) : h;
      return ce.width = K, ce.height = xe, ce.getContext("2d").drawImage(T, 0, 0, K, xe), console.warn("THREE.WebGLRenderer: Texture has been resized from (" + te.width + "x" + te.height + ") to (" + K + "x" + xe + ")."), ce;
  ...
  function b(T, v, U, Y, te = false) {
    ...
    if (v === n.RED && (U === n.FLOAT && (K = n.R32F), U === n.HALF_FLOAT && (K = n.R16F), U === n.UNSIGNED_BYTE && (K = n.R8)), v === n.RED_INTEGER && (U === n.UNSIGNED_BYTE && (K = n.R8UI), U === n.UNSIGNED_SHORT && (K = n.R16UI), U === n.UNSIGNED_INT && (K = n.R32UI), U === n.BYTE && (K = n.R8I), U === n.SHORT && (K = n.R16I), U === n.INT && (K = n.R32I)), v === n.RG && (U === n.FLOAT && (K = n.RG32F), U === n.HALF_FLOAT && (K = n.RG16F), U === n.UNSIGNED_BYTE && (K = n.RG8)), v === n.RG_INTEGER && (U === n.UNSIGNED_BYTE && (K = n.RG8UI), U === n.UNSIGNED_SHORT && (K = n.RG16UI), U === n.UNSIGNED_INT && (K = n.RG32UI), U === n.BYTE && (K = n.RG8I), U === n.SHORT && (K = n.RG16I), U === n.INT && (K = n.RG32I)), v === n.RGB_INTEGER && (U === n.UNSIGNED_BYTE && (K = n.RGB8UI), U === n.UNSIGNED_SHORT && (K = n.RGB16UI), U === n.UNSIGNED_INT && (K = n.RGB32UI), U === n.BYTE && (K = n.RGB8I), U === n.SHORT && (K = n.RGB16I), U === n.INT && (K = n.RGB32I)), v === n.RGBA_INTEGER && (U === n.UNSIGNED_BYTE && (K = n.RGBA8UI), U === n.UNSIGNED_SHORT && (K = n.RGBA16UI), U === n.UNSIGNED_INT && (K = n.RGBA32UI), U === n.BYTE && (K = n.RGBA8I), U === n.SHORT && (K = n.RGBA16I), U === n.INT && (K = n.RGBA32I)), v === n.RGB && U === n.UNSIGNED_INT_5_9_9_9_REV && (K = n.RGB9_E5), v === n.RGBA) {
      const xe = te ? xa : $e.getTransfer(Y);
      U === n.FLOAT && (K = n.RGBA32F), U === n.HALF_FLOAT && (K = n.RGBA16F), U === n.UNSIGNED_BYTE && (K = xe === at ? n.SRGB8_ALPHA8 : n.RGBA8), U === n.UNSIGNED_SHORT_4_4_4_4 && (K = n.RGBA4), U === n.UNSIGNED_SHORT_5_5_5_1 && (K = n.RGB5_A1);
    }
    return (K === n.R16F || K === n.R32F || K === n.RG16F || K === n.RG32F || K === n.RGBA16F || K === n.RGBA32F) && e.get("EXT_color_buffer_float"), K;
  }
  function x(T, v) {
    let U;
    return T ? v === null || v === as || v === Gr ? U = n.DEPTH24_STENCIL8 : v === Rn ? U = n.DEPTH32F_STENCIL8 : v === kr && (U = n.DEPTH24_STENCIL8, console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")) : v === null || v === as || v === Gr ? U = n.DEPTH_COMPONENT24 : v === Rn ? U = n.DEPTH_COMPONENT32F : v === kr && (U = n.DEPTH_COMPONENT16), U;
  }
  function P(T, v) {
  ...
  const de = { [Ks]: n.REPEAT, [Ci]: n.CLAMP_TO_EDGE, [ga]: n.MIRRORED_REPEAT }, ve = { [Ot]: n.NEAREST, [rm]: n.NEAREST_MIPMAP_NEAREST, [yr]: n.NEAREST_MIPMAP_LINEAR, [nn]: n.LINEAR, [ta]: n.LINEAR_MIPMAP_NEAREST, [ri]: n.LINEAR_MIPMAP_LINEAR }, be = { [pv]: n.NEVER, [yv]: n.ALWAYS, [mv]: n.LESS, [pm]: n.LEQUAL, [gv]: n.EQUAL, [vv]: n.GEQUAL, [_v]: n.GREATER, [xv]: n.NOTEQUAL };
  function Oe(T, v) {
    if (v.type === Rn && e.has("OES_texture_float_linear") === false && (v.magFilter === nn || v.magFilter === ta || v.magFilter === yr || v.magFilter === ri || v.minFilter === nn || v.minFilter === ta || v.minFilter === yr || v.minFilter === ri) && console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."), n.texParameteri(T, n.TEXTURE_WRAP_S, de[v.wrapS]), n.texParameteri(T, n.TEXTURE_WRAP_T, de[v.wrapT]), (T === n.TEXTURE_3D || T === n.TEXTURE_2D_ARRAY) && n.texParameteri(T, n.TEXTURE_WRAP_R, de[v.wrapR]), n.texParameteri(T, n.TEXTURE_MAG_FILTER, ve[v.magFilter]), n.texParameteri(T, n.TEXTURE_MIN_FILTER, ve[v.minFilter]), v.compareFunction && (n.texParameteri(T, n.TEXTURE_COMPARE_MODE, n.COMPARE_REF_TO_TEXTURE), n.texParameteri(T, n.TEXTURE_COMPARE_FUNC, be[v.compareFunction])), e.has("EXT_texture_filter_anisotropic") === true) {
      if (v.magFilter === Ot || v.minFilter !== yr && v.minFilter !== ri || v.type === Rn && e.has("OES_texture_float_linear") === false) return;
  ...
  function Ze(T, v) {
    ...
    if (K !== T.__cacheKey) {
      ...
      const xe = te[T.__cacheKey];
      xe !== void 0 && (te[T.__cacheKey].usedTimes--, xe.usedTimes === 0 && S(v)), T.__cacheKey = K, T.__webglTexture = te[K].texture;
    }
    return U;
  }
  function ie(T, v, U) {
  ...
  function pe(T, v, U, Y) {
    ...
    if (K.length === 0) t.texSubImage2D(n.TEXTURE_2D, 0, 0, 0, v.width, v.height, U, Y, v.data);
      ...
      for (let oe = 1; oe < K.length; oe++) {
        const Ee = K[xe], Ce = K[oe], Le = Ee.start + Ee.count, me = ie(Ce.start, v.width, 4), Ge = ie(Ee.start, v.width, 4);
        Ce.start <= Le + 1 && me === Ge && ie(Ce.start + Ce.count - 1, v.width, 4) === me ? Ee.count = Math.max(Ee.count, Ce.start + Ce.count - Ee.start) : (++xe, K[xe] = Ce);
      }
      K.length = xe + 1;
  ...
  function we(T, v, U) {
    ...
    const xe = i.get(K);
    if (K.version !== xe.__version || te === true) {
      t.activeTexture(n.TEXTURE0 + U);
      const ce = $e.getPrimaries($e.workingColorSpace), ye = v.colorSpace === Ri ? null : $e.getPrimaries(v.colorSpace), Te = v.colorSpace === Ri || ce === ye ? n.NONE : n.BROWSER_DEFAULT_WEBGL;
      ...
      Oe(Y, v);
      let me;
      const Ge = v.mipmaps, B = v.isVideoTexture !== true, Me = xe.__version === void 0 || te === true, le = K.dataReady, Re = P(v, oe);
      if (v.isDepthTexture) Le = x(v.format === Xr, v.type), Me && (B ? t.texStorage2D(n.TEXTURE_2D, 1, Le, oe.width, oe.height) : t.texImage2D(n.TEXTURE_2D, 0, Le, oe.width, oe.height, 0, Ee, Ce, null));
        ...
        for (let ue = 0, re = Ge.length; ue < re; ue++) if (me = Ge[ue], v.format !== gn) if (Ee !== null) if (B) {
          if (le) if (v.layerUpdates.size > 0) {
            const Ie = qf(me.width, me.height, v.format, v.type);
        ...
        B && Me && t.texStorage2D(n.TEXTURE_2D, Re, Le, Ge[0].width, Ge[0].height);
        for (let ue = 0, re = Ge.length; ue < re; ue++) me = Ge[ue], v.format !== gn ? Ee !== null ? B ? le && t.compressedTexSubImage2D(n.TEXTURE_2D, ue, 0, 0, me.width, me.height, Ee, me.data) : t.compressedTexImage2D(n.TEXTURE_2D, ue, Le, me.width, me.height, 0, me.data) : console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()") : B ? le && t.texSubImage2D(n.TEXTURE_2D, ue, 0, 0, me.width, me.height, Ee, Ce, me.data) : t.texImage2D(n.TEXTURE_2D, ue, Le, me.width, me.height, 0, Ee, Ce, me.data);
      }
        ...
        if (Me && t.texStorage3D(n.TEXTURE_2D_ARRAY, Re, Le, oe.width, oe.height, oe.depth), le) if (v.layerUpdates.size > 0) {
          const ue = qf(oe.width, oe.height, v.format, v.type);
      ...
      g(v) && p(Y), xe.__version = K.version, v.onUpdate && v.onUpdate(v);
    }
  ...
  function ge(T, v, U) {
    ...
    if (te.version !== K.__version || Y === true) {
      t.activeTexture(n.TEXTURE0 + U);
      const xe = $e.getPrimaries($e.workingColorSpace), ce = v.colorSpace === Ri ? null : $e.getPrimaries(v.colorSpace), ye = v.colorSpace === Ri || xe === ce ? n.NONE : n.BROWSER_DEFAULT_WEBGL;
      ...
      if (Te) {
        ...
        for (let re = 0; re < 6; re++) {
          ...
          for (let Ie = 0; Ie < ue.length; Ie++) {
            const Xe = ue[Ie];
            v.format !== gn ? Le !== null ? B ? le && t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X + re, Ie, 0, 0, Xe.width, Xe.height, Le, Xe.data) : t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X + re, Ie, Ge, Xe.width, Xe.height, 0, Xe.data) : console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()") : B ? le && t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X + re, Ie, 0, 0, Xe.width, Xe.height, Le, me, Xe.data) : t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X + re, Ie, Ge, Xe.width, Xe.height, 0, Le, me, Xe.data);
          }
        }
      } else {
  ...
  function Pe(T, v, U, Y, te, K) {
    const xe = r.convert(U.format, U.colorSpace), ce = r.convert(U.type), ye = b(U.internalFormat, xe, ce, U.colorSpace), Te = i.get(v), oe = i.get(U);
    if (oe.__renderTarget = v, !Te.__hasExternalTextures) {
      const Ee = Math.max(1, v.width >> K), Ce = Math.max(1, v.height >> K);
      te === n.TEXTURE_3D || te === n.TEXTURE_2D_ARRAY ? t.texImage3D(te, K, ye, Ee, Ce, v.depth, 0, xe, ce, null) : t.texImage2D(te, K, ye, Ee, Ce, 0, xe, ce, null);
    }
  ...
  function ke(T, v, U) {
    if (n.bindRenderbuffer(n.RENDERBUFFER, T), v.depthBuffer) {
      const Y = v.depthTexture, te = Y && Y.isDepthTexture ? Y.type : null, K = x(v.stencilBuffer, te), xe = v.stencilBuffer ? n.DEPTH_STENCIL_ATTACHMENT : n.DEPTH_ATTACHMENT, ce = z(v);
      J(v) ? a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER, ce, K, v.width, v.height) : U ? n.renderbufferStorageMultisample(n.RENDERBUFFER, ce, K, v.width, v.height) : n.renderbufferStorage(n.RENDERBUFFER, K, v.width, v.height), n.framebufferRenderbuffer(n.FRAMEBUFFER, xe, n.RENDERBUFFER, T);
    } else {
      const Y = v.textures;
      for (let te = 0; te < Y.length; te++) {
        const K = Y[te], xe = r.convert(K.format, K.colorSpace), ce = r.convert(K.type), ye = b(K.internalFormat, xe, ce, K.colorSpace), Te = z(v);
  ...
  function Ne(T, v) {
    ...
    if (v.depthTexture.format === Wr) J(v) ? a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER, n.DEPTH_ATTACHMENT, n.TEXTURE_2D, te, 0, K) : n.framebufferTexture2D(n.FRAMEBUFFER, n.DEPTH_ATTACHMENT, n.TEXTURE_2D, te, 0);
    else if (v.depthTexture.format === Xr) J(v) ? a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER, n.DEPTH_STENCIL_ATTACHMENT, n.TEXTURE_2D, te, 0, K) : n.framebufferTexture2D(n.FRAMEBUFFER, n.DEPTH_STENCIL_ATTACHMENT, n.TEXTURE_2D, te, 0);
  ...
  function D(T) {
    ...
    const te = T.textures, K = T.isWebGLCubeRenderTarget === true, xe = te.length > 1;
    if (xe || (Y.__webglTexture === void 0 && (Y.__webglTexture = n.createTexture()), Y.__version = v.version, o.memory.textures++), K) {
      ...
      if (xe) for (let ce = 0, ye = te.length; ce < ye; ce++) {
    ...
    if (K) {
      t.bindTexture(n.TEXTURE_CUBE_MAP, Y.__webglTexture), Oe(n.TEXTURE_CUBE_MAP, v);
      ...
      for (let ce = 0, ye = te.length; ce < ye; ce++) {
        ...
        t.bindTexture(n.TEXTURE_2D, oe.__webglTexture), Oe(n.TEXTURE_2D, Te), Pe(U.__webglFramebuffer, T, Te, n.COLOR_ATTACHMENT0 + ce, n.TEXTURE_2D, 0), g(Te) && p(n.TEXTURE_2D);
      }
      t.unbindTexture();
    } else {
      let ce = n.TEXTURE_2D;
      if ((T.isWebGL3DRenderTarget || T.isWebGLArrayRenderTarget) && (ce = T.isWebGL3DRenderTarget ? n.TEXTURE_3D : n.TEXTURE_2D_ARRAY), t.bindTexture(ce, Y.__webglTexture), Oe(ce, v), v.mipmaps && v.mipmaps.length > 0) for (let ye = 0; ye < v.mipmaps.length; ye++) Pe(U.__webglFramebuffer[ye], T, v, n.COLOR_ATTACHMENT0, ce, ye);
  ...
  function y(T) {
    ...
    for (let U = 0, Y = v.length; U < Y; U++) {
      const te = v[U];
      if (g(te)) {
        const K = E(T), xe = i.get(te).__webglTexture;
        t.bindTexture(K, xe), p(K), t.unbindTexture();
      }
    }
  }
  const V = [], F = [];
  function H(T) {
    if (T.samples > 0) {
      if (J(T) === false) {
        ...
        const K = T.stencilBuffer ? n.DEPTH_STENCIL_ATTACHMENT : n.DEPTH_ATTACHMENT, xe = i.get(T), ce = v.length > 1;
        if (ce) for (let Te = 0; Te < v.length; Te++) t.bindFramebuffer(n.FRAMEBUFFER, xe.__webglMultisampledFramebuffer), n.framebufferRenderbuffer(n.FRAMEBUFFER, n.COLOR_ATTACHMENT0 + Te, n.RENDERBUFFER, null), t.bindFramebuffer(n.FRAMEBUFFER, xe.__webglFramebuffer), n.framebufferTexture2D(n.DRAW_FRAMEBUFFER, n.COLOR_ATTACHMENT0 + Te, n.TEXTURE_2D, null, 0);
        t.bindFramebuffer(n.READ_FRAMEBUFFER, xe.__webglMultisampledFramebuffer);
        const ye = T.texture.mipmaps;
        ye && ye.length > 0 ? t.bindFramebuffer(n.DRAW_FRAMEBUFFER, xe.__webglFramebuffer[0]) : t.bindFramebuffer(n.DRAW_FRAMEBUFFER, xe.__webglFramebuffer);
        for (let Te = 0; Te < v.length; Te++) {
          if (T.resolveDepthBuffer && (T.depthBuffer && (te |= n.DEPTH_BUFFER_BIT), T.stencilBuffer && T.resolveStencilBuffer && (te |= n.STENCIL_BUFFER_BIT)), ce) {
            n.framebufferRenderbuffer(n.READ_FRAMEBUFFER, n.COLOR_ATTACHMENT0, n.RENDERBUFFER, xe.__webglColorRenderbuffer[Te]);
        ...
        if (t.bindFramebuffer(n.READ_FRAMEBUFFER, null), t.bindFramebuffer(n.DRAW_FRAMEBUFFER, null), ce) for (let Te = 0; Te < v.length; Te++) {
          t.bindFramebuffer(n.FRAMEBUFFER, xe.__webglMultisampledFramebuffer), n.framebufferRenderbuffer(n.FRAMEBUFFER, n.COLOR_ATTACHMENT0 + Te, n.RENDERBUFFER, xe.__webglColorRenderbuffer[Te]);
          const oe = i.get(v[Te]).__webglTexture;
          t.bindFramebuffer(n.FRAMEBUFFER, xe.__webglFramebuffer), n.framebufferTexture2D(n.DRAW_FRAMEBUFFER, n.COLOR_ATTACHMENT0 + Te, n.TEXTURE_2D, oe, 0);
        }
  ...
  function q(T, v) {
    ...
    return T.isCompressedTexture === true || T.isVideoTexture === true || U !== Jt && U !== Ri && ($e.getTransfer(U) === at ? (Y !== gn || te !== Vn) && console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType.") : console.error("THREE.WebGLTextures: Unsupported texture color space:", U)), v;
  }
  function ae(T) {
...
function fE(n, e) {
  function t(i, s = Ri) {
    ...
    if (i === Eu) return n.UNSIGNED_SHORT_4_4_4_4;
    if (i === Au) return n.UNSIGNED_SHORT_5_5_5_1;
    if (i === lm) return n.UNSIGNED_INT_5_9_9_9_REV;
    if (i === om) return n.BYTE;
    if (i === am) return n.SHORT;
    if (i === kr) return n.UNSIGNED_SHORT;
    if (i === Tu) return n.INT;
    ...
    if (i === Xr) return n.DEPTH_STENCIL;
    if (i === wu) return n.RED;
    if (i === Ru) return n.RED_INTEGER;
    if (i === hm) return n.RG;
    if (i === Cu) return n.RG_INTEGER;
    if (i === Pu) return n.RGBA_INTEGER;
    if (i === na || i === ia || i === sa || i === ra) if (o === at) if (r = e.get("WEBGL_compressed_texture_s3tc_srgb"), r !== null) {
      if (i === na) return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;
      if (i === ia) return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;
      if (i === sa) return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;
      if (i === ra) return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT;
    } else return null;
    else if (r = e.get("WEBGL_compressed_texture_s3tc"), r !== null) {
      if (i === na) return r.COMPRESSED_RGB_S3TC_DXT1_EXT;
      if (i === ia) return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;
      if (i === sa) return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;
      if (i === ra) return r.COMPRESSED_RGBA_S3TC_DXT5_EXT;
    } else return null;
    if (i === xc || i === vc || i === yc || i === Mc) if (r = e.get("WEBGL_compressed_texture_pvrtc"), r !== null) {
      if (i === xc) return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;
      if (i === vc) return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;
      if (i === yc) return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;
      if (i === Mc) return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG;
    } else return null;
    if (i === Sc || i === bc || i === Tc) if (r = e.get("WEBGL_compressed_texture_etc"), r !== null) {
      if (i === Sc || i === bc) return o === at ? r.COMPRESSED_SRGB8_ETC2 : r.COMPRESSED_RGB8_ETC2;
      if (i === Tc) return o === at ? r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC : r.COMPRESSED_RGBA8_ETC2_EAC;
    } else return null;
    if (i === Ec || i === Ac || i === wc || i === Rc || i === Cc || i === Pc || i === Lc || i === Ic || i === Dc || i === Nc || i === Uc || i === Oc || i === Fc || i === Bc) if (r = e.get("WEBGL_compressed_texture_astc"), r !== null) {
      if (i === Ec) return o === at ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR : r.COMPRESSED_RGBA_ASTC_4x4_KHR;
      if (i === Ac) return o === at ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR : r.COMPRESSED_RGBA_ASTC_5x4_KHR;
      if (i === wc) return o === at ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR : r.COMPRESSED_RGBA_ASTC_5x5_KHR;
      if (i === Rc) return o === at ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR : r.COMPRESSED_RGBA_ASTC_6x5_KHR;
      if (i === Cc) return o === at ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR : r.COMPRESSED_RGBA_ASTC_6x6_KHR;
      if (i === Pc) return o === at ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR : r.COMPRESSED_RGBA_ASTC_8x5_KHR;
      if (i === Lc) return o === at ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR : r.COMPRESSED_RGBA_ASTC_8x6_KHR;
      if (i === Ic) return o === at ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR : r.COMPRESSED_RGBA_ASTC_8x8_KHR;
      if (i === Dc) return o === at ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR : r.COMPRESSED_RGBA_ASTC_10x5_KHR;
      if (i === Nc) return o === at ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR : r.COMPRESSED_RGBA_ASTC_10x6_KHR;
      if (i === Uc) return o === at ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR : r.COMPRESSED_RGBA_ASTC_10x8_KHR;
      if (i === Oc) return o === at ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR : r.COMPRESSED_RGBA_ASTC_10x10_KHR;
      if (i === Fc) return o === at ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR : r.COMPRESSED_RGBA_ASTC_12x10_KHR;
      if (i === Bc) return o === at ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR : r.COMPRESSED_RGBA_ASTC_12x12_KHR;
    } else return null;
    if (i === oa || i === zc || i === Hc) if (r = e.get("EXT_texture_compression_bptc"), r !== null) {
      if (i === oa) return o === at ? r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT : r.COMPRESSED_RGBA_BPTC_UNORM_EXT;
      if (i === zc) return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;
      if (i === Hc) return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT;
    } else return null;
    if (i === fm || i === Vc || i === kc || i === Gc) if (r = e.get("EXT_texture_compression_rgtc"), r !== null) {
      if (i === oa) return r.COMPRESSED_RED_RGTC1_EXT;
      if (i === Vc) return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;
      if (i === kc) return r.COMPRESSED_RED_GREEN_RGTC2_EXT;
      if (i === Gc) return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT;
    } else return null;
    return i === Gr ? n.UNSIGNED_INT_24_8 : n[i] !== void 0 ? n[i] : null;
  }
  return { convert: t };
}
const dE = `
...
class mE {
  ...
  init(e, t, i) {
    if (this.texture === null) {
      const s = new wt(), r = e.properties.get(s);
  ...
  getMesh(e) {
    if (this.texture !== null && this.mesh === null) {
      const t = e.cameras[0].viewport, i = new rn({ vertexShader: dE, fragmentShader: pE, uniforms: { depthColor: { value: this.texture }, depthWidth: { value: t.z }, depthHeight: { value: t.w } } });
      this.mesh = new kt(new Fa(20, 20), i);
    }
    return this.mesh;
  }
  reset() {
...
class gE extends Oi {
  constructor(e, t) {
    ...
    const _ = new mE(), g = t.getContextAttributes();
    let p = null, E = null;
    const b = [], x = [], P = new fe();
    let w = null;
    const C = new tn();
    ...
    const I = new tn();
    I.viewport = new it();
    const S = [C, I], M = new by();
    let L = null, O = null;
    this.cameraAutoUpdate = true, this.enabled = false, this.isPresenting = false, this.getController = function(ie) {
      let pe = b[ie];
      return pe === void 0 && (pe = new bl(), b[ie] = pe), pe.getTargetRaySpace();
    }, this.getControllerGrip = function(ie) {
      let pe = b[ie];
      return pe === void 0 && (pe = new bl(), b[ie] = pe), pe.getGripSpace();
    }, this.getHand = function(ie) {
      let pe = b[ie];
      return pe === void 0 && (pe = new bl(), b[ie] = pe), pe.getHandSpace();
    };
    function X(ie) {
    ...
    this.setFramebufferScaleFactor = function(ie) {
      ...
      if (s = ie, s !== null) {
        if (p = e.getRenderTarget(), s.addEventListener("select", X), s.addEventListener("selectstart", X), s.addEventListener("selectend", X), s.addEventListener("squeeze", X), s.addEventListener("squeezestart", X), s.addEventListener("squeezeend", X), s.addEventListener("end", Q), s.addEventListener("inputsourceschange", ne), g.xrCompatible !== true && await t.makeXRCompatible(), w = e.getPixelRatio(), e.getSize(P), typeof XRWebGLBinding < "u" && "createProjectionLayer" in XRWebGLBinding.prototype) {
          ...
          g.depth && (Pe = g.stencil ? t.DEPTH24_STENCIL8 : t.DEPTH_COMPONENT24, we = g.stencil ? Xr : Wr, ge = g.stencil ? Gr : as);
          const ke = { colorFormat: t.RGBA8, depthFormat: Pe, scaleFactor: r };
          h = new XRWebGLBinding(s, t), f = h.createProjectionLayer(ke), s.updateRenderState({ layers: [f] }), e.setPixelRatio(1), e.setSize(f.textureWidth, f.textureHeight, false), E = new kn(f.textureWidth, f.textureHeight, { format: gn, type: Vn, depthTexture: new Rm(f.textureWidth, f.textureHeight, ge, void 0, void 0, void 0, void 0, void 0, void 0, we), stencilBuffer: g.stencil, colorSpace: e.outputColorSpace, samples: g.antialias ? 4 : 0, resolveDepthBuffer: f.ignoreDepthValues === false, resolveStencilBuffer: f.ignoreDepthValues === false });
        } else {
          const we = { antialias: g.antialias, alpha: true, depth: g.depth, stencil: g.stencil, framebufferScaleFactor: r };
          d = new XRWebGLLayer(s, t, we), s.updateRenderState({ baseLayer: d }), e.setPixelRatio(1), e.setSize(d.framebufferWidth, d.framebufferHeight, false), E = new kn(d.framebufferWidth, d.framebufferHeight, { format: gn, type: Vn, colorSpace: e.outputColorSpace, stencilBuffer: g.stencil, resolveDepthBuffer: d.ignoreDepthValues === false, resolveStencilBuffer: d.ignoreDepthValues === false });
        }
    ...
    const Ze = new Ym();
    Ze.setAnimationLoop(Oe), this.setAnimationLoop = function(ie) {
      be = ie;
    }, this.dispose = function() {
    };
  }
}
const Zi = new Ln(), _E = new Ye();
function xE(n, e) {
  function t(g, p) {
    ...
    for (let C = 0, I = b.length; C < I; C++) {
      ...
      for (let M = 0, L = S.length; M < L; M++) {
        ...
        for (let Q = 0, ne = X.length; Q < ne; Q++) {
          const Z = X[Q], se = _(Z), j = x % P, de = j % se.boundary, ve = j + de;
          x += de, ve !== 0 && P - ve < se.storage && (x += P - ve), O.__data = new Float32Array(se.storage / Float32Array.BYTES_PER_ELEMENT), O.__offset = x, x += se.storage;
        }
      }
    }
    const w = x % P;
...
class jA {
  constructor(e = {}) {
    ...
    let X = null;
    const Q = new Ue(0);
    let ne = 0, Z = t.width, se = t.height, j = 1, de = null, ve = null;
    const be = new it(0, 0, Z, se), Oe = new it(0, 0, Z, se);
    let Ze = false;
    const ie = new Bu();
    ...
    try {
      ...
      if ("setAttribute" in t && t.setAttribute("data-engine", `three.js r${Su}`), t.addEventListener("webglcontextlost", Re, false), t.addEventListener("webglcontextrestored", ue, false), t.addEventListener("webglcontextcreationerror", re, false), y === null) {
        const k = "webgl2";
    ...
    let F, H, z, J, G, q, ae, T, v, U, Y, te, K, xe, ce, ye, Te, oe, Ee, Ce, Le, me, Ge, B;
    function Me() {
      F = new Pb(y), F.init(), me = new fE(y, F), H = new bb(y, F, e, me), z = new uE(y, F), H.reverseDepthBuffer && f && z.buffers.depth.setReversed(true), J = new Db(y), G = new JT(), q = new hE(y, F, z, G, H, me, J), ae = new Eb(x), T = new Cb(x), v = new zy(y), Ge = new Mb(y, v), U = new Lb(y, v, J, Ge), Y = new Ub(y, U, v, J), Ee = new Nb(y, H, q), ye = new Tb(G), te = new ZT(x, ae, T, F, H, Ge, ye), K = new xE(x, G), xe = new $T(), ce = new rE(F), oe = new yb(x, ae, T, z, Y, d, l), Te = new lE(x, Y, H), B = new vE(y, J, H, z), Ce = new Sb(y, F, J), Le = new Ib(y, F, J), J.programs = te.programs, x.capabilities = H, x.extensions = F, x.properties = G, x.renderLists = xe, x.shadowMap = Te, x.state = z, x.info = J;
    }
    Me();
    const le = new gE(x, y);
    this.xr = le, this.getContext = function() {
      ...
      A.isVector4 ? Oe.set(A.x, A.y, A.z, A.w) : Oe.set(A, k, $, ee), z.scissor(O.copy(Oe).multiplyScalar(j).round());
      ...
      if (A) {
        ...
        if (W) {
          const he = I.texture.type, Se = he === Vn || he === as || he === kr || he === Gr || he === Eu || he === Au, De = oe.getClearColor(), Ae = oe.getClearAlpha(), He = De.r, Ve = De.g, Fe = De.b;
          Se ? (m[0] = He, m[1] = Ve, m[2] = Fe, m[3] = Ae, y.clearBufferuiv(y.COLOR, 0, m)) : (_[0] = He, _[1] = Ve, _[2] = Fe, _[3] = Ae, y.clearBufferiv(y.COLOR, 0, _));
      ...
      t.removeEventListener("webglcontextlost", Re, false), t.removeEventListener("webglcontextrestored", ue, false), t.removeEventListener("webglcontextcreationerror", re, false), oe.dispose(), xe.dispose(), ce.dispose(), G.dispose(), ae.dispose(), T.dispose(), Y.dispose(), Ge.dispose(), B.dispose(), te.dispose(), le.dispose(), le.removeEventListener("sessionstart", Qu), le.removeEventListener("sessionend", $u), Fi.stop();
    };
    function Re(A) {
    ...
    this.renderBufferDirect = function(A, k, $, ee, W, he) {
      ...
      const Ve = $.drawRange, Fe = $.attributes.position;
      let Qe = Ve.start * He, ct = (Ve.start + Ve.count) * He;
      he !== null && (Qe = Math.max(Qe, he.start * He), ct = Math.min(ct, (he.start + he.count) * He)), Ae !== null ? (Qe = Math.max(Qe, 0), ct = Math.min(ct, Ae.count)) : Fe != null && (Qe = Math.max(Qe, 0), ct = Math.min(ct, Fe.count));
      const bt = ct - Qe;
      if (bt < 0 || bt === 1 / 0) return;
      Ge.setup(W, ee, De, $, Ae);
      let gt, ht = Ce;
      if (Ae !== null && (gt = v.get(Ae), ht = Le, ht.setIndex(gt)), W.isMesh) ee.wireframe === true ? (z.setLineWidth(ee.wireframeLinewidth * D()), ht.setMode(y.LINES)) : ht.setMode(y.TRIANGLES);
      else if (W.isLine) {
        let Be = ee.linewidth;
        Be === void 0 && (Be = 1), z.setLineWidth(Be * D()), W.isLineSegments ? ht.setMode(y.LINES) : W.isLineLoop ? ht.setMode(y.LINE_LOOP) : ht.setMode(y.LINE_STRIP);
      } else W.isPoints ? ht.setMode(y.POINTS) : W.isSprite && ht.setMode(y.TRIANGLES);
      if (W.isBatchedMesh) if (W._multiDrawInstances !== null) Vs("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."), ht.renderMultiDrawInstances(W._multiDrawStarts, W._multiDrawCounts, W._multiDrawCount, W._multiDrawInstances);
      else if (F.get("WEBGL_multi_draw")) ht.renderMultiDraw(W._multiDrawStarts, W._multiDrawCounts, W._multiDrawCount);
      else {
        const Be = W._multiDrawStarts, vt = W._multiDrawCounts, tt = W._multiDrawCount, on = Ae ? v.get(Ae).bytesPerElement : 1, us = G.get(ee).currentProgram.getUniforms();
        for (let an = 0; an < tt; an++) us.setValue(y, "_gl_DrawID", an), ht.render(Be[an] / on, vt[an]);
      }
      else if (W.isInstancedMesh) ht.renderInstances(Qe, bt, W.count);
      else if ($.isInstancedBufferGeometry) {
        const Be = $._maxInstanceCount !== void 0 ? $._maxInstanceCount : 1 / 0, vt = Math.min($.instanceCount, Be);
        ht.renderInstances(Qe, bt, vt);
      } else ht.render(Qe, bt);
    };
    function ot(A, k, $) {
      A.transparent === true && A.side === Bn && A.forceSinglePass === false ? (A.side = sn, A.needsUpdate = true, oo(A, k, $), A.side = fi, A.needsUpdate = true, oo(A, k, $), A.side = Bn) : oo(A, k, $);
    }
    ...
    Fi.setAnimationLoop(Yn), typeof self < "u" && Fi.setContext(self), this.setAnimationLoop = function(A) {
      ...
      if (p.setupLights(), k.isArrayCamera) {
        ...
        for (let Se = 0, De = he.length; Se < De; Se++) {
          const Ae = he[Se];
          eh(g, A, Ae, Ae.viewport);
        }
      } else W.length > 0 && th(ee, W, A, k), R && oe.render(A), eh(g, A, k);
        ...
        if (A.isGroup) $ = A.renderOrder;
          ...
          if (ee && (A.boundingSphere !== void 0 ? (A.boundingSphere === null && A.computeBoundingSphere(), Ne.copy(A.boundingSphere.center)) : (Se.boundingSphere === null && Se.computeBoundingSphere(), Ne.copy(Se.boundingSphere.center)), Ne.applyMatrix4(A.matrixWorld).applyMatrix4(Pe)), Array.isArray(De)) {
            ...
            for (let He = 0, Ve = Ae.length; He < Ve; He++) {
              const Fe = Ae[He], Qe = De[Fe.materialIndex];
              Qe && Qe.visible && g.push(A, Se, Qe, $, Ne.z, Fe);
            }
          } else De.visible && g.push(A, Se, De, $, Ne.z, null);
        }
      }
      const he = A.children;
      for (let Se = 0, De = he.length; Se < De; Se++) Ha(he[Se], k, $, ee);
    }
    function eh(A, k, $, ee) {
      const W = A.opaque, he = A.transmissive, Se = A.transparent;
      p.setupLightsView($), pe === true && ye.setGlobalState(x.clippingPlanes, $), ee && z.viewport(L.copy(ee)), W.length > 0 && ro(W, k, $), he.length > 0 && ro(he, k, $), Se.length > 0 && ro(Se, k, $), z.buffers.depth.setTest(true), z.buffers.depth.setMask(true), z.buffers.color.setMask(true), z.setPolygonOffset(false);
    }
    function th(A, k, $, ee) {
      ...
      const De = x.getRenderTarget(), Ae = x.getActiveCubeFace(), He = x.getActiveMipmapLevel();
      ...
      if (ee.viewport !== void 0 && (ee.viewport = void 0), p.setupLightsView(ee), pe === true && ye.setGlobalState(x.clippingPlanes, ee), ro(A, $, ee), q.updateMultisampleRenderTarget(he), q.updateRenderTargetMipmap(he), F.has("WEBGL_multisampled_render_to_texture") === false) {
        let Qe = false;
        for (let ct = 0, bt = k.length; ct < bt; ct++) {
          const gt = k[ct], ht = gt.object, Be = gt.geometry, vt = gt.material, tt = gt.group;
          if (vt.side === Bn && ht.layers.test(ee.layers)) {
            const on = vt.side;
            vt.side = sn, vt.needsUpdate = true, nh(ht, $, ee, Be, vt, tt), vt.side = on, vt.needsUpdate = true, Qe = true;
          }
        }
        Qe === true && (q.updateMultisampleRenderTarget(he), q.updateRenderTargetMipmap(he));
      }
      x.setRenderTarget(De, Ae, He), x.setClearColor(Q, ne), Fe !== void 0 && (ee.viewport = Fe), x.toneMapping = Ve;
    }
    function ro(A, k, $) {
      ...
      for (let W = 0, he = A.length; W < he; W++) {
        ...
        let Ve = Se.material;
        Ve.allowOverride === true && ee !== null && (Ve = ee), De.layers.test($.layers) && nh(De, k, $, Ae, Ve, He);
      }
    }
    function nh(A, k, $, ee, W, he) {
      A.onBeforeRender(x, k, $, ee, W, he), A.modelViewMatrix.multiplyMatrices($.matrixWorldInverse, A.matrixWorld), A.normalMatrix.getNormalMatrix(A.modelViewMatrix), W.onBeforeRender(x, k, $, ee, A, he), W.transparent === true && W.side === Bn && W.forceSinglePass === false ? (W.side = sn, W.needsUpdate = true, x.renderBufferDirect($, k, ee, W, A, he), W.side = fi, W.needsUpdate = true, x.renderBufferDirect($, k, ee, W, A, he), W.side = Bn) : x.renderBufferDirect($, k, ee, W, A, he), A.onAfterRender(x, k, $, ee, W, he);
    }
    function oo(A, k, $) {
      k.isScene !== true && (k = dt);
      ...
      let Ve = He.get(Ae);
      if (Ve !== void 0) {
        if (ee.currentProgram === Ve && ee.lightsStateVersion === Se) return sh(A, De), Ve;
    ...
    function eg(A, k, $, ee, W) {
      ...
      const he = k.fog, Se = ee.isMeshStandardMaterial ? k.environment : null, De = I === null ? x.outputColorSpace : I.isXRRenderTarget === true ? I.texture.colorSpace : Jt, Ae = (ee.isMeshStandardMaterial ? T : ae).get(ee.envMap || Se), He = ee.vertexColors === true && !!$.attributes.color && $.attributes.color.itemSize === 4, Ve = !!$.attributes.tangent && (!!ee.normalMap || ee.anisotropy > 0), Fe = !!$.morphAttributes.position, Qe = !!$.morphAttributes.normal, ct = !!$.morphAttributes.color;
      let bt = Li;
      ee.toneMapped && (I === null || I.isXRRenderTarget === true) && (bt = x.toneMapping);
      const gt = $.morphAttributes.position || $.morphAttributes.normal || $.morphAttributes.color, ht = gt !== void 0 ? gt.length : 0, Be = G.get(ee), vt = p.state.lights;
      if (pe === true && (we === true || A !== M)) {
        const Wt = A === M && ee.id === S;
        ye.setState(ee, A, Wt);
      }
      let tt = false;
      ee.version === Be.__version ? (Be.needsLights && Be.lightsStateVersion !== vt.state.version || Be.outputColorSpace !== De || W.isBatchedMesh && Be.batching === false || !W.isBatchedMesh && Be.batching === true || W.isBatchedMesh && Be.batchingColor === true && W.colorTexture === null || W.isBatchedMesh && Be.batchingColor === false && W.colorTexture !== null || W.isInstancedMesh && Be.instancing === false || !W.isInstancedMesh && Be.instancing === true || W.isSkinnedMesh && Be.skinning === false || !W.isSkinnedMesh && Be.skinning === true || W.isInstancedMesh && Be.instancingColor === true && W.instanceColor === null || W.isInstancedMesh && Be.instancingColor === false && W.instanceColor !== null || W.isInstancedMesh && Be.instancingMorph === true && W.morphTexture === null || W.isInstancedMesh && Be.instancingMorph === false && W.morphTexture !== null || Be.envMap !== Ae || ee.fog === true && Be.fog !== he || Be.numClippingPlanes !== void 0 && (Be.numClippingPlanes !== ye.numPlanes || Be.numIntersection !== ye.numIntersection) || Be.vertexAlphas !== He || Be.vertexTangents !== Ve || Be.morphTargets !== Fe || Be.morphNormals !== Qe || Be.morphColors !== ct || Be.toneMapping !== bt || Be.morphTargetsCount !== ht) && (tt = true) : (tt = true, Be.__version = ee.version);
      let on = Be.currentProgram;
      tt === true && (on = oo(ee, k, W));
      let us = false, an = false, or = false;
      const xt = on.getUniforms(), hn = Be.uniforms;
      if (z.useProgram(on.program) && (us = true, an = true, or = true), ee.id !== S && (S = ee.id, an = true), us || M !== A) {
        z.buffers.depth.getReversed() ? (ge.copy(A.projectionMatrix), Hv(ge), Vv(ge), xt.setValue(y, "projectionMatrix", ge)) : xt.setValue(y, "projectionMatrix", A.projectionMatrix), xt.setValue(y, "viewMatrix", A.matrixWorldInverse);
        const Qt = xt.map.cameraPosition;
        Qt !== void 0 && Qt.setValue(y, ke.setFromMatrixPosition(A.matrixWorld)), H.logarithmicDepthBuffer && xt.setValue(y, "logDepthBufFC", 2 / (Math.log(A.far + 1) / Math.LN2)), (ee.isMeshPhongMaterial || ee.isMeshToonMaterial || ee.isMeshLambertMaterial || ee.isMeshBasicMaterial || ee.isMeshStandardMaterial || ee.isShaderMaterial) && xt.setValue(y, "isOrthographic", A.isOrthographicCamera === true), M !== A && (M = A, an = true, or = true);
      }
      if (W.isSkinnedMesh) {
        xt.setOptional(y, W, "bindMatrix"), xt.setOptional(y, W, "bindMatrixInverse");
        const Wt = W.skeleton;
        Wt && (Wt.boneTexture === null && Wt.computeBoneTexture(), xt.setValue(y, "boneTexture", Wt.boneTexture, q));
      }
      W.isBatchedMesh && (xt.setOptional(y, W, "batchingTexture"), xt.setValue(y, "batchingTexture", W._matricesTexture, q), xt.setOptional(y, W, "batchingIdTexture"), xt.setValue(y, "batchingIdTexture", W._indirectTexture, q), xt.setOptional(y, W, "batchingColorTexture"), W._colorsTexture !== null && xt.setValue(y, "batchingColorTexture", W._colorsTexture, q));
      const fn = $.morphAttributes;
      if ((fn.position !== void 0 || fn.normal !== void 0 || fn.color !== void 0) && Ee.update(W, $, on), (an || Be.receiveShadow !== W.receiveShadow) && (Be.receiveShadow = W.receiveShadow, xt.setValue(y, "receiveShadow", W.receiveShadow)), ee.isMeshGouraudMaterial && ee.envMap !== null && (hn.envMap.value = Ae, hn.flipEnvMap.value = Ae.isCubeTexture && Ae.isRenderTargetTexture === false ? -1 : 1), ee.isMeshStandardMaterial && ee.envMap === null && k.environment !== null && (hn.envMapIntensity.value = k.environmentIntensity), an && (xt.setValue(y, "toneMappingExposure", x.toneMappingExposure), Be.needsLights && tg(hn, or), he && ee.fog === true && K.refreshFogUniforms(hn, he), K.refreshMaterialUniforms(hn, ee, j, se, p.state.transmissionRenderTarget[A.id]), aa.upload(y, ih(Be), hn, q)), ee.isShaderMaterial && ee.uniformsNeedUpdate === true && (aa.upload(y, ih(Be), hn, q), ee.uniformsNeedUpdate = false), ee.isSpriteMaterial && xt.setValue(y, "center", W.center), xt.setValue(y, "modelViewMatrix", W.modelViewMatrix), xt.setValue(y, "normalMatrix", W.normalMatrix), xt.setValue(y, "modelMatrix", W.matrixWorld), ee.isShaderMaterial || ee.isRawShaderMaterial) {
        const Wt = ee.uniformsGroups;
        for (let Qt = 0, Va = Wt.length; Qt < Va; Qt++) {
          const Bi = Wt[Qt];
          B.update(Bi, on), B.bind(Bi, on);
        }
      }
      return on;
    }
    ...
    this.setRenderTarget = function(A, k = 0, $ = 0) {
      ...
      if (A) {
        ...
        if (Ae.__useDefaultFramebuffer !== void 0) z.bindFramebuffer(y.FRAMEBUFFER, null), ee = false;
          ...
          if (Ae.__boundDepthTexture !== Fe) {
            if (Fe !== null && G.has(Fe) && (A.width !== Fe.image.width || A.height !== Fe.image.height)) throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");
      ...
      } else L.copy(be).multiplyScalar(j).floor(), O.copy(Oe).multiplyScalar(j).floor(), X = Ze;
      ...
      if (A.isWebGLCubeRenderTarget && Se !== void 0 && (Ae = Ae[Se]), Ae) {
        ...
        try {
          const He = A.textures[De], Ve = He.format, Fe = He.type;
          if (!H.textureFormatReadable(Ve)) {
            console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");
            return;
          }
          if (!H.textureTypeReadable(Fe)) {
            console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");
            return;
          }
          k >= 0 && k <= A.width - ee && $ >= 0 && $ <= A.height - W && (A.textures.length > 1 && y.readBuffer(y.COLOR_ATTACHMENT0 + De), y.readPixels(k, $, ee, W, me.convert(Ve), me.convert(Fe), he));
        } finally {
      ...
      if (A.isWebGLCubeRenderTarget && Se !== void 0 && (Ae = Ae[Se]), Ae) if (k >= 0 && k <= A.width - ee && $ >= 0 && $ <= A.height - W) {
        ...
        if (!H.textureTypeReadable(Fe)) throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");
        const Qe = y.createBuffer();
        y.bindBuffer(y.PIXEL_PACK_BUFFER, Qe), y.bufferData(y.PIXEL_PACK_BUFFER, he.byteLength, y.STREAM_READ), A.textures.length > 1 && y.readBuffer(y.COLOR_ATTACHMENT0 + De), y.readPixels(k, $, ee, W, me.convert(Ve), me.convert(Fe), 0);
        const ct = I !== null ? G.get(I).__webglFramebuffer : null;
        z.bindFramebuffer(y.FRAMEBUFFER, ct);
        const bt = y.fenceSync(y.SYNC_GPU_COMMANDS_COMPLETE, 0);
        return y.flush(), await zv(y, bt, 4), y.bindBuffer(y.PIXEL_PACK_BUFFER, Qe), y.getBufferSubData(y.PIXEL_PACK_BUFFER, 0, he), y.deleteBuffer(Qe), y.deleteSync(bt), he;
    ...
    this.copyTextureToTexture = function(A, k, $ = null, ee = null, W = 0, he = null) {
      he === null && (W !== 0 ? (Vs("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."), he = W, W = 0) : he = 0);
      let Se, De, Ae, He, Ve, Fe, Qe, ct, bt;
      const gt = A.isCompressedTexture ? A.mipmaps[he] : A.image;
      if ($ !== null) Se = $.max.x - $.min.x, De = $.max.y - $.min.y, Ae = $.isBox3 ? $.max.z - $.min.z : 1, He = $.min.x, Ve = $.min.y, Fe = $.isBox3 ? $.min.z : 0;
      else {
        const fn = Math.pow(2, -W);
        Se = Math.floor(gt.width * fn), De = Math.floor(gt.height * fn), A.isDataArrayTexture ? Ae = gt.depth : A.isData3DTexture ? Ae = Math.floor(gt.depth * fn) : Ae = 1, He = 0, Ve = 0, Fe = 0;
      }
      ee !== null ? (Qe = ee.x, ct = ee.y, bt = ee.z) : (Qe = 0, ct = 0, bt = 0);
      const ht = me.convert(k.format), Be = me.convert(k.type);
      let vt;
      k.isData3DTexture ? (q.setTexture3D(k, 0), vt = y.TEXTURE_3D) : k.isDataArrayTexture || k.isCompressedArrayTexture ? (q.setTexture2DArray(k, 0), vt = y.TEXTURE_2D_ARRAY) : (q.setTexture2D(k, 0), vt = y.TEXTURE_2D), y.pixelStorei(y.UNPACK_FLIP_Y_WEBGL, k.flipY), y.pixelStorei(y.UNPACK_PREMULTIPLY_ALPHA_WEBGL, k.premultiplyAlpha), y.pixelStorei(y.UNPACK_ALIGNMENT, k.unpackAlignment);
      const tt = y.getParameter(y.UNPACK_ROW_LENGTH), on = y.getParameter(y.UNPACK_IMAGE_HEIGHT), us = y.getParameter(y.UNPACK_SKIP_PIXELS), an = y.getParameter(y.UNPACK_SKIP_ROWS), or = y.getParameter(y.UNPACK_SKIP_IMAGES);
      y.pixelStorei(y.UNPACK_ROW_LENGTH, gt.width), y.pixelStorei(y.UNPACK_IMAGE_HEIGHT, gt.height), y.pixelStorei(y.UNPACK_SKIP_PIXELS, He), y.pixelStorei(y.UNPACK_SKIP_ROWS, Ve), y.pixelStorei(y.UNPACK_SKIP_IMAGES, Fe);
      const xt = A.isDataArrayTexture || A.isData3DTexture, hn = k.isDataArrayTexture || k.isData3DTexture;
      if (A.isDepthTexture) {
        const fn = G.get(A), Wt = G.get(k), Qt = G.get(fn.__renderTarget), Va = G.get(Wt.__renderTarget);
        z.bindFramebuffer(y.READ_FRAMEBUFFER, Qt.__webglFramebuffer), z.bindFramebuffer(y.DRAW_FRAMEBUFFER, Va.__webglFramebuffer);
        for (let Bi = 0; Bi < Ae; Bi++) xt && (y.framebufferTextureLayer(y.READ_FRAMEBUFFER, y.COLOR_ATTACHMENT0, G.get(A).__webglTexture, W, Fe + Bi), y.framebufferTextureLayer(y.DRAW_FRAMEBUFFER, y.COLOR_ATTACHMENT0, G.get(k).__webglTexture, he, bt + Bi)), y.blitFramebuffer(He, Ve, Se, De, Qe, ct, Se, De, y.DEPTH_BUFFER_BIT, y.NEAREST);
        ...
        const fn = G.get(A), Wt = G.get(k);
        z.bindFramebuffer(y.READ_FRAMEBUFFER, sg), z.bindFramebuffer(y.DRAW_FRAMEBUFFER, rg);
        for (let Qt = 0; Qt < Ae; Qt++) xt ? y.framebufferTextureLayer(y.READ_FRAMEBUFFER, y.COLOR_ATTACHMENT0, fn.__webglTexture, W, Fe + Qt) : y.framebufferTexture2D(y.READ_FRAMEBUFFER, y.COLOR_ATTACHMENT0, y.TEXTURE_2D, fn.__webglTexture, W), hn ? y.framebufferTextureLayer(y.DRAW_FRAMEBUFFER, y.COLOR_ATTACHMENT0, Wt.__webglTexture, he, bt + Qt) : y.framebufferTexture2D(y.DRAW_FRAMEBUFFER, y.COLOR_ATTACHMENT0, y.TEXTURE_2D, Wt.__webglTexture, he), W !== 0 ? y.blitFramebuffer(He, Ve, Se, De, Qe, ct, Se, De, y.COLOR_BUFFER_BIT, y.NEAREST) : hn ? y.copyTexSubImage3D(vt, he, Qe, ct, bt + Qt, He, Ve, Se, De) : y.copyTexSubImage2D(vt, he, Qe, ct, He, Ve, Se, De);
        z.bindFramebuffer(y.READ_FRAMEBUFFER, null), z.bindFramebuffer(y.DRAW_FRAMEBUFFER, null);
      } else hn ? A.isDataTexture || A.isData3DTexture ? y.texSubImage3D(vt, he, Qe, ct, bt, Se, De, Ae, ht, Be, gt.data) : k.isCompressedArrayTexture ? y.compressedTexSubImage3D(vt, he, Qe, ct, bt, Se, De, Ae, ht, gt.data) : y.texSubImage3D(vt, he, Qe, ct, bt, Se, De, Ae, ht, Be, gt) : A.isDataTexture ? y.texSubImage2D(y.TEXTURE_2D, he, Qe, ct, Se, De, ht, Be, gt.data) : A.isCompressedTexture ? y.compressedTexSubImage2D(y.TEXTURE_2D, he, Qe, ct, gt.width, gt.height, ht, gt.data) : y.texSubImage2D(y.TEXTURE_2D, he, Qe, ct, Se, De, ht, Be, gt);
      y.pixelStorei(y.UNPACK_ROW_LENGTH, tt), y.pixelStorei(y.UNPACK_IMAGE_HEIGHT, on), y.pixelStorei(y.UNPACK_SKIP_PIXELS, us), y.pixelStorei(y.UNPACK_SKIP_ROWS, an), y.pixelStorei(y.UNPACK_SKIP_IMAGES, or), he === 0 && k.generateMipmaps && y.generateMipmap(vt), z.unbindTexture();
    }, this.copyTextureToTexture3D = function(A, k, $ = null, ee = null, W = 0) {
      return Vs('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'), this.copyTextureToTexture(A, k, $, ee, W);
...
const KA = (n, e) => {
  ...
  return t;
}, yE = { name: "CopyShader", uniforms: { tDiffuse: { value: null }, opacity: { value: 1 } }, vertexShader: `
...
class Ju {
  constructor(e) {
    this._mesh = new kt(bE, e);
  }
  dispose() {
    this._mesh.geometry.dispose();
  }
  render(e) {
    e.render(this._mesh, ME);
  }
  get material() {
...
class ZA {
  constructor(e, t) {
    ...
    this.renderTarget1 = t, this.renderTarget2 = t.clone(), this.renderTarget2.texture.name = "EffectComposer.rt2", this.writeBuffer = this.renderTarget1, this.readBuffer = this.renderTarget2, this.renderToScreen = true, this.passes = [], this.copyPass = new TE(yE), this.copyPass.material.blending = li, this.clock = new Xm();
  }
  swapBuffers() {
  ...
  render(e) {
    ...
    for (let s = 0, r = this.passes.length; s < r; s++) {
      ...
      if (o.enabled !== false) {
        ...
        xd !== void 0 && (o instanceof xd ? i = true : o instanceof EE && (i = false));
      }
    }
...
const qo = { name: "OutputShader", uniforms: { tDiffuse: { value: null }, toneMappingExposure: { value: 1 } }, vertexShader: `
...
class QA extends rr {
  constructor() {
    super(), this.uniforms = Gs.clone(qo.uniforms), this.material = new ty({ name: qo.name, uniforms: this.uniforms, vertexShader: qo.vertexShader, fragmentShader: qo.fragmentShader }), this._fsQuad = new Ju(this.material), this._outputColorSpace = null, this._toneMapping = null;
  }
  render(e, t, i) {
...
const jo = { defines: { SMAA_THRESHOLD: "0.1" }, uniforms: { tDiffuse: { value: null }, resolution: { value: new fe(1 / 1024, 1 / 512) } }, vertexShader: `
		...
		}` }, Ko = { defines: { SMAA_MAX_SEARCH_STEPS: "8", SMAA_AREATEX_MAX_DISTANCE: "16", SMAA_AREATEX_PIXEL_SIZE: "( 1.0 / vec2( 160.0, 560.0 ) )", SMAA_AREATEX_SUBTEX_SIZE: "( 1.0 / 7.0 )" }, uniforms: { tDiffuse: { value: null }, tArea: { value: null }, tSearch: { value: null }, resolution: { value: new fe(1 / 1024, 1 / 512) } }, vertexShader: `
		...
		}` }, Vl = { uniforms: { tDiffuse: { value: null }, tColor: { value: null }, resolution: { value: new fe(1 / 1024, 1 / 512) } }, vertexShader: `
...
class $A extends rr {
  constructor() {
    ...
    }, this._searchTexture = new wt(), this._searchTexture.name = "SMAAPass.search", this._searchTexture.image = i, this._searchTexture.magFilter = Ot, this._searchTexture.minFilter = Ot, this._searchTexture.generateMipmaps = false, this._searchTexture.flipY = false, this._uniformsEdges = Gs.clone(jo.uniforms), this._materialEdges = new rn({ defines: Object.assign({}, jo.defines), uniforms: this._uniformsEdges, vertexShader: jo.vertexShader, fragmentShader: jo.fragmentShader }), this._uniformsWeights = Gs.clone(Ko.uniforms), this._uniformsWeights.tDiffuse.value = this._edgesRT.texture, this._uniformsWeights.tArea.value = this._areaTexture, this._uniformsWeights.tSearch.value = this._searchTexture, this._materialWeights = new rn({ defines: Object.assign({}, Ko.defines), uniforms: this._uniformsWeights, vertexShader: Ko.vertexShader, fragmentShader: Ko.fragmentShader }), this._uniformsBlend = Gs.clone(Vl.uniforms), this._uniformsBlend.tDiffuse.value = this._weightsRT.texture, this._materialBlend = new rn({ uniforms: this._uniformsBlend, vertexShader: Vl.vertexShader, fragmentShader: Vl.fragmentShader }), this._fsQuad = new Ju(null);
  }
  render(e, t, i) {
...
function yd(n, e) {
  ...
  if (e === Wc || e === dm) {
    ...
    const i = t.count - 2, s = [];
    if (e === Wc) for (let o = 1; o <= i; o++) s.push(t.getX(0)), s.push(t.getX(o)), s.push(t.getX(o + 1));
...
class tw extends cs {
  ...
  load(e, t, i, s) {
    ...
    if (this.resourcePath !== "") o = this.resourcePath;
      ...
      const c = Nr.extractUrlBase(e);
      o = Nr.resolveURL(c, this.path);
    } else o = Nr.extractUrlBase(e);
    this.manager.itemStart(e);
    const a = function(c) {
  ...
  parse(e, t, i, s) {
    ...
    const c = new sA(r, { path: t || this.resourcePath || "", crossOrigin: this.crossOrigin, requestHeader: this.requestHeader, manager: this.manager, ktx2Loader: this.ktx2Loader, meshoptDecoder: this.meshoptDecoder });
...
class wE {
  ...
  _loadLight(e) {
    ...
    switch (l.type) {
      case "directional":
        c = new My(u), c.target.position.set(0, 0, -1), c.add(c.target);
        break;
      case "point":
        c = new vy(u), c.distance = h;
        break;
      case "spot":
        c = new _y(u), c.distance = h, l.spot = l.spot || {}, l.spot.innerConeAngle = l.spot.innerConeAngle !== void 0 ? l.spot.innerConeAngle : 0, l.spot.outerConeAngle = l.spot.outerConeAngle !== void 0 ? l.spot.outerConeAngle : Math.PI / 4, c.angle = l.spot.outerConeAngle, c.penumbra = 1 - l.spot.innerConeAngle / l.spot.outerConeAngle, c.target.position.set(0, 0, -1), c.add(c.target);
        break;
      default:
...
class WE {
  ...
  createNodeMesh(e) {
    ...
    return a.length < 1 ? null : (a.push(this.parser.createNodeMesh(e)), Promise.all(a).then((c) => {
      ...
      for (const m of h) {
        const _ = new Ye(), g = new N(), p = new vn(), E = new N(1, 1, 1), b = new m0(m.geometry, m.material, f);
        ...
        for (const x in l) if (x === "_COLOR_0") {
          const P = l[x];
          b.instanceColor = new Yc(P.array, P.itemSize, P.normalized);
...
const Jm = "glTF", xr = 12, Md = { JSON: 1313821514, BIN: 5130562 };
class XE {
  constructor(e) {
    this.name = Je.KHR_BINARY_GLTF, this.content = null, this.body = null;
    const t = new DataView(e, 0, xr), i = new TextDecoder();
    ...
    const s = this.header.length - xr, r = new DataView(e, xr);
    let o = 0;
    for (; o < s; ) {
      ...
      if (o += 4, l === Md.JSON) {
        const c = new Uint8Array(e, xr + o, a);
...
class YE {
  ...
  decodePrimitive(e, t) {
    ...
    for (const u in e.attributes) {
      const h = eu[u] || u.toLowerCase();
      if (o[u] !== void 0) {
        const f = i.accessors[e.attributes[u]], d = Ws[f.componentType];
...
class ZE extends Qm {
  interpolate_(e, t, i, s) {
    ...
    return KE.fromArray(r).normalize().toArray(r), r;
  }
}
const mn = { POINTS: 0, LINES: 1, LINE_LOOP: 2, LINE_STRIP: 3, TRIANGLES: 4, TRIANGLE_STRIP: 5, TRIANGLE_FAN: 6 }, Ws = { 5120: Int8Array, 5121: Uint8Array, 5122: Int16Array, 5123: Uint16Array, 5125: Uint32Array, 5126: Float32Array }, Sd = { 9728: Ot, 9729: nn, 9984: rm, 9985: ta, 9986: yr, 9987: ri }, bd = { 33071: Ci, 33648: ga, 10497: Ks }, kl = { SCALAR: 1, VEC2: 2, VEC3: 3, VEC4: 4, MAT2: 4, MAT3: 9, MAT4: 16 }, eu = { POSITION: "position", NORMAL: "normal", TANGENT: "tangent", TEXCOORD_0: "uv", TEXCOORD_1: "uv1", TEXCOORD_2: "uv2", TEXCOORD_3: "uv3", COLOR_0: "color", WEIGHTS_0: "skinWeight", JOINTS_0: "skinIndex" }, bi = { scale: "scale", translation: "position", rotation: "quaternion", weights: "morphTargetInfluences" }, JE = { CUBICSPLINE: void 0, LINEAR: qr, STEP: Yr }, Gl = { OPAQUE: "OPAQUE", MASK: "MASK", BLEND: "BLEND" };
function QE(n) {
  return n.DefaultMaterial === void 0 && (n.DefaultMaterial = new Xu({ color: 16777215, emissive: 0, metalness: 1, roughness: 1, transparent: false, depthTest: true, side: fi })), n.DefaultMaterial;
}
function Ji(n, e, t) {
...
function tA(n) {
  ...
  if (t ? e = "draco:" + t.bufferView + ":" + t.indices + ":" + Wl(t.attributes) : e = n.indices + ":" + Wl(n.attributes) + ":" + n.mode, n.targets !== void 0) for (let i = 0, s = n.targets.length; i < s; i++) e += ":" + Wl(n.targets[i]);
  return e;
}
function Wl(n) {
  let e = "";
...
class sA {
  constructor(e = {}, t = {}) {
    this.json = e, this.extensions = {}, this.plugins = {}, this.options = t, this.cache = new AE(), this.associations = /* @__PURE__ */ new Map(), this.primitiveCache = {}, this.nodeCache = {}, this.meshCache = { refs: {}, uses: {} }, this.cameraCache = { refs: {}, uses: {} }, this.lightCache = { refs: {}, uses: {} }, this.sourceCache = {}, this.textureCache = {}, this.nodeNamesUsed = {};
    ...
    typeof createImageBitmap > "u" || i && s < 17 || r && o < 98 ? this.textureLoader = new my(this.options.manager) : this.textureLoader = new Sy(this.options.manager), this.textureLoader.setCrossOrigin(this.options.crossOrigin), this.textureLoader.setRequestHeader(this.options.requestHeader), this.fileLoader = new Yu(this.options.manager), this.fileLoader.setResponseType("arraybuffer"), this.options.crossOrigin === "use-credentials" && this.fileLoader.setWithCredentials(true);
  }
  setExtensions(e) {
    this.extensions = e;
  }
  ...
  loadBuffer(e) {
    ...
    return new Promise(function(r, o) {
      i.load(Nr.resolveURL(t.uri, s.path), r, void 0, function() {
  ...
  loadAccessor(e) {
    ...
    if (s.bufferView === void 0 && s.sparse === void 0) {
      const o = kl[s.type], a = Ws[s.componentType], l = s.normalized === true, c = new a(s.count * o);
    ...
    return s.bufferView !== void 0 ? r.push(this.getDependency("bufferView", s.bufferView)) : r.push(null), s.sparse !== void 0 && (r.push(this.getDependency("bufferView", s.sparse.indices.bufferView)), r.push(this.getDependency("bufferView", s.sparse.values.bufferView))), Promise.all(r).then(function(o) {
      const a = o[0], l = kl[s.type], c = Ws[s.componentType], u = c.BYTES_PER_ELEMENT, h = u * l, f = s.byteOffset || 0, d = s.bufferView !== void 0 ? i.bufferViews[s.bufferView].byteStride : void 0, m = s.normalized === true;
      let _, g;
      if (d && d !== h) {
        const p = Math.floor(f / d), E = "InterleavedBuffer:" + s.bufferView + ":" + s.componentType + ":" + p + ":" + s.count;
        let b = t.cache.get(E);
        b || (_ = new c(a, p * d, s.count * d / u), b = new bm(_, d / u), t.cache.add(E, b)), g = new Ou(b, l, f % d / u, m);
      } else a === null ? _ = new c(s.count * l) : _ = new c(a, f, s.count * l), g = new Ft(_, l, m);
      if (s.sparse !== void 0) {
        const p = kl.SCALAR, E = Ws[s.sparse.indices.componentType], b = s.sparse.indices.byteOffset || 0, x = s.sparse.values.byteOffset || 0, P = new E(o[1], b, s.sparse.count * p), w = new c(o[2], x, s.sparse.count * l);
  ...
  loadTextureImage(e, t, i) {
    ...
    const c = this.loadImageSource(t, i).then(function(u) {
      ...
      return u.magFilter = Sd[f.magFilter] || nn, u.minFilter = Sd[f.minFilter] || ri, u.wrapS = bd[f.wrapS] || Ks, u.wrapT = bd[f.wrapT] || Ks, u.generateMipmaps = !u.isCompressedTexture && u.minFilter !== Ot && u.minFilter !== nn, s.associations.set(u, { textures: e }), u;
    }).catch(function() {
      return null;
    });
  ...
  loadImageSource(e, t) {
    ...
    const u = Promise.resolve(l).then(function(h) {
      return new Promise(function(f, d) {
        ...
        }), t.load(Nr.resolveURL(h, r.path), m, void 0, d);
      });
    }).then(function(h) {
      return c === true && a.revokeObjectURL(l), ni(h, o), h.userData.mimeType = o.mimeType || nA(o.uri), h;
    }).catch(function(h) {
  ...
  assignFinalMaterial(e) {
    ...
    if (e.isPoints) {
      ...
      l || (l = new wm(), yn.prototype.copy.call(l, i), l.color.copy(i.color), l.map = i.map, l.sizeAttenuation = false, this.cache.add(a, l)), i = l;
    } else if (e.isLine) {
      const a = "LineBasicMaterial:" + i.uuid;
      let l = this.cache.get(a);
      l || (l = new Oa(), yn.prototype.copy.call(l, i), l.color.copy(i.color), l.map = i.map, this.cache.add(a, l)), i = l;
    }
    if (s || r || o) {
  ...
  loadMaterial(e) {
    ...
    const u = r.alphaMode || Gl.OPAQUE;
    if (u === Gl.BLEND ? (a.transparent = true, a.depthWrite = false) : (a.transparent = false, u === Gl.MASK && (a.alphaTest = r.alphaCutoff !== void 0 ? r.alphaCutoff : 0.5)), r.normalTexture !== void 0 && o !== oi && (c.push(t.assignTexture(a, "normalMap", r.normalTexture)), a.normalScale = new fe(1, 1), r.normalTexture.scale !== void 0)) {
  ...
  loadGeometries(e) {
    ...
    const o = [];
    for (let a = 0, l = e.length; a < l; a++) {
      const c = e[a], u = tA(c), h = s[u];
      if (h) o.push(h.promise);
      else {
        let f;
        c.extensions && c.extensions[Je.KHR_DRACO_MESH_COMPRESSION] ? f = r(c) : f = Td(new St(), c, t), s[u] = { primitive: c, promise: f }, o.push(f);
      }
    }
  ...
  loadMesh(e) {
    ...
    for (let l = 0, c = o.length; l < c; l++) {
      const u = o[l].material === void 0 ? QE(this.cache) : this.getDependency("material", o[l].material);
      a.push(u);
    }
    return a.push(t.loadGeometries(o)), Promise.all(a).then(function(l) {
      ...
      for (let d = 0, m = u.length; d < m; d++) {
        ...
        let p;
        const E = c[d];
        if (g.mode === mn.TRIANGLES || g.mode === mn.TRIANGLE_STRIP || g.mode === mn.TRIANGLE_FAN || g.mode === void 0) p = r.isSkinnedMesh === true ? new f0(_, E) : new kt(_, E), p.isSkinnedMesh === true && p.normalizeSkinWeights(), g.mode === mn.TRIANGLE_STRIP ? p.geometry = yd(p.geometry, dm) : g.mode === mn.TRIANGLE_FAN && (p.geometry = yd(p.geometry, Wc));
        else if (g.mode === mn.LINES) p = new Am(_, E);
        else if (g.mode === mn.LINE_STRIP) p = new Kr(_, E);
        else if (g.mode === mn.LINE_LOOP) p = new v0(_, E);
        else if (g.mode === mn.POINTS) p = new y0(_, E);
        else throw new Error("THREE.GLTFLoader: Primitive mode unsupported: " + g.mode);
        Object.keys(p.geometry.morphAttributes).length > 0 && eA(p, r), p.name = t.createUniqueName(r.name || "mesh_" + e), ni(p, r), g.extensions && Ji(s, p, g), t.assignFinalMaterial(p), h.push(p);
      }
  ...
  loadCamera(e) {
    ...
    return i.type === "perspective" ? t = new tn(Fv.radToDeg(s.yfov), s.aspectRatio || 1, s.znear || 1, s.zfar || 2e6) : i.type === "orthographic" && (t = new Ba(-s.xmag, s.xmag, s.ymag, -s.ymag, s.znear, s.zfar)), i.name && (t.name = this.createUniqueName(i.name)), ni(t, i), Promise.resolve(t);
  }
  loadSkin(e) {
  ...
  _loadNodeShallow(e) {
    ...
    return l && a.push(l), r.camera !== void 0 && a.push(s.getDependency("camera", r.camera).then(function(c) {
      ...
      let u;
      if (r.isBone === true ? u = new Tm() : c.length > 1 ? u = new ss() : c.length === 1 ? u = c[0] : u = new ut(), u !== c[0]) for (let h = 0, f = c.length; h < f; h++) u.add(c[h]);
  ...
  _createAnimationTracks(e, t, i, s, r) {
    ...
    const u = s.interpolation !== void 0 ? JE[s.interpolation] : qr, h = this._getArrayFromAccessor(i);
  ...
  _getArrayFromAccessor(e) {
    let t = e.array;
    if (e.normalized) {
      const i = tu(t.constructor), s = new Float32Array(t.length);
  ...
  _createCubicSplineTrackInterpolant(e) {
    e.createInterpolant = function(i) {
      const s = this instanceof er ? ZE : Qm;
...
function Td(n, e, t) {
  ...
  return $e.workingColorSpace !== Jt && "COLOR_0" in i && console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${$e.workingColorSpace}" not supported.`), ni(n, e), rA(n, e, t), Promise.all(s).then(function() {
    return e.targets !== void 0 ? $E(n, e.targets, t) : n;
  });
}
function nw(n) {
