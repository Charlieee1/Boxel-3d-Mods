import { _ as F, c as i, a as t, r as E, o as l, n as fe, b as j, w, d as y, u as m, T as ee, e as k, f as g, g as Y, h, t as b, i as oe, F as V, j as te, v as _e, k as le, l as ge, m as se, p as we, s as be, q as ke, x as he, y as ye, z as ae, A as $e } from "./SkeletonUtils-CPE3ZpxV.js";
import { A as xe, L as Ie, I as Ce, G as Se, a as Fe } from "./AssetLoader-B-yKI2c4.js";
import { U as N, A as Ae, u as ie, S as Le, i as je } from "./i18n-GjvcIrVO.js";
const Ee = { class: "banner" }, Be = { class: "text" }, Ue = { __name: "Banner", setup(v) {
  ...
  return (o, r) => (l(), j(R, { class: "action", title: "Discord Server" }, { default: w(() => r[0] || (r[0] = [t("img", { src: "./svg/discord.svg" }, null, -1)])), _: 1, __: [0] }));
  ...
  return (d, a) => m(o).isElectronApp() || m(o).isNativeApp() ? (l(), j(R, { key: 0, class: "action", title: "Exit", onClick: r }, { default: w(() => a[0] || (a[0] = [t("span", { class: "material-symbols-rounded" }, "undo", -1)])), _: 1, __: [0] })) : y("", true);
  ...
  return (d, a) => m(o).isNativeApp() == false ? (l(), j(R, { key: 0, class: "action", title: "Fullscreen", onClick: r }, { default: w(() => a[0] || (a[0] = [t("span", { class: "material-symbols-rounded" }, "fullscreen", -1)])), _: 1, __: [0] })) : y("", true);
  ...
  return (d, a) => m(o).isExtension() || m(o).isNativeApp() ? (l(), j(R, { key: 0, class: "action", onClick: a[0] || (a[0] = (A) => r()) }, { default: w(() => a[1] || (a[1] = [t("span", { class: "material-symbols-rounded" }, "favorite", -1), t("span", null, "Write a Review", -1)])), _: 1, __: [1] })) : y("", true);
