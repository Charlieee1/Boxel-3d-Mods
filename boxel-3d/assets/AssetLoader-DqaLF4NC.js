import { _ as G, e as V, b as Q, w as W, c as X, d as $, a as P, n as D, u as B, t as J, T as Z, o as E, P as z, N as f, ba as Y, W as g, bb as y, bc as v, bd as q, a0 as A, $ as S, aw as K, Q as w, R as ee, S as k, U as te, X as R, Y as re, Z as ae, M as ie, V as L, a1 as se, a2 as ne, a3 as F, a5 as U, a6 as oe, a7 as le, a8 as de, aa as he, ab as ue, be as N, bf as ce, bg as fe, aO as pe, bh as ge, am as me, bi as ve, b7 as xe, G as Te, E as Me, I as Se, J as we, aB as ye, C as _e, B as be, D as Pe, bj as Be, K as Ce } from "./SkeletonUtils-Cx5mugYb.js";
...
class Oe extends Te {
  ...
  renderThumbnail(e, r) {
    ...
    return e.position.copy(r.position), e.scale.copy(r.scale), C.add(e), O.setSize(r.width, r.height), O.render(C, j), e.removeFromParent(), e.position.copy(t), e.scale.copy(a), I.toDataURL("image/png");
  }
}
const ze = new N("#ffffff", Math.PI), C = new F(), I = document.createElement("canvas"), O = new U({ alpha: true, canvas: I }), j = new xe(-0.5, 0.5, 0.5, -0.5, 0.01, 100);
C.add(ze);
j.position.z = 10;
class Ae extends we {
  constructor(e) {
