const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./web-BNSPXz6U.js","./SkeletonUtils-Lx6OFsqh.js","./web-BB9l3TLf.js"])))=>i.map(i=>d[i]);
import { ac as za, aW as Za, f as en, aX as tn, g as we, q as pt, aV as an, aY as St, aZ as ya, F as La, a_ as Te, a$ as nn, x as rn, y as sn, h as on, b0 as ln } from "./SkeletonUtils-Lx6OFsqh.js";
...
let __tla = (async () => {
  ...
  const cn = (e) => {
    ...
    const t = e.CapacitorCustomPlatform || null, a = e.Capacitor || {}, n = a.Plugins = a.Plugins || {}, r = () => t !== null ? t.name : cn(e), s = () => r() !== "web", o = (_) => {
      ...
      var m;
      return (m = a.PluginHeaders) === null || m === void 0 ? void 0 : m.find((L) => L.name === _);
    }, u = (_) => e.console.error(_), d = /* @__PURE__ */ new Map(), g = (_, m = {}) => {
      const L = d.get(_);
      if (L) return console.warn(`Capacitor plugin "${_}" already registered. Cannot register plugins twice.`), L.proxy;
      const P = r(), w = i(_);
      let T;
      const f = async () => (!T && P in m ? T = typeof m[P] == "function" ? T = await m[P]() : T = m[P] : t !== null && !T && "web" in m && (T = typeof m.web == "function" ? T = await m.web() : T = m.web), T), v = (N, A) => {
        var H, G;
        if (w) {
      ...
      }, h = k("addListener"), S = k("removeListener"), I = (N, A) => {
        const H = h({
          eventName: N
        }, A), G = async () => {
          const J = await H;
    ...
    return $t || ($t = 1, (function(e, t) {
      (function(a, n) {
        ...
        var o = typeof window == "object" && window.window === window ? window : typeof self == "object" && self.self === self ? self : typeof Me == "object" && Me.global === Me ? Me : void 0, i = o.navigator && /Macintosh/.test(navigator.userAgent) && /AppleWebKit/.test(navigator.userAgent) && !/Safari/.test(navigator.userAgent), u = o.saveAs || (typeof window != "object" || window !== o ? function() {
          ...
          var m = o.URL || o.webkitURL, L = document.createElement("a");
          g = g || d.name || "download", L.download = g, L.rel = "noopener", typeof d == "string" ? (L.href = d, L.origin === location.origin ? s(L) : r(L.href) ? n(d, g, _) : s(L, L.target = "_blank")) : (L.href = m.createObjectURL(d), setTimeout(function() {
            m.revokeObjectURL(L.href);
          ...
          var L = d.type === "application/octet-stream", P = /constructor/i.test(o.HTMLElement) || o.safari, w = /CriOS\/[\d]+/.test(navigator.userAgent);
          if ((w || L && P || i) && typeof FileReader < "u") {
            var T = new FileReader();
            T.onloadend = function() {
              var k = T.result;
              k = w ? k : k.replace(/^data:[^;]*;/, "data:attachment/file;"), m ? m.location.href = k : location = k, m = null;
            }, T.readAsDataURL(d);
          } else {
  ...
  const En = "modulepreload", yn = function(e, t) {
    ...
    if (a && a.length > 0) {
      ...
      r = d(a.map((g) => {
        ...
        if (L.rel = _ ? "stylesheet" : En, _ || (L.as = "script"), L.crossOrigin = "", L.href = g, u && L.setAttribute("nonce", u), document.head.appendChild(L), _) return new Promise((P, w) => {
          L.addEventListener("load", P), L.addEventListener("error", () => w(new Error(`Unable to preload CSS for ${g}`)));
        });
      }));
    }
    function s(o) {
  ...
  const Wt = Ge("Filesystem", {
    web: () => wa(() => import("./web-BNSPXz6U.js"), __vite__mapDeps([0,1]), import.meta.url).then((e) => new e.FilesystemWeb())
  });
  wn();
  xo = class {
    constructor() {
    ...
    saveScore(t, a) {
      ...
      return i != null && (i.indexOf(":") >= 0 && (i += "0"), r = parseInt(i.replace(/[^\d]/g, ""))), s < r && (o = true, n[t] = a, localStorage.setItem("scores", JSON.stringify(n)), this.saveThumbnailAfterPopupOpened(t)), o;
    }
    getScores() {
    ...
    screenshot(t) {
      ...
      app.graphics.camera.zoom = t.zoom, app.graphics.camera.aspect = t.width / t.height, app.graphics.camera.updateProjectionMatrix(), app.graphics.renderer.setPixelRatio(1), app.graphics.renderer.setSize(t.width, t.height), app.graphics.renderer.render(app.graphics.scene, app.graphics.camera);
      const i = app.graphics.renderer.domElement, u = document.createElement("canvas");
      u.width = i.width, u.height = i.height;
      const d = u.getContext("2d");
      d.drawImage(i, 0, 0);
      var g = app.storage.getSettings(app);
      return g.buffer == 0 && g.debug == false && (d.save(), d.font = '48px "Material Symbols Rounded", sans-serif', d.fillStyle = "#FFFFFF", d.textAlign = "left", d.textBaseline = "top", d.shadowColor = "rgba(0, 0, 0, 0.25)", d.shadowOffsetX = 0, d.shadowOffsetY = 2, d.shadowBlur = 0, d.fillText(String.fromCharCode(parseInt("ef76", 16)), 10, 10), d.restore()), a = u.toDataURL("image/png"), t.save == true && u.toBlob((_) => ut.saveAs(_, "screenshot.png")), app.graphics.camera.zoom = s, app.graphics.camera.aspect = n / r, app.graphics.camera.updateProjectionMatrix(), app.graphics.renderer.setPixelRatio(o), app.graphics.renderer.setSize(n, r), app.graphics.renderer.render(app.graphics.scene, app.graphics.camera), a;
    }
    loadLevelFromFile() {
...
`, Un = "\u2028", $n = "\u2029";
  function jn(e) {
    const t = e;
    let a = 0, n = 1, r = 1, s = 0;
    const o = (E) => t[E] === xn && t[E + 1] === X, i = (E) => t[E] === X, u = (E) => t[E] === $n, d = (E) => t[E] === Un, g = (E) => o(E) || i(E) || u(E) || d(E), _ = () => a, m = () => n, L = () => r, P = () => s, w = (E) => o(E) || u(E) || d(E) ? X : t[E], T = () => w(a), f = () => w(a + s);
    function v() {
  ...
  function Vn(e, t = {}) {
    ...
    function _e(l, c) {
      ...
      switch (l.currentChar()) {
        case "{":
          return c.braceNest >= 1 && _(U.NOT_ALLOW_NEST_PLACEHOLDER, s(), 0), l.next(), b = m(c, 2, "{"), T(l), c.braceNest++, b;
        case "}":
          return c.braceNest > 0 && c.currentType === 2 && _(U.EMPTY_PLACEHOLDER, s(), 0), l.next(), b = m(c, 3, "}"), c.braceNest--, c.braceNest > 0 && T(l), c.inLinked && c.braceNest === 0 && (c.inLinked = false), b;
        case "@":
          return c.braceNest > 0 && _(U.UNTERMINATED_CLOSING_BRACE, s(), 0), b = ge(l, c) || L(c), c.braceNest = 0, b;
        default: {
          ...
          if (V = k(l, c)) return b = m(c, 4, et(l)), T(l), b;
          if (R = h(l, c)) return b = m(c, 5, tt(l)), T(l), b;
          if (p = S(l, c)) return b = m(c, 6, at(l)), T(l), b;
          if (!V && !R && !p) return b = m(c, 12, Fe(l)), _(U.INVALID_TOKEN_IN_PLACEHOLDER, s(), 0, b.value), T(l), b;
          break;
        }
      }
      return b;
    ...
    function ge(l, c) {
      ...
      switch ((b === 7 || b === 8 || b === 11 || b === 9) && (V === X || V === te) && _(U.INVALID_LINKED_FORMAT, s(), 0), V) {
        ...
        case ".":
          return T(l), l.next(), m(c, 8, ".");
        case ":":
          return T(l), l.next(), m(c, 9, ":");
        default:
          return H(l) ? (O = m(c, 1, Le(l)), c.braceNest = 0, c.inLinked = false, O) : I(l, c) || N(l, c) ? (T(l), ge(l, c)) : E(l, c) ? (T(l), m(c, 11, st(l))) : A(l, c) ? (T(l), V === "{" ? _e(l, c) || O : m(c, 10, ot(l))) : (b === 7 && _(U.INVALID_LINKED_FORMAT, s(), 0), c.braceNest = 0, c.inLinked = false, ke(l, c));
      }
    }
    function ke(l, c) {
      let b = {
      ...
      if (c.braceNest > 0) return _e(l, c) || L(c);
      if (c.inLinked) return ge(l, c) || L(c);
      switch (l.currentChar()) {
        case "{":
          return _e(l, c) || L(c);
        case "}":
  ...
  function qn(e = {}) {
    ...
    function s(f, v, k, h) {
      t && (f.end = v, f.loc && (f.loc.end = k));
    }
    function o(f, v) {
      const k = f.context(), h = r(3, k.offset, k.startLoc);
      return h.value = v, s(h, f.currentOffset(), f.currentPosition()), h;
    }
    function i(f, v) {
      const k = f.context(), { lastOffset: h, lastStartLoc: S } = k, I = r(5, h, S);
      return I.index = parseInt(v, 10), f.nextToken(), s(I, f.currentOffset(), f.currentPosition()), I;
    }
    function u(f, v) {
      const k = f.context(), { lastOffset: h, lastStartLoc: S } = k, I = r(4, h, S);
      return I.key = v, f.nextToken(), s(I, f.currentOffset(), f.currentPosition()), I;
    }
    function d(f, v) {
      const k = f.context(), { lastOffset: h, lastStartLoc: S } = k, I = r(9, h, S);
      return I.value = v.replace(Bn, Gn), f.nextToken(), s(I, f.currentOffset(), f.currentPosition()), I;
    }
    function g(f) {
      const v = f.nextToken(), k = f.context(), { lastOffset: h, lastStartLoc: S } = k, I = r(8, h, S);
      return v.type !== 11 ? (n(f, U.UNEXPECTED_EMPTY_LINKED_MODIFIER, k.lastStartLoc, 0), I.value = "", s(I, h, S), {
        nextConsumeToken: v,
        node: I
      }) : (v.value == null && n(f, U.UNEXPECTED_LEXICAL_ANALYSIS, k.lastStartLoc, 0, ae(v)), I.value = v.value || "", s(I, f.currentOffset(), f.currentPosition()), {
        node: I
      });
    }
    function _(f, v) {
      const k = f.context(), h = r(7, k.offset, k.startLoc);
      return h.value = v, s(h, f.currentOffset(), f.currentPosition()), h;
    }
    function m(f) {
      const v = f.context(), k = r(6, v.offset, v.startLoc);
      let h = f.nextToken();
      if (h.type === 8) {
        const S = g(f);
        k.modifier = S.node, h = S.nextConsumeToken || f.nextToken();
      }
      switch (h.type !== 9 && n(f, U.UNEXPECTED_LEXICAL_ANALYSIS, v.lastStartLoc, 0, ae(h)), h = f.nextToken(), h.type === 2 && (h = f.nextToken()), h.type) {
        case 10:
          h.value == null && n(f, U.UNEXPECTED_LEXICAL_ANALYSIS, v.lastStartLoc, 0, ae(h)), k.key = _(f, h.value || "");
          break;
        case 4:
          h.value == null && n(f, U.UNEXPECTED_LEXICAL_ANALYSIS, v.lastStartLoc, 0, ae(h)), k.key = u(f, h.value || "");
          break;
        case 5:
          h.value == null && n(f, U.UNEXPECTED_LEXICAL_ANALYSIS, v.lastStartLoc, 0, ae(h)), k.key = i(f, h.value || "");
          break;
        case 6:
          h.value == null && n(f, U.UNEXPECTED_LEXICAL_ANALYSIS, v.lastStartLoc, 0, ae(h)), k.key = d(f, h.value || "");
          break;
        default: {
          n(f, U.UNEXPECTED_EMPTY_LINKED_KEY, v.lastStartLoc, 0);
          const S = f.context(), I = r(7, S.offset, S.startLoc);
          return I.value = "", s(I, S.offset, S.startLoc), k.key = I, s(k, S.offset, S.startLoc), {
            nextConsumeToken: h,
            node: k
          };
        }
    ...
    function L(f) {
      const v = f.context(), k = v.currentType === 1 ? f.currentOffset() : v.offset, h = v.currentType === 1 ? v.endLoc : v.startLoc, S = r(2, k, h);
      S.items = [];
      let I = null;
      do {
        ...
        switch (I = null, A.type) {
          case 0:
            A.value == null && n(f, U.UNEXPECTED_LEXICAL_ANALYSIS, v.lastStartLoc, 0, ae(A)), S.items.push(o(f, A.value || ""));
            break;
          case 5:
            A.value == null && n(f, U.UNEXPECTED_LEXICAL_ANALYSIS, v.lastStartLoc, 0, ae(A)), S.items.push(i(f, A.value || ""));
            break;
          case 4:
            A.value == null && n(f, U.UNEXPECTED_LEXICAL_ANALYSIS, v.lastStartLoc, 0, ae(A)), S.items.push(u(f, A.value || ""));
            break;
          case 6:
            A.value == null && n(f, U.UNEXPECTED_LEXICAL_ANALYSIS, v.lastStartLoc, 0, ae(A)), S.items.push(d(f, A.value || ""));
            break;
          case 7: {
            const H = m(f);
            S.items.push(H.node), I = H.nextConsumeToken || null;
            break;
          }
        }
    ...
    function P(f, v, k, h) {
      ...
      return I && n(f, U.MUST_HAVE_MESSAGES_IN_PLURAL, k, 0), s(E, f.currentOffset(), f.currentPosition()), E;
    }
    function w(f) {
      const v = f.context(), { offset: k, startLoc: h } = v, S = L(f);
      return v.currentType === 13 ? S : P(f, k, h, S);
    }
    function T(f) {
      const v = Vn(f, K({}, e)), k = v.context(), h = r(0, k.offset, k.startLoc);
      return t && h.loc && (h.loc.source = f), h.body = w(v), e.onCacheKey && (h.cacheKey = e.onCacheKey(f)), k.currentType !== 13 && n(v, U.UNEXPECTED_LEXICAL_ANALYSIS, k.lastStartLoc, 0, f[k.offset] || ""), s(h, v.currentOffset(), v.currentPosition()), h;
    }
    return {
      parse: T
    };
...
`, s = t.needIndent ? t.needIndent : a !== "arrow", o = e.helpers || [], i = Qn(e, {
  ...
  function aa(e, ...t) {
    ...
    const L = !!g.part, P = Ot(e, g), w = o(e, r, P);
    if (!C(u) || u === "") return new Intl.DateTimeFormat(P, _).format(d);
    let T = {}, f, v = null;
    const k = "datetime format";
    for (let I = 0; I < w.length && (f = w[I], T = a[f] || {}, v = T[u], !F(v)); I++) Nt(e, u, f, m, k);
    if (!F(v) || !C(f)) return n ? Je : u;
    let h = `${f}__${u}`;
    qe(_) || (h = `${h}__${JSON.stringify(_)}`);
    let S = i.get(h);
    return S || (S = new Intl.DateTimeFormat(f, K({}, v, _)), i.set(h, S)), L ? S.formatToParts(d) : S.format(d);
  }
  const Wa = [
    "localeMatcher",
    "weekday",
  ...
  function ra(e, ...t) {
    ...
    qe(_) || (h = `${h}__${JSON.stringify(_)}`);
    let S = i.get(h);
    return S || (S = new Intl.NumberFormat(f, K({}, v, _)), i.set(h, S)), L ? S.formatToParts(d) : S.format(d);
  }
  const Ha = [
    "localeMatcher",
    "style",
  ...
  function Jr(e = {}) {
    ...
    const d = (f) => u[f];
    function g(f, v) {
      const k = W(e.messages) ? e.messages(f, !!v) : M(e.messages) ? e.messages[f] : false;
      return k || (e.parent ? e.parent.message(f) : Vr);
    }
    const _ = (f) => e.modifiers ? e.modifiers[f] : Hr, m = F(e.processor) && W(e.processor.normalize) ? e.processor.normalize : Br, L = F(e.processor) && W(e.processor.interpolate) ? e.processor.interpolate : Gr, P = F(e.processor) && C(e.processor.type) ? e.processor.type : Yr, T = {
      list: i,
      named: d,
      plural: s,
      linked: (f, ...v) => {
        const [k, h] = v;
        let S = "text", I = "";
        v.length === 1 ? M(k) ? (I = k.modifier || I, S = k.type || S) : C(k) && (I = k || I) : v.length === 2 && (C(k) && (I = k || I), C(h) && (S = h || S));
        const E = g(f, true)(T), N = S === "vnode" && Y(E) && I ? E[0] : E;
        return I ? _(I)(N, S) : N;
      },
      message: g,
      type: P,
  ...
  const la = () => "", Z = (e) => W(e);
  function ia(e, ...t) {
    const { fallbackFormat: a, postTranslation: n, unresolving: r, messageCompiler: s, fallbackLocale: o, messages: i } = e, [u, d] = bt(...t), g = D(d.missingWarn) ? d.missingWarn : e.missingWarn, _ = D(d.fallbackWarn) ? d.fallbackWarn : e.fallbackWarn, m = D(d.escapeParameter) ? d.escapeParameter : e.escapeParameter, L = !!d.resolvedMessage, P = C(d.default) || D(d.default) ? D(d.default) ? s ? u : () => u : d.default : a ? s ? u : () => u : null, w = a || P != null && (C(P) || W(P)), T = Ot(e, d);
    m && Xr(d);
    let [f, v, k] = L ? [
      u,
      T,
      i[T] || $()
    ] : Va(e, u, T, o, _, g), h = f, S = u;
    if (!L && !(C(h) || ne(h) || Z(h)) && w && (h = P, S = h), !L && (!(C(h) || ne(h) || Z(h)) || !C(v))) return r ? Je : u;
    let I = false;
    const E = () => {
      I = true;
    }, N = Z(h) ? h : Ya(e, u, v, h, S, E);
    if (I) return h;
    const A = Zr(e, v, k, d), H = Jr(A), G = Qr(e, N, H);
    let x = n ? n(G, u) : G;
  ...
  function Va(e, t, a, n, r, s) {
    ...
    let _ = $(), m, L = null;
    const P = "translate";
    for (let w = 0; w < g.length && (m = g[w], _ = o[m] || $(), (L = u(_, t)) === null && (L = _[t]), !(C(L) || ne(L) || Z(L))); w++) if (!Wr(m, g)) {
      const T = Nt(e, t, m, s, P);
      T !== t && (L = T);
    }
    return [
      L,
  ...
  function Zr(e, t, a, n) {
    const { modifiers: r, pluralRules: s, messageResolver: o, fallbackLocale: i, fallbackWarn: u, missingWarn: d, fallbackContext: g } = e, m = {
      ...
      messages: (L, P) => {
        let w = o(a, L);
        if (w == null && (g || P)) {
          const [, , T] = Va(g || e, L, t, i, u, d);
          w = o(T, L);
        }
        if (C(w) || ne(w)) {
          let T = false;
          const v = Ya(e, L, t, w, L, () => {
            T = true;
          });
          return T ? la : v;
  ...
  function Rt(e = {}) {
    ...
    let m = t ? t.missingWarn : D(e.missingWarn) || Ee(e.missingWarn) ? e.missingWarn : true, L = t ? t.fallbackWarn : D(e.fallbackWarn) || Ee(e.fallbackWarn) ? e.fallbackWarn : true, P = t ? t.fallbackRoot : D(e.fallbackRoot) ? e.fallbackRoot : true, w = !!e.fallbackFormat, T = W(e.missing) ? e.missing : null, f = W(e.missing) ? ma(e.missing) : null, v = W(e.postTranslation) ? e.postTranslation : null, k = t ? t.warnHtmlMessage : D(e.warnHtmlMessage) ? e.warnHtmlMessage : true, h = !!e.escapeParameter;
    const S = t ? t.modifiers : F(e.modifiers) ? e.modifiers : {};
  ...
  function Xa(e, t, a, n) {
    ...
    return () => {
      ...
      let i = $();
      e.locale && (o.locale = e.locale), C(e.format) ? o.key = e.format : M(e.format) && (C(e.format.key) && (o.key = e.format.key), i = Object.keys(e.format).reduce((m, L) => a.includes(L) ? K($(), m, {
        [L]: e.format[L]
      }) : m, $()));
      ...
      Y(u) ? d = u.map((m, L) => {
        ...
        return is(w) && (w[0].key = `${m.type}-${L}`), w;
      }) : C(u) && (d = [
        u
      ]);
  ...
  function ps(e = {}) {
    ...
    const g = {
      ...
      async install(_, ...m) {
        ...
        let L = null;
        !t && a && (L = ks(_, g.global)), __VUE_I18N_FULL_INSTALL__ && fs(_, g, ...m), __VUE_I18N_LEGACY_API__ && t && _.mixin(ss(s, s.__composer, g));
        const P = _.unmount;
        _.unmount = () => {
          L && L(), g.dispose(), P();
        };
  ...
  Uo = Ge("App", {
    web: () => wa(() => import("./web-BB9l3TLf.js"), __vite__mapDeps([2,1]), import.meta.url).then((e) => new e.AppWeb())
  });
  Ss = {
    button: {
      pause: "Pause"
