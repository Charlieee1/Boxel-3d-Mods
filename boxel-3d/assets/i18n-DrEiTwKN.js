const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./web-CL8k8zDe.js","./SkeletonUtils-Cx5mugYb.js","./web-CMHvrI69.js"])))=>i.map(i=>d[i]);
import { ac as zn, aW as Zn, e as er, aX as tr, f as Se, q as pt, aV as nr, aY as wt, aZ as yn, F as Ln, a_ as Te, a$ as rr, x as ar, y as sr, g as or, b0 as lr } from "./SkeletonUtils-Cx5mugYb.js";
...
let __tla = (async () => {
  ...
  const Wt = Be("Filesystem", {
    web: () => Sn(() => import("./web-CL8k8zDe.js"), __vite__mapDeps([0,1]), import.meta.url).then((e) => new e.FilesystemWeb())
  });
  kr();
  wo = class {
    constructor() {
...
`, s = t.needIndent ? t.needIndent : n !== "arrow", o = e.helpers || [], i = Kr(e, {
  ...
  To = Be("App", {
    web: () => Sn(() => import("./web-CMHvrI69.js"), __vite__mapDeps([2,1]), import.meta.url).then((e) => new e.AppWeb())
  });
  ks = {
    button: {
      pause: "Pause"
